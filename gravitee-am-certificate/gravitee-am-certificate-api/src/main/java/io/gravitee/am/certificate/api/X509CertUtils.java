...
public final class X509CertUtils {
     ...
     *
     * @param derEncodedCert The DER-encoded X.509 certificate, as a byte array. May be {@code
     *     null}.
     ...
     *
     * @param derEncodedCert The DER-encoded X.509 certificate, as a byte array. Empty or {@code
     ...
     *
     * @param pemEncodedCert The PEM-encoded X.509 certificate, as a string. Empty or {@code null}
     *     if not specified.
