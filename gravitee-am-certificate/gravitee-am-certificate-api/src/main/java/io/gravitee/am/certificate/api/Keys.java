...
public final class Keys {
    ...
    /**
     * Creates a new SecretKey instance for use with HMAC-SHA algorithms based on the specified key
     * byte array.
     *
     * @param bytes the key byte array
     * @return a new SecretKey instance for use with HMAC-SHA algorithms based on the specified key
     *     byte array.
     * @throws InvalidKeyException if the key byte array length is less than 256 bits (32 bytes) as
     *     mandated by the <a href="https://tools.ietf.org/html/rfc7518#section-3.2">JWT JWA
     *     Specification (RFC 7518, Section 3.2)</a>
     */
    public static SecretKey hmacShaKeyFor(byte[] bytes) throws InvalidKeyException {
        ...
        String msg =
                "The specified key byte array is "
                        ...
                        + "output size).  Consider using the "
                        + Keys.class.getName()
