 ...
 * OIDC Parameters
 *
 * <p>See <a href="https://www.iana.org/assignments/oauth-parameters/oauth-parameters.xhtml">OAuth
 * Parameters</a>
 *
...
public interface Parameters {
     ...
     * time the End-User was actively authenticated by the OP.
     */
    ...
    /**
     * This parameter is used by the Client to provide information about itself to a Self-Issued OP
     * that would normally be provided to an OP during Dynamic Client Registration.
     */
    String REGISTRATION = "registration";
    /**
     * This parameter enables OpenID Connect requests to be passed in a single, self-contained
     * parameter and to be optionally signed and/or encrypted.
     */
    String REQUEST = "request";
    /**
     * This parameter enables OpenID Connect requests to be passed by reference, rather than by
     * value.
     */
    String REQUEST_URI = "request_uri";
    /**
     * This parameter enables OpenID Connect response to be passed in a single, self-contained
     * parameter and to be optionally signed and/or encrypted.
     */
