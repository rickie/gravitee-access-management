...
/**
 * insufficient_scope The request requires higher privileges than provided by the access token. The
 * resource server SHOULD respond with the HTTP 403 (Forbidden) status code and MAY include the
 * "scope" attribute with the scope necessary to access the protected resource.
 *
 * <p>See <a href="https://tools.ietf.org/html/rfc6750#section-3">3.1. Error Codes</a>
 *
