...
/**
 * Type-safe representation of standard JWT signature algorithm names as defined in the <a
 * href="https://tools.ietf.org/html/draft-ietf-jose-json-web-algorithms-31">JSON Web Algorithms</a>
 * specification.
 *
...
public enum SignatureAlgorithm {
    ...
    /**
     * JWA algorithm name for {@code RSASSA-PSS using SHA-256 and MGF1 with SHA-256}. <b>This
     * algorithm requires Java 11 or later or a JCA provider like BouncyCastle to be in the runtime
     * classpath.</b> If on Java 10 or earlier, BouncyCastle will be used automatically if found in
    ...
    /**
     * JWA algorithm name for {@code RSASSA-PSS using SHA-384 and MGF1 with SHA-384}. <b>This
     * algorithm requires Java 11 or later or a JCA provider like BouncyCastle to be in the runtime
     * classpath.</b> If on Java 10 or earlier, BouncyCastle will be used automatically if found in
     * the runtime classpath.
     */
    ...
    /**
     * JWA algorithm name for {@code RSASSA-PSS using SHA-512 and MGF1 with SHA-512}. <b>This
     * algorithm requires Java 11 or later or a JCA provider like BouncyCastle to be in the runtime
     * classpath.</b> If on Java 10 or earlier, BouncyCastle will be used automatically if found in
     * the runtime classpath.
     */
    ...
    public static final List<SignatureAlgorithm> PREFERRED_HMAC_ALGS =
    ...
    // purposefully ordered higher to lower:
    public static final List<SignatureAlgorithm> PREFERRED_EC_ALGS =
            Collections.unmodifiableList(
                    Arrays.asList(
