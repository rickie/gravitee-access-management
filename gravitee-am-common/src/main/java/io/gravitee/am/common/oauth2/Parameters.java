...
public interface Parameters {
    ...
    /**
     * The client informs the authorization server of the mechanism to be used for returning
     * Authorization Response parameters from the Authorization_endpoint.
     */
    String RESPONSE_MODE = "response_mode";
    /**
     * The authorization server redirects the user-agent to the client's redirection endpoint
    ...
    /**
     * The format of the assertion as defined by the authorization server. The value will be an
     * absolute URI.
     */
