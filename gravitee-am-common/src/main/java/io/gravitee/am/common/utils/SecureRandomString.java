 ...
 *
 * <p>OAuth 2.0 spec says :
 *
 * <p>The probability of an attacker guessing generated tokens (and other credentials not intended
 * for handling by end-users) MUST be less than or equal to 2^(-128) and SHOULD be less than or
 * equal to 2^(-160).
 *
 * <p>This random generator use a 256-bit (32 byte) random value that is then URL-safe
 * base64-encoded.
 *
