 ...
 *
 * <p>See <a href="https://openid.net/specs/openid-connect-core-1_0.html#StandardClaims">5.1.
 * Standard Claims</a>
 *
...
public interface StandardClaims {
     ...
     * j.doe. This value MAY be any valid JSON string including special characters such as @, /, or
     * whitespace.
     */
    ...
    /**
     * End-User's locale, represented as a BCP47 [RFC5646] language tag. This is typically an ISO
     * 639-1 Alpha-2 [ISO639‑1] language code in lowercase and an ISO 3166-1 Alpha-2 [ISO3166‑1]
    ...
    /**
     * True if the End-User's phone number has been verified; otherwise false. When this Claim Value
     * is true, this means that the OP took affirmative steps to ensure that this phone number was
     * controlled by the End-User at the time the verification was performed. The means by which a
     * phone number is verified is context-specific, and dependent upon the trust framework or
