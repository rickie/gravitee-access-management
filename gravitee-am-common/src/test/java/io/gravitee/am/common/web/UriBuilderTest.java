...
public class UriBuilderTest {
                ...
                new Object[][] {
                    {
                        ...
                        8080,
                        Arrays.asList("http", "localhost", null, "/callback", null, null)
                    ...
                    },
                    {
                        ...
                        -1,
                        Arrays.asList("https", "gravitee.is", null, "", "the=best", null)
                                .toArray(new String[6]),
                        true
                    },
                    {
                        ...
                        -1,
                        Arrays.asList("myapp", "callback", null, "", null, "token=fragment")
                                .toArray(new String[6]),
                        false
                    },
                    {
                    ...
                    },
                    {
                        ...
                        -1,
                        Arrays.asList("com.google.app", null, null, "/callback", null, null)
                                .toArray(new String[6]),
                        false
                    }
                });
    ...
    public void testFromUri() throws Exception {
        ...
        Assert.assertEquals(
                "Scheme isHttp does not match", this.isHttp, UriBuilder.isHttp(uri.getScheme()));
    }
    ...
    public void testFromHttp() throws Exception {
        if (this.isHttp) {
            ...
            Assert.assertTrue(
                    "We expecting an exception, but did not happen", assertThrowException);
        }
    }
}
