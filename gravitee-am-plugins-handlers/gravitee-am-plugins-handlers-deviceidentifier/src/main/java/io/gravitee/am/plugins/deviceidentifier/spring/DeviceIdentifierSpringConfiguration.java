...
public class DeviceIdentifierSpringConfiguration {
    ...
    public DeviceIdentifierPluginManager deviceIdentifierPluginManager(
        ...
        return new DeviceIdentifierPluginManager(
                pluginContextFactory, deviceIdentifierConfigurationFactory);
    }

    @Bean
    public ConfigurationFactory<DeviceIdentifierConfiguration>
            deviceIdentifierConfigurationFactory() {
