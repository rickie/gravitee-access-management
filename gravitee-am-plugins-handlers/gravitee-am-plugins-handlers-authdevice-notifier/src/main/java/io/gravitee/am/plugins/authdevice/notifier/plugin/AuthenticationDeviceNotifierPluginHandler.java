 ...
 */
public class AuthenticationDeviceNotifierPluginHandler
        extends AmPluginHandler<AuthenticationDeviceNotifier> {

    private static final Logger LOGGER =
            LoggerFactory.getLogger(AuthenticationDeviceNotifierPluginHandler.class);
