...
public class AuthenticationDeviceNotifierSpringConfiguration {
    ...
    public AuthenticationDeviceNotifierPluginManager authDeviceNotifierPluginManager(
        ...
        return new AuthenticationDeviceNotifierPluginManager(
                pluginContextFactory, authDeviceNotifierConfigurationFactory);
    }

    @Bean
    public ConfigurationFactory<AuthenticationDeviceNotifierConfiguration>
            authDeviceNotifierConfigurationFactory() {
