...
public class FactorPluginManager
    ...
    public FactorProvider create(ProviderConfiguration providerConfiguration) {
        ...
        if (factor != null) {
            ...
            var factorConfiguration =
                    factorConfigurationFactory.create(
            ...
            throw new IllegalStateException(
                    "No factor is registered for type " + providerConfiguration.getType());
        }
    }

    private static class FactorConfigurationBeanFactoryPostProcessor
            extends NamedBeanFactoryPostProcessor<FactorConfiguration> {
