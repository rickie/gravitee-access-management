 ...
 */
public class ConfigurationFactoryImpl<CONFIGURATION>
        implements ConfigurationFactory<CONFIGURATION> {
    ...
    public <T extends CONFIGURATION> T create(Class<T> clazz, String content) {
        ...
        try {
            ...
            logger.error(
                    "Unable to create a new configuration for class {} configuration",
                    clazz.getName(),
                    ioe);
            return null;
        }
