...
public class BotDetectionSpringConfiguration {
    ...
    public AmPluginManager<BotDetection> botDetectionPluginManager(
            ...
            ConfigurationFactory<io.gravitee.am.botdetection.api.BotDetectionConfiguration>
                    botDetectionConfigurationFactory) {
        return new BotDetectionPluginManager(
                pluginContextFactory, botDetectionConfigurationFactory);
    }
