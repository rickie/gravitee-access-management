...
public interface AuthenticationContext extends ExecutionContext {
    ...
    /**
     * Removes an attribute from this context. long as the request is being handled.
     *
    ...
    /**
     * Returns the value of the named attribute as an Object, or <code>null</code> if no attribute
