...
public interface SocialAuthenticationProvider extends AuthenticationProvider {
     ...
     *
     * @param redirectUri
     * @return @Deprecated use the asyncSignInUrl instead
     */
    @Deprecated
    Request signInUrl(String redirectUri, String state);

    /**
     * Generate the signIn Url in asynchronous way to avoid blocking thread when an http call out is
     * required to generate the url.
     *
     * @param redirectUri
     * @return
     */
