...
@ContextConfiguration(
        classes = {
            OAuth2GenericAuthenticationProviderTestConfiguration.class,
            OAuth2GenericAuthenticationProviderConfiguration.class
        },
...
public class OAuth2GenericAuthenticationProviderTest {
    ...
    @Rule public WireMockRule wireMockRule = new WireMockRule(wireMockConfig().port(19999));
    ...
    public void shouldLoadUserByUsername_roleMapping() {
        ...
        stubFor(
                any(urlPathEqualTo("/profile"))
                        .withHeader(HttpHeaders.AUTHORIZATION, equalTo("Bearer test_token"))
                        .willReturn(
                                okJson("{ \"sub\": \"bob\", \"preferred_username\": \"bob\" }")));
