...
public class OAuth2GenericAuthenticationProviderTest_idToken {
    ...
    @InjectMocks
    private OAuth2GenericAuthenticationProvider authenticationProvider =
            new OAuth2GenericAuthenticationProvider();

    @Mock private OAuth2GenericIdentityProviderConfiguration configuration;
                                ...
                                new Authentication() {
                                    ...
                                    public AuthenticationContext getContext() {
                                        ...
                                        return new DummyAuthenticationContext(
                                                Collections.singletonMap("id_token", "test"),
                                                dummyRequest);
                                    }
                                })
                        .test();
