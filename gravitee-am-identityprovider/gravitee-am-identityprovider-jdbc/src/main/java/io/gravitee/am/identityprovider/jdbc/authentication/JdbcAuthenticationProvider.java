...
public class JdbcAuthenticationProvider extends JdbcAbstractProvider<AuthenticationProvider> implements AuthenticationProvider {
    ...
    public Maybe<User> loadUserByUsername(Authentication authentication) {
        ...
        return RxJava2Adapter.monoToMaybe(RxJava2Adapter.singleToMono(RxJava2Adapter.monoToSingle(RxJava2Adapter.flowableToFlux(selectUserByMultipleField(username)
                .toList()
    ...
    private Flowable<Map<String, Object>> selectUserByMultipleField(String username) {
        ...
        return RxJava2Adapter.fluxToFlowable(RxJava2Adapter.flowableToFlux(RxJava2Adapter.fluxToFlowable(RxJava2Adapter.flowableToFlux(Flowable.fromPublisher(connectionPool.create())).flatMap(RxJavaReactorMigrationUtil.toJdkFunction(connection -> {
    ...
    private Maybe<Map<String, Object>> selectUserByUsername(String username) {
        ...
        return RxJava2Adapter.monoToMaybe(RxJava2Adapter.flowableToFlux(RxJava2Adapter.fluxToFlowable(RxJava2Adapter.flowableToFlux(Flowable.fromPublisher(connectionPool.create())
