 ...
 */
@Configuration
public class JdbcAuthenticationProviderConfigurationTest_MSSQL
    ...
    protected void initData(Connection connection) {
        ...
        Single.fromPublisher(
                        connection
                                .createStatement(
                                        "insert into users(id, username, password, email, metadata) values( @id, @username, @password, @email , @metadata)")
                                .bind("id", "2")
                                ...
                                .execute())
                .flatMap(rp -> Single.fromPublisher(rp.getRowsUpdated()))
                .blockingGet();
        Single.fromPublisher(
                        connection
                                .createStatement(
