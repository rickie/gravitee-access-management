...
public class MongoAuthenticationProviderConfiguration {
    ...
    @Autowired private MongoIdentityProviderConfiguration configuration;
    ...
    public PasswordEncoder passwordEncoder() {
        ...
        if (MD5.equals(configuration.getPasswordEncoder())) {
            ...
            passwordEncoder.setEncodeSaltAsBase64(
                    "Base64".equals(configuration.getPasswordEncoding()));
        ...
        if (configuration.getPasswordEncoder().startsWith(SHA)) {
            ...
            if (configuration.getPasswordEncoder().endsWith("+MD5")) {
                passwordEncoder =
                        new SHAMD5PasswordEncoder(
                                configuration.getPasswordEncoder().split(Pattern.quote("+"))[0]);
            } else {
