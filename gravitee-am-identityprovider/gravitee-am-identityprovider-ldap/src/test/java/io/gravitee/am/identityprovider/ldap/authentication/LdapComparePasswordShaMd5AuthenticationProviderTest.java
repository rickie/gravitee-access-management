...
@ContextConfiguration(
        classes = {
            ...
            LdapComparePasswordShaMd5AuthenticationProviderTest.LdapAuthenticationConfiguration
                    .class
        })
public class LdapComparePasswordShaMd5AuthenticationProviderTest
    ...
    static class LdapAuthenticationConfiguration {
        ...
        public LdapIdentityProviderConfiguration configuration() {
            LdapIdentityProviderConfiguration configuration =
                    new LdapIdentityProviderConfiguration();
