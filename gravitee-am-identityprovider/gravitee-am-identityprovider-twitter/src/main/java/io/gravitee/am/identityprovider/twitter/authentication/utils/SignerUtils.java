...
public class SignerUtils {
    ...
    private static String signRequest(String secret, String tokenSecret, String signatureBaseString)
            throws Exception {
    ...
    public static String getAuthorizationHeader(
        ...
        for (Map.Entry<String, String> oauthParam : oauthParams.entrySet()) {
            authorization
                    .append(oauthParam.getKey())
                    .append("=\"")
                    .append(percentEncode(oauthParam.getValue()))
                    .append("\", ");
        }
        try {
            String baseSignatureString =
                    buildSignatureBaseString(method, url, parameters, oauthParams);
            String signature =
                    signRequest(
