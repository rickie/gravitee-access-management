...
public class FormsResourceTest extends JerseySpringTest {
    ...
    public void shouldGetForm() throws IOException {
        ...
        doReturn(Mono.just(mockForm)).when(formService).findByDomainAndTemplate_migrated(domainId, Template.LOGIN.template());
    ...
    public void shouldGetForms_technicalManagementException() {
        final String domainId = "domain-1";
        doReturn(Mono.error(new TechnicalManagementException("error occurs"))).when(formService).findByDomainAndTemplate_migrated(domainId, Template.LOGIN.template());
    ...
    public void shouldCreate() {
        ...
        doReturn(Mono.just(new Form())).when(formService).create_migrated(eq(domainId), any(), any(User.class));
