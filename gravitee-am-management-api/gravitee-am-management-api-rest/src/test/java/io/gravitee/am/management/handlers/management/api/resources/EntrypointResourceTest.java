...
public class EntrypointResourceTest extends JerseySpringTest {
    ...
    public void shouldGetEntrypoint() {
        ...
        doReturn(Mono.just(mockEntrypoint)).when(entrypointService).findById_migrated(ENTRYPOINT_ID, ORGANIZATION_ID);
    ...
    public void shouldNotGetEntrypoint_notFound() {
        ...
        doReturn(Mono.error(new EntrypointNotFoundException(ENTRYPOINT_ID))).when(entrypointService).findById_migrated(ENTRYPOINT_ID, ORGANIZATION_ID);
    ...
    public void shouldUpdateEntrypoint() {
        ...
        doReturn(Mono.just(mockEntrypoint)).when(entrypointService).update_migrated(eq(ENTRYPOINT_ID), eq(ORGANIZATION_ID), any(UpdateEntrypoint.class), any(User.class));
    ...
    public void shouldNotUpdateEntrypoint_notFound() {
        ...
        doReturn(Mono.error(new EntrypointNotFoundException(ENTRYPOINT_ID))).when(entrypointService).update_migrated(eq(ENTRYPOINT_ID), eq(ORGANIZATION_ID), any(UpdateEntrypoint.class), any(User.class));
