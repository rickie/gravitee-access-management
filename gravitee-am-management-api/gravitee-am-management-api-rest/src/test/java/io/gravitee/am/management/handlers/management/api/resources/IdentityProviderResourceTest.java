...
public class IdentityProviderResourceTest extends JerseySpringTest {
    ...
    public void shouldGetIdentityProvider() {
        ...
        doReturn(Mono.just(mockIdentityProvider)).when(identityProviderService).findById_migrated(identityProviderId);
    ...
    public void shouldGetIdentityProvider_notFound() {
        ...
        doReturn(Mono.just(mockDomain)).when(domainService).findById_migrated(domainId);
        doReturn(Mono.empty()).when(identityProviderService).findById_migrated(identityProviderId);
