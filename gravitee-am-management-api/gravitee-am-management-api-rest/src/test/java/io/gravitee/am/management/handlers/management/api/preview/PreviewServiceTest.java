...
public class PreviewServiceTest {
    ...
    @InjectMocks private PreviewService previewService;
    ...
    @Mock private ThemeService themeService = new ThemeServiceImpl();
        ...
        observer.assertValue(
                response ->
                        response.getContent() != null
                                && response.getContent().contains("PreviewApp"));
        observer.assertValue(
                response ->
                        response.getContent() != null && response.getContent().contains("#6A4FF7"));
    }
