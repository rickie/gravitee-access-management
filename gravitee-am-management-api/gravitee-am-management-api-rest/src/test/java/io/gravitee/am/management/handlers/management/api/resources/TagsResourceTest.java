...
public class TagsResourceTest extends JerseySpringTest {
    ...
    public void shouldGetTags() {
        ...
        doReturn(Flux.just(mockRole, mockRole2)).when(tagService).findAll_migrated(anyString());
    ...
    public void shouldGetTags_technicalManagementException() {
        doReturn(Flux.error(new TechnicalManagementException("error occurs"))).when(tagService).findAll_migrated(anyString());
    ...
    public void shouldCreate() {
        ...
        doReturn(Mono.just(tag)).when(tagService).create_migrated(any(), anyString(), any());
