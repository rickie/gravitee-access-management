...
public class ExtensionGrantPluginResourceTest extends JerseySpringTest {
    ...
    public void shouldGet() {
        ...
        doReturn(Mono.just(extensionGrantPlugin)).when(extensionGrantPluginService).findById_migrated(extensionGrantPluginId);
    ...
    public void shouldGet_technicalManagementException() {
        final String extensionGrantPluginId = "extensionGrant-plugin-id";
        doReturn(Mono.error(new TechnicalManagementException("Error occurs"))).when(extensionGrantPluginService).findById_migrated(extensionGrantPluginId);
    ...
    public void shouldGetSchema() {
        ...
        doReturn(Mono.just(extensionGrantPlugin)).when(extensionGrantPluginService).findById_migrated(extensionGrantPluginId);
        doReturn(Mono.just(schema)).when(extensionGrantPluginService).getSchema_migrated(extensionGrantPluginId);
