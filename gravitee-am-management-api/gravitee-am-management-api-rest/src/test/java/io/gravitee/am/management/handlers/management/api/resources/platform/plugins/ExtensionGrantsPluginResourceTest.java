...
public class ExtensionGrantsPluginResourceTest extends JerseySpringTest {
    ...
    public void shouldList() {
        ...
        doReturn(Mono.just(new HashSet<>(Arrays.asList(extensionGrantPlugin)))).when(extensionGrantPluginService).findAll_migrated();
    ...
    public void shouldList_technicalManagementException() {
        doReturn(Mono.error(new TechnicalManagementException("Error occurs"))).when(extensionGrantPluginService).findAll_migrated();
