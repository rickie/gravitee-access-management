...
public class ManagementAuthenticationProviderTest {
    ...
    public void shouldAuthenticate_firstAuthProvider() {
        ...
        when(authenticationProvider.loadUserByUsername_migrated(any(io.gravitee.am.identityprovider.api.Authentication.class))).thenReturn(Mono.just(new DefaultUser("username")));
    ...
    public void shouldAuthenticate_secondAuthProvider() {
        AuthenticationProvider authenticationProvider = mock(AuthenticationProvider.class);
        when(authenticationProvider.loadUserByUsername_migrated(any(io.gravitee.am.identityprovider.api.Authentication.class))).thenReturn(Mono.error(new BadCredentialsException()));
        AuthenticationProvider authenticationProvider2 = mock(AuthenticationProvider.class);
        when(authenticationProvider2.loadUserByUsername_migrated(any(io.gravitee.am.identityprovider.api.Authentication.class))).thenReturn(Mono.just(new DefaultUser("username")));
        when(identityProviderManager.getIdentityProvider("idp1")).thenReturn(new IdentityProvider());
    ...
    public void shouldNotAuthenticate_wrongCredentials() {
        ...
        when(authenticationProvider.loadUserByUsername_migrated(any(io.gravitee.am.identityprovider.api.Authentication.class))).thenReturn(Mono.error(new BadCredentialsException()));
        AuthenticationProvider authenticationProvider2 = mock(AuthenticationProvider.class);
        when(authenticationProvider2.loadUserByUsername_migrated(any(io.gravitee.am.identityprovider.api.Authentication.class))).thenReturn(Mono.error(new BadCredentialsException()));
        when(identityProviderManager.getIdentityProvider("idp1")).thenReturn(new IdentityProvider());
        when(identityProviderManager.getIdentityProvider("idp2")).thenReturn(new IdentityProvider());
        when(identityProviderManager.get("idp1")).thenReturn(authenticationProvider);
        when(identityProviderManager.get("idp2")).thenReturn(authenticationProvider2);
