...
public class CertificatesPluginResourceTest extends JerseySpringTest {
    ...
    public void shouldList() {
        ...
        doReturn(Mono.just(new HashSet<>(Arrays.asList(certificatePlugin)))).when(certificatePluginService).findAll_migrated();
    ...
    public void shouldList_technicalManagementException() {
        doReturn(Mono.error(new TechnicalManagementException("Error occurs"))).when(certificatePluginService).findAll_migrated();
