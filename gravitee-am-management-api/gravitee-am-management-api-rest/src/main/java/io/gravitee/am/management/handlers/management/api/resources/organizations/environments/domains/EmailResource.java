...
public class EmailResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EMAIL_TEMPLATE[UPDATE] permission on the specified domain "
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EMAIL_TEMPLATE[DELETE] permission on the specified domain "
