...
public class DeviceIdentifierResource extends AbstractResource {
    ...
    @ApiOperation(
            value = "Get a Device identifier",
            notes =
                    "User must have the DOMAIN_DEVICE_IDENTIFIER[READ] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Device identifier successfully fetched",
                response = DeviceIdentifierResource.class),
    ...
    public void get(
        ...
        checkAnyPermission(
                        ...
                        environmentId,
                        domain,
                        Permission.DOMAIN_DEVICE_IDENTIFIER,
                        Acl.READ)
                .andThen(
                        domainService
                                .findById(domain)
                                ...
                                .switchIfEmpty(
                                        Maybe.error(
                                                new DeviceIdentifierNotFoundException(
                                                        deviceIdentifierId)))
                                .map(
                                        deviceIdentifier -> {
                                            if (!(deviceIdentifier
                                                ...
                                                throw new BadRequestException(
                                                        "DeviceIdentifier does not belong to domain");
                                            }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Update a Device identifier",
            notes =
                    "User must have the DOMAIN_DEVICE_IDENTIFIER[UPDATE] permission on the specified domain "
    ...
    public void update(
            ...
            @ApiParam(name = "deviceIdentifier", required = true) @Valid @NotNull
                    UpdateDeviceIdentifier updateBotDetection,
            @Suspended final AsyncResponse response) {
        ...
        checkAnyPermission(
                ...
                .andThen(
                        domainService
                                ...
                                .flatMapSingle(
                                        __ ->
                                                deviceIdentifierService.update(
                                                        domain,
                                                        deviceIdentifierId,
                                                        updateBotDetection,
                                                        authenticatedUser)))
    ...
    @DELETE
    @ApiOperation(
            value = "Delete a Device identifier",
            notes =
                    "User must have the DOMAIN_DEVICE_IDENTIFIER[DELETE] permission on the specified domain "
    ...
    public void delete(
        ...
        checkAnyPermission(
                        ...
                        Acl.DELETE)
                .andThen(
                        deviceIdentifierService.delete(
                                domain, deviceIdentifierId, authenticatedUser))
