...
public class MemberResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_MEMBER[DELETE] permission on the specified domain "
    ...
    public void removeMember(
        ...
        checkAnyPermission(
                        organizationId, environmentId, domain, Permission.DOMAIN_MEMBER, Acl.DELETE)
                .andThen(
                        domainService
                                .findById(domain)
                                ...
                                .flatMapCompletable(
                                        irrelevant ->
                                                membershipService.delete(
                                                        membershipId, authenticatedUser)))
