...
public class AlertTriggersResource extends AbstractResource {
    ...
    @Inject private AlertTriggerService alertTriggerService;
    ...
    @ApiOperation(
            ...
            notes =
                    "List all the alert triggers of the domain accessible to the current user. "
                            + "User must have DOMAIN_ALERT[LIST] permission on the specified domain, environment or organization.")
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "List alert triggers for current user",
                response = AlertTrigger.class,
    ...
    public void list(
        ...
        checkAnyPermission(organizationId, environmentId, Permission.DOMAIN_ALERT, Acl.LIST)
                .andThen(
                        alertTriggerService.findByDomainAndCriteria(
    ...
    public void list(
        ...
        checkAnyPermission(organizationId, environmentId, Permission.DOMAIN_ALERT, Acl.UPDATE)
                ...
                .flatMapSingle(
                        patchAlertTrigger ->
                                alertTriggerService.createOrUpdate(
