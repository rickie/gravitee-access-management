...
public class EntrypointResource extends AbstractResource {
    ...
    public void update(
        ...
        RxJava2Adapter.monoToSingle(RxJava2Adapter.completableToMono(RxJava2Adapter.monoToCompletable(checkPermission_migrated(ReferenceType.ORGANIZATION, organizationId, Permission.ORGANIZATION_ENTRYPOINT, Acl.UPDATE))).then(RxJava2Adapter.singleToMono(RxJava2Adapter.monoToSingle(entrypointService.update_migrated(entrypointId, organizationId, entrypointToUpdate, authenticatedUser)))))
                .subscribe(response::resume, response::resume);
    }
