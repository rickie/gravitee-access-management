...
public class BotDetectionsResource extends AbstractResource {
    ...
    @ApiOperation(
            value = "List registered bot detections for a security domain",
            notes =
                    "User must have the DOMAIN_BOT_DETECTION[LIST] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "List registered bot detections for a security domain",
    ...
    @ApiOperation(
            value = "Create a bot detection",
            notes =
                    "User must have the DOMAIN_BOT_DETECTION[CREATE] permission on the specified domain "
