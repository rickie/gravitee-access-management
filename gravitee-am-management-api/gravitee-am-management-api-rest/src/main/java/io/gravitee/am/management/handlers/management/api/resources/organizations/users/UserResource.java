...
public class UserResource extends AbstractResource {
    ...
    public void updateUser(
        ...
        checkPermission_migrated(ReferenceType.ORGANIZATION, organizationId, Permission.ORGANIZATION_USER, Acl.UPDATE).then(organizationUserService.update_migrated(ReferenceType.ORGANIZATION, organizationId, user, updateUser, authenticatedUser)).subscribe(RxJavaReactorMigrationUtil.toJdkConsumer(response::resume), RxJavaReactorMigrationUtil.toJdkConsumer(response::resume));
    }
