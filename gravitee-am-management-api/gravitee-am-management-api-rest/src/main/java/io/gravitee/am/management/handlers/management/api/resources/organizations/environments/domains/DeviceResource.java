...
public class DeviceResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_USER_DEVICE[DELETE] permission on the specified domain "
    ...
    public void delete(
        ...
        checkAnyPermission(
                ...
                .flatMapCompletable(
                        __ -> deviceService.delete(domain, user, device, authenticatedUser))
