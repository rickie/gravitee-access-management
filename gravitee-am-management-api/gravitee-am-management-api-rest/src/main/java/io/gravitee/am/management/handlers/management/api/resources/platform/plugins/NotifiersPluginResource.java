...
public class NotifiersPluginResource {
    ...
    public void list(@QueryParam("expand") List<String> expand, @Suspended final AsyncResponse response) {
        ...
        RxJava2Adapter.monoToSingle(RxJava2Adapter.flowableToFlux(RxJava2Adapter.fluxToFlowable(notifierPluginService.findAll_migrated(expand.toArray(new String[0])))).sort(Comparator.comparing(AbstractPlugin::getName)).collectList())
