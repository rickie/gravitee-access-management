...
public class ExtensionGrantsResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EXTENSION_GRANT[LIST] permission on the specified domain "
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EXTENSION_GRANT[CREATE] permission on the specified domain "
    ...
    public void create(
            ...
            @PathParam("environmentId") String environmentId,
            @PathParam("domain") String domain,
            @ApiParam(name = "extension grant", required = true) @Valid @NotNull
                    final NewExtensionGrant newExtensionGrant,
            @Suspended final AsyncResponse response) {
