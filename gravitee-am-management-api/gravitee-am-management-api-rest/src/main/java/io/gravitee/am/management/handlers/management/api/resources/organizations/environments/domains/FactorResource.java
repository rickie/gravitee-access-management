...
public class FactorResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            nickname = "getFactor",
            notes =
                    "User must have the DOMAIN_FACTOR[READ] permission on the specified domain "
    ...
    public void get(
        ...
        checkAnyPermission(
                        organizationId, environmentId, domain, Permission.DOMAIN_FACTOR, Acl.READ)
                .andThen(
                        domainService
                                .findById(domain)
                                        ...
                                        factor1 -> {
                                            if (!factor1.getDomain().equalsIgnoreCase(domain)) {
                                                throw new BadRequestException(
                                                        "Factor does not belong to domain");
                                            }
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_FACTOR[UPDATE] permission on the specified domain "
    ...
    public void update(
        ...
        checkAnyPermission(
                        organizationId, environmentId, domain, Permission.DOMAIN_FACTOR, Acl.UPDATE)
                .andThen(
                        domainService
                                .findById(domain)
                                .switchIfEmpty(Maybe.error(new DomainNotFoundException(domain)))
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_FACTOR[DELETE] permission on the specified domain "
    ...
    public void delete(
        ...
        checkAnyPermission(
                        organizationId, environmentId, domain, Permission.DOMAIN_FACTOR, Acl.DELETE)
