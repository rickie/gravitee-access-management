...
public class ExtensionGrantsPluginResource {
    ...
    public void list(@Suspended final AsyncResponse response) {
        RxJava2Adapter.monoToSingle(extensionGrantPluginService.findAll_migrated().map(RxJavaReactorMigrationUtil.toJdkFunction(extensionGrantPlugins -> extensionGrantPlugins.stream()
