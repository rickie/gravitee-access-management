...
public class RedirectCookieGenerator {
    ...
    public static final String DEFAULT_REDIRECT_URL =
            "/auth/authorize?redirect_uri=http://localhost:4200/login/callback";
    ...
    public Cookie generateCookie(String redirectUrl) {
        ...
        cookie.setSecure(
                environment.getProperty(
                        "jwt.cookie-secure", Boolean.class, DEFAULT_REDIRECT_COOKIE_SECURE));
        cookie.setPath(environment.getProperty("jwt.cookie-path", DEFAULT_REDIRECT_COOKIE_PATH));
        cookie.setDomain(
                environment.getProperty("jwt.cookie-domain", DEFAULT_REDIRECT_COOKIE_DOMAIN));
        cookie.setMaxAge(
                environment.getProperty(
                        "jwt.expire-after", Integer.class, DEFAULT_REDIRECT_COOKIE_EXPIRES));
