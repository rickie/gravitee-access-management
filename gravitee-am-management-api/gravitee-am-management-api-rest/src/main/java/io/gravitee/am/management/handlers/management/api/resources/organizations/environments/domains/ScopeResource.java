...
public class ScopeResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            value = "Get a scope",
            notes =
                    "User must have the DOMAIN_SCOPE[READ] permission on the specified domain "
                                        ...
                                        scope -> {
                                            if (!scope.getDomain().equalsIgnoreCase(domain)) {
                                                throw new BadRequestException(
                                                        "Scope does not belong to domain");
                                            }
    ...
    @ApiOperation(
            ...
            value = "Patch a scope",
            notes =
                    "User must have the DOMAIN_SCOPE[UPDATE] permission on the specified domain "
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_SCOPE[DELETE] permission on the specified domain "
