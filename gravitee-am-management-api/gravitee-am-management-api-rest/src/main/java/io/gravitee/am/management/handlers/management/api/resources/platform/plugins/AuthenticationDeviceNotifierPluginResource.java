...
public class AuthenticationDeviceNotifierPluginResource {
    ...
    @Inject private AuthenticationDeviceNotifierPluginService pluginService;

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Get a Authentication Device Notifier plugin",
    ...
    public void get(
        ...
        pluginService
                ...
                .switchIfEmpty(
                        Maybe.error(
                                new AuthenticationDeviceNotifierPluginNotFoundException(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Get an Authentication Device Notifier plugin's schema",
            notes = "There is no particular permission needed. User must be authenticated.")
