...
public class ExtensionGrantResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EXTENSION_GRANT[READ] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Extension grant successfully fetched",
    ...
    public void get(
        ...
        checkAnyPermission(
                        ...
                        environmentId,
                        domain,
                        Permission.DOMAIN_EXTENSION_GRANT,
                        Acl.READ)
                .andThen(
                        domainService
                                .findById(domain)
                                ...
                                .flatMap(
                                        irrelevant ->
                                                extensionGrantService.findById(extensionGrant))
                                .switchIfEmpty(
                                        Maybe.error(
                                                new ExtensionGrantNotFoundException(
                                                        extensionGrant)))
                                .map(
                                        extensionGrant1 -> {
                                            if (!extensionGrant1
                                                ...
                                                throw new BadRequestException(
                                                        "Extension grant does not belong to domain");
                                            }
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EXTENSION_GRANT[UPDATE] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 201,
                message = "Extension grant successfully updated",
                response = ExtensionGrant.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void update(
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_EXTENSION_GRANT[DELETE] permission on the specified domain "
