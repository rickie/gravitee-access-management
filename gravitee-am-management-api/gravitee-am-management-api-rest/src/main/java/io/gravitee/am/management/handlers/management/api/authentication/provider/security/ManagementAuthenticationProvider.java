...
public class ManagementAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Organization organization = organizationService.findById_migrated(organizationId).block();
        ...
        while (iter.hasNext() && user == null) {
            ...
            try {
                user = authenticationProvider.loadUserByUsername_migrated(provAuthentication).block();
