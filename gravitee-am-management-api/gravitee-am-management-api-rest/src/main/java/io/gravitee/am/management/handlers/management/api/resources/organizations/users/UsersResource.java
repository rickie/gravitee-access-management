...
public class UsersResource extends AbstractUsersResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the ORGANIZATION_USER[LIST] permission on the specified organization. "
        ...
        checkPermission(
                ...
                .andThen(
                        organizationService
                                ...
                                .flatMap(
                                        organization ->
                                                organizationUserService.createGraviteeUser(
                                                        organization, newUser, authenticatedUser))
                                .map(
                                        user ->
                                                Response.created(
                                                                URI.create(
    ...
    private Single<User> filterUserInfos(
            Map<Permission, Set<Acl>> organizationPermissions, User user) {
