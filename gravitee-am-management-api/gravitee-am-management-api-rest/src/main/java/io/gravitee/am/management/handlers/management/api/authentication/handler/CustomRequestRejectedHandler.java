...
public class CustomRequestRejectedHandler extends HttpStatusRequestRejectedHandler {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(CustomRequestRejectedHandler.class);
    ...
    public void handle(
        ...
        logger.debug(
                String.format(
                        "Rejecting request due to: %s", requestRejectedException.getMessage()),
        ...
        response.getWriter()
                .write(
                        objectMapper.writeValueAsString(
                                new ErrorEntity(
                                        requestRejectedException.getMessage(), SC_BAD_REQUEST)));
