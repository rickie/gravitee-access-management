...
public class ExtensionGrantPluginResource {
    ...
    @Inject private ExtensionGrantPluginService extensionGrantPluginService;

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Get an extension grant plugin",
    ...
    public void get(
        ...
        extensionGrantPluginService
                ...
                .switchIfEmpty(
                        Maybe.error(new ExtensionGrantPluginNotFoundException(extensionGrantId)))
    ...
    public void getSchema(
        ...
        extensionGrantPluginService
                ...
                .switchIfEmpty(
                        Maybe.error(
                                new ExtensionGrantPluginSchemaNotFoundException(extensionGrantId)))
