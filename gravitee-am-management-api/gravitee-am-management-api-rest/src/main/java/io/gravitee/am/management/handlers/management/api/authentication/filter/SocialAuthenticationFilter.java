...
public class SocialAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public SocialAuthenticationFilter(String defaultFilterProcessesUrl) {
        ...
        SimpleUrlAuthenticationFailureHandler failureHandler =
                new SimpleUrlAuthenticationFailureHandler(errorPage);
    ...
    public Authentication attemptAuthentication(
        ...
        if (authenticationProvider == null
                ...
                || identityProvider.getReferenceType() != ReferenceType.ORGANIZATION) {
        ...
        SimpleAuthenticationContext authenticationContext =
                new SimpleAuthenticationContext(new JettyHttpServerRequest(request));
        authenticationContext.set(REDIRECT_URI, buildRedirectUri(request));
        EndUserAuthentication provAuthentication =
                new EndUserAuthentication("__social__", "__social__", authenticationContext);
    ...
    protected boolean requiresAuthentication(
        ...
        return super.requiresAuthentication(request, response)
                && !authenticated()
                && request.getParameter(PROVIDER_PARAMETER) != null;
    }
