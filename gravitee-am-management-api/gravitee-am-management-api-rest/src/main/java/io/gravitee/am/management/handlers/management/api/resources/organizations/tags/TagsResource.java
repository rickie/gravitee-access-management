...
public class TagsResource extends AbstractResource {
    ...
    public void create(
        ...
        checkPermission_migrated(ReferenceType.ORGANIZATION, organizationId, Permission.ORGANIZATION_TAG, Acl.CREATE).then(tagService.create_migrated(newTag, organizationId, authenticatedUser)).subscribe(RxJavaReactorMigrationUtil.toJdkConsumer(tag -> response.resume(Response
