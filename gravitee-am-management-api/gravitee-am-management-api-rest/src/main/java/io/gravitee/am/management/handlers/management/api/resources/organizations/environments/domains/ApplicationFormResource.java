...
public class ApplicationFormResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_FORM[UPDATE] permission on the specified application "
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_FORM[DELETE] permission on the specified application "
