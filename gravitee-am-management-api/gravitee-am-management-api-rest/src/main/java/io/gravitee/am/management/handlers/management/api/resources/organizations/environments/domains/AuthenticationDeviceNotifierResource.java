...
public class AuthenticationDeviceNotifierResource extends AbstractResource {
    ...
    @Autowired private AuthenticationDeviceNotifierService authDeviceNotifierService;
    ...
    @ApiOperation(
            value = "Get an Authentication Device Notifier",
            notes =
                    "User must have the DOMAIN_AUTHDEVICE_NOTIFIER[READ] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Authentication Device Notifier successfully fetched",
                response = AuthenticationDeviceNotifier.class),
    ...
    public void get(
        ...
        checkAnyPermission(
                        ...
                        environmentId,
                        domain,
                        Permission.DOMAIN_AUTHDEVICE_NOTIFIER,
                        Acl.READ)
                .andThen(
                        domainService
                                .findById(domain)
                                        ...
                                        deviceNotifier -> {
                                            if (!deviceNotifier
                                                ...
                                                throw new BadRequestException(
                                                        "AuthenticationDeviceNotifier does not belong to domain");
                                            }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Update an Authentication Device Notifier",
            notes =
                    "User must have the DOMAIN_AUTHDEVICE_NOTIFIER[UPDATE] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 201,
                message = "Authentication Device Notifier successfully updated",
                response = AuthenticationDeviceNotifier.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void update(
        ...
        checkAnyPermission(
                ...
                .andThen(
                        domainService
                                ...
                                .flatMapSingle(
                                        __ ->
                                                authDeviceNotifierService.update(
                                                        domain,
                                                        deviceNotifierId,
    ...
    @DELETE
    @ApiOperation(
            value = "Delete an Authentication Device Notifier",
            notes =
                    "User must have the DOMAIN_AUTHDEVICE_NOTIFIER[DELETE] permission on the specified domain "
    ...
    public void delete(
        ...
        checkAnyPermission(
                        ...
                        Acl.DELETE)
                .andThen(
                        authDeviceNotifierService.delete(
                                domain, deviceNotifierId, authenticatedUser))
