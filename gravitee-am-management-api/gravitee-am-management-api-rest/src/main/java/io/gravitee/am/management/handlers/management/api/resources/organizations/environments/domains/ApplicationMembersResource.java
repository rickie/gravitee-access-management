...
public class ApplicationMembersResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_MEMBER[LIST] permission on the specified application "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "List members for an application",
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_MEMBER[CREATE] permission on the specified application "
    ...
    public void permissions(
        ...
        checkAnyPermission(
                ...
                .andThen(
                        permissionService
                                .findAllPermissions(
                                        authenticatedUser, ReferenceType.APPLICATION, application)
