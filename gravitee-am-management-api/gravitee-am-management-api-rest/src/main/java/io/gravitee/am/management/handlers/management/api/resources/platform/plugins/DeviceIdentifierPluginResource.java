...
public class DeviceIdentifierPluginResource {
    ...
    @Inject private DeviceIdentifierPluginService deviceIdentifierPluginService;

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Get a device identifier plugin",
    ...
    public void get(
        ...
        deviceIdentifierPluginService
                ...
                .switchIfEmpty(
                        Maybe.error(new DeviceIdentifierNotFoundException(deviceIdentifierId)))
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Get a device identifier plugin's schema",
            notes = "There is no particular permission needed. User must be authenticated.")
