...
public class PolicyPluginResource {
    ...
    public void get(
        ...
        RxJava2Adapter.monoToMaybe(policyPluginService.findById_migrated(policyId).switchIfEmpty(Mono.error(new PolicyPluginNotFoundException(policyId))).map(RxJavaReactorMigrationUtil.toJdkFunction(policyPlugin -> Response.ok(policyPlugin).build())))
