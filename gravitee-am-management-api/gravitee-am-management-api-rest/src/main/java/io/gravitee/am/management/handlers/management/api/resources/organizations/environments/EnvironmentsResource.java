...
public class EnvironmentsResource extends AbstractResource {
    ...
    @ApiOperation(
            value = "List all the environments",
            notes =
                    "User must have the ENVIRONMENT[LIST] permission on the specified organization "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "List all the environments of the organization",
