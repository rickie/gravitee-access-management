...
public class ApplicationsResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the APPLICATION[LIST] permission on the specified domain, environment or organization "
                                        ...
                                        __ -> {
                                            if (query != null) {
                                                return applicationService.search(
                                                        domain, query, 0, Integer.MAX_VALUE);
                                            } else {
                                                return applicationService.findByDomain(
                                                        domain, 0, Integer.MAX_VALUE);
                                            }
                                        })
                                .flatMap(
                                        pagedApplications ->
