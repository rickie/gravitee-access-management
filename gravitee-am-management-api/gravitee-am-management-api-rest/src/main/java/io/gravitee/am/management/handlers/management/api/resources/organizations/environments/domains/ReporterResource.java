...
public class ReporterResource extends AbstractResource {
    ...
    @Autowired private ReporterServiceProxy reporterService;
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_REPORTER[READ] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Reporter successfully fetched",
                                        ...
                                        reporter1 -> {
                                            ...
                                            if (!reporter1.getDomain().equalsIgnoreCase(domain)) {
                                                throw new BadRequestException(
                                                        "Reporter does not belong to domain");
                                            }
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_REPORTER[UPDATE] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 201,
                message = "Reporter successfully updated",
                response = Reporter.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void update(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
            value = "Delete a reporter",
            notes =
                    "User must have the DOMAIN_REPORTER[DELETE] permission on the specified domain "
