...
public class IdentityProviderResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_IDENTITY_PROVIDER[READ] permission on the specified domain "
        ...
        checkAnyPermission(
                ...
                .andThen(
                        domainService
                                ...
                                .flatMap(
                                        irrelevant ->
                                                identityProviderService.findById(identityProvider))
                                .switchIfEmpty(
                                        Maybe.error(
                                ...
                                .map(
                                        safeIdp -> {
                                            if (safeIdp.getReferenceType() == ReferenceType.DOMAIN
                                                    && !safeIdp.getReferenceId()
                                                            .equalsIgnoreCase(domain)) {
                                                throw new BadRequestException(
                                                        "Identity provider does not belong to domain");
                                            }
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_IDENTITY_PROVIDER[UPDATE] permission on the specified domain "
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_IDENTITY_PROVIDER[DELETE] permission on the specified domain "
