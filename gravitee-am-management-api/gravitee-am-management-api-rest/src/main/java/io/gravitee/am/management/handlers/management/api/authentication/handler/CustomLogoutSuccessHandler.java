    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response) {
        ...
        authCookie.ifPresent(cookie -> {
            try {
                ...
                userService.findById_migrated(ReferenceType.ORGANIZATION, (String) jwt.get("org"), (String) jwt.getSub()).doOnSuccess(user -> auditService.report(AuditBuilder.builder(LogoutAuditBuilder.class).user(user)
