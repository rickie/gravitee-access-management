    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response) {
        ...
        authCookie.ifPresent(cookie -> {
            try {
                ...
                RxJava2Adapter.monoToSingle(RxJava2Adapter.singleToMono(userService.findById(ReferenceType.ORGANIZATION, (String) jwt.get("org"), (String) jwt.getSub())).doOnSuccess(RxJavaReactorMigrationUtil.toJdkConsumer(user -> auditService.report(AuditBuilder.builder(LogoutAuditBuilder.class).user(user)
