                ...
                cookie -> {
                    try {
                        ...
                        userService
                                ...
                                .flatMap(
                                        user1 ->
                                                userService.updateLogoutDate(
                                                        ReferenceType.ORGANIZATION, orgId, userId))
                                .doOnSuccess(
                                        user ->
                                                auditService.report(
                                                        AuditBuilder.builder(
                                                                        LogoutAuditBuilder.class)
                                                                .user(user)
                                                                .referenceType(
                                ...
                                .doOnError(
                                        err -> {
                                            logger.warn(
                                                    "Unable to read user information, trace logout with minimal data",
                                                    err);
                                            auditService.report(
