...
public class GroupsResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the ORGANIZATION[LIST] permission on the specified organization. "
                            + "Each returned group is filtered and contains only basic information such as id and name.")
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "List groups of the organization",
                ...
                .andThen(
                        groupService
                                .findAll(
                                        ...
                                        organizationId,
                                        page,
                                        Integer.min(size, MAX_GROUPS_SIZE_PER_PAGE))
                                .map(
                                        groupPage ->
                                                new GroupPage(
