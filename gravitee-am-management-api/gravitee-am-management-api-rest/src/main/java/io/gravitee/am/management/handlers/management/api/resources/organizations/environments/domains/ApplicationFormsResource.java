...
public class ApplicationFormsResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_FORM[READ] permission on the specified application "
    ...
    public void get(
        ...
        checkAnyPermission(
                        ...
                        domain,
                        application,
                        Permission.APPLICATION_FORM,
                        Acl.READ)
                .andThen(
                        formService.findByDomainAndClientAndTemplate(
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_FORM[CREATE] permission on the specified application "
