...
public class I18nDictionariesResource extends AbstractDomainResource {
    ...
    @Autowired private I18nDictionaryService dictionaryService;
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_I18N_DICTIONARY[LIST] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "List of i18n dictionaries for a security domain",
        ...
        checkAnyPermission(organizationId, environmentId, domain, DOMAIN_I18N_DICTIONARY, LIST)
                .andThen(
                        domainService
                                ...
                                .flatMapPublisher(
                                        irrelevant -> dictionaryService.findAll(DOMAIN, domain)))
                .toList()
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_I18N_DICTIONARY[CREATE] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 201,
                message = "Create a new i18n dictionary for a security domain",
                response = I18nDictionary.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void create(
