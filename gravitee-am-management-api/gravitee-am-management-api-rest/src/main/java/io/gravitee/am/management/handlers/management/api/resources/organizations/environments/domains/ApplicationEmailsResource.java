...
public class ApplicationEmailsResource extends AbstractResource {
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_EMAIL_TEMPLATE[READ] permission on the specified application "
                ...
                .andThen(
                        emailTemplateService
                                .findByDomainAndClientAndTemplate(
                                        domain, application, emailTemplate.template())
                                .map(email -> Response.ok(email).build())
                                .defaultIfEmpty(
                                        Response.ok(new Email(false, emailTemplate.template()))
                                                .build()))
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have APPLICATION_EMAIL_TEMPLATE[CREATE] permission on the specified application "
