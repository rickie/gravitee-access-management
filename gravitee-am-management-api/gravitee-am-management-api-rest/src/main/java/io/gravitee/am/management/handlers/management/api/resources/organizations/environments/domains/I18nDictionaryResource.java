...
public class I18nDictionaryResource extends AbstractDomainResource {
    ...
    @Autowired private I18nDictionaryService service;
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_I18N_DICTIONARY[READ] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Get the i18n dictionary",
                response = I18nDictionary.class),
        ...
        checkAnyPermission(organizationId, environmentId, domain, DOMAIN_I18N_DICTIONARY, READ)
                .andThen(
                        service.findById(DOMAIN, domain, dictionary)
                                .switchIfEmpty(
                                        Maybe.error(new DictionaryNotFoundException(dictionary))))
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_I18N_DICTIONARY[UPDATE] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Update the i18n dictionary description",
                response = I18nDictionary.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void update(
    ...
    @ApiOperation(
            ...
            notes =
                    "User must have the DOMAIN_I18N_DICTIONARY[DELETE] permission on the specified domain "
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Update the i18n entries for the given dictionary",
                response = I18nDictionary.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void update(
