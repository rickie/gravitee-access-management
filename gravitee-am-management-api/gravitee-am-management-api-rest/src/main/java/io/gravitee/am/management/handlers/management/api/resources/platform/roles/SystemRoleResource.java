...
public class SystemRoleResource extends AbstractResource {
    ...
    public void get(
        ...
        RxJava2Adapter.monoToSingle(roleService.findById_migrated(ReferenceType.PLATFORM, Platform.DEFAULT, role).map(RxJavaReactorMigrationUtil.toJdkFunction(this::convert)))
