...
public class SettingsResource extends AbstractResource {
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Platform settings successfully fetched",
    ...
    @ApiResponses({
        @ApiResponse(
                code = 200,
                message = "Platform settings successfully patched",
                response = Domain.class),
        @ApiResponse(code = 500, message = "Internal server error")
    })
    public void patch(
        ...
        checkPermission(
                ...
                .andThen(
                        organizationService.update(
                                organizationId, patchOrganization, authenticatedUser))
                .subscribe(
                        organization -> response.resume(Response.ok(organization).build()),
                        response::resume);
    }
}
