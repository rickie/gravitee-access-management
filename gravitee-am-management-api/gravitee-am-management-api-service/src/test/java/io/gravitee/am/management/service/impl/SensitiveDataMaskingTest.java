...
public class SensitiveDataMaskingTest extends AbstractSensitiveProxy {
    ...
    private static final String URI_WITHOUT_USERINFO =
            "mongodb+srv://hostname/dbname?retryWrites=true&w=majority&connectTimeoutMS=10000&maxIdleTimeMS=30000";

    private static final String URI_WITH_USERNAME =
            "mongodb+srv://user@hostname/dbname?retryWrites=true&w=majority&connectTimeoutMS=10000&maxIdleTimeMS=30000";

    private static final String URI_WITH_CREDENTIALS =
            "mongodb+srv://user:password@hostname/dbname?retryWrites=true&w=majority&connectTimeoutMS=10000&maxIdleTimeMS=30000";

    private static final String URI_WITH_CREDENTIALS_EMPTY_PWD =
            "mongodb+srv://user:@hostname/dbname?retryWrites=true&w=majority&connectTimeoutMS=10000&maxIdleTimeMS=30000";

    private static final String URI_WITH_UPDATED_CREDENTIALS =
            "mongodb+srv://user:password@hostname/dbname?retryWrites=true&w=majority&connectTimeoutMS=10000&maxIdleTimeMS=30000";

    private static final String URI_WITH_MASKED_PWD =
            "mongodb+srv://user:"
                    + SENSITIVE_VALUE
                    + "@hostname/dbname?retryWrites=true&w=majority&connectTimeoutMS=10000&maxIdleTimeMS=30000";
    ...
    public void shouldFilter_URI_withPassword() throws Exception {
        ...
        filterSensitiveData(
                ...
                (maskedConfig) -> {
                    assertUriEquals(
                            "Password must be replace by '*'", URI_WITH_MASKED_PWD, maskedConfig);
                });
    }
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    assertUriEquals(
                            ...
                            URI_WITHOUT_USERINFO + "custom-param=toto",
                            uriToUpdate);
                });
    }
    ...
    public void shouldUpdate_URI_withoutUserInfo_With_multipleWildcard() throws Exception {
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    assertUriEquals(
                            "URI should be updated",
                            URI_WITHOUT_USERINFO + "custom-param=*******",
                            uriToUpdate);
                });
    }
    ...
    public void shouldUpdate_URI_withoutUserPassword() throws Exception {
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    assertUriEquals(
                            "URI should be updated",
                            URI_WITH_USERNAME + "custom-param=toto",
                            uriToUpdate);
                });
    }
    ...
    public void shouldUpdate_URI_withoutUserPassword_With_multipleWildcard() throws Exception {
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    assertUriEquals(
                            "URI should be updated",
                            URI_WITH_USERNAME + "custom-param=*******",
                            uriToUpdate);
                });
    }
    ...
    public void shouldUpdate_URI_withUserPassword_And_PreservePassword() throws Exception {
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    ...
                    assertUriEquals(
                            "URI should be updated with previous password",
                            URI_WITH_CREDENTIALS + "custom-param=toto",
                            uriToUpdate);
                });
    }
    ...
    public void shouldUpdate_URI_withUserPassword_And_UpdatePassword() throws Exception {
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    ...
                    assertUriEquals(
                            "URI should be updated with the new value",
                            URI_WITH_UPDATED_CREDENTIALS + "custom-param=toto",
                            uriToUpdate);
                });
    }
    ...
    public void shouldUpdate_URI_withUserEmptyPassword_And_UpdatePassword() throws Exception {
        ...
        updateSensitiveData(
                ...
                (uriToUpdate) -> {
                    ...
                    assertUriEquals(
                            "URI should be updated with the new value",
                            URI_WITH_CREDENTIALS_EMPTY_PWD + "custom-param=toto",
                            uriToUpdate);
                });
    }
    ...
    private void assertUriEquals(String message, String expectedValue, String processedConfig) {
        try {
            assertEquals(
                    message,
                    expectedValue,
                    (String) objectMapper.readValue(processedConfig, Map.class).get("uri"));
        } catch (Exception e) {
            fail();
        }
    }
