...
public class OrganizationCommandHandlerTest {
    ...
    public void handle() {
        ...
        organizationPayload.setDomainRestrictions(
                Arrays.asList("domain.restriction1.io", "domain.restriction2.io"));

        when(organizationService.createOrUpdate(
                        eq("orga#1"),
                        argThat(
                                newOrganization ->
                                        newOrganization
                                                        .getHrids()
                                                        .equals(organizationPayload.getHrids())
                                                && newOrganization
                                                        .getDescription()
                                                        .equals(
                                                                organizationPayload
                                                ...
                                                && newOrganization
                                                        .getName()
                                                        .equals(organizationPayload.getName())
                                                && newOrganization
    ...
    public void handleWithException() {
        ...
        when(organizationService.createOrUpdate(eq("orga#1"), any(NewOrganization.class), isNull()))
