...
public class ApplicationScopeSettingsUpgraderTest {
    ...
    public void shouldUpgrade() {
        ...
        oauthWithOptions.setScopeApprovals(
                Maps.<String, Integer>builder().put(SCOPE_PROFILE, 42).build());
        ...
        verify(applicationService, atMost(2))
                .update(
                        argThat(
                                app -> {
                ...
                .update(
                        argThat(
                                app -> {
                                    return app.getSettings() != null
                                            && app.getSettings().getOauth() != null
                                            && app.getSettings().getOauth().getScopeSettings()
                                                    == null;
                                }));
