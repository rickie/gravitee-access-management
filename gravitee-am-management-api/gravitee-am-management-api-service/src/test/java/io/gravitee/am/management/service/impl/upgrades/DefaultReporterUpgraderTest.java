...
public class DefaultReporterUpgraderTest {
    ...
    public void shouldUpdateDefaultIdp() {
        ...
        when(reporterService.update(anyString(), anyString(), any(UpdateReporter.class), eq(true)))
                .thenReturn(changeReporterConfig(true));
        ...
        verify(reporterService, times(1))
                .update(
                        ...
                        argThat(
                                upReporter ->
                                        upReporter.getConfiguration().equals("new-config-created")),
                        anyBoolean());
    }
