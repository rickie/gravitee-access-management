...
private Mono<SystemTask> createSystemTask_migrated(String operationId) {
        ...
        return systemTaskRepository.create_migrated(systemTask).onErrorResume(err->RxJava2Adapter.singleToMono(RxJavaReactorMigrationUtil.<Throwable, Single<SystemTask>>toJdkFunction(err2 -> {
