...
public class UserServiceImpl extends AbstractUserService<io.gravitee.am.service.UserService>
    ...
    @Autowired protected io.gravitee.am.service.UserService userService;
    ...
    public Single<User> create(
            Domain domain, NewUser newUser, io.gravitee.am.identityprovider.api.User principal) {
        ...
        return userService
                .findByDomainAndUsernameAndSource(
                        domain.getId(), newUser.getUsername(), newUser.getSource())
                .isEmpty()
                .flatMap(
                        isEmpty -> {
                            if (FALSE.equals(isEmpty)) {
                                return Single.error(
                                        new UserAlreadyExistsException(newUser.getUsername()));
                            } else {
                                // check user provider
                                                    ...
                                                    return checkClientFunction()
                                                            ...
                                                            .flatMapSingle(
                                                                    optClient -> {
                                                                        ...
                                                                        // identity provider:
                                                                        // - perform first
                                                                        // validation of user to
                                                                        // avoid error status 500
                                                                        // when the IDP is based on
                                                                        // relational databases
                                                                        // - in case of error, trace
                                                                        // the event otherwise
                                                                        ...
                                                                        return userValidator
                                                                                                                                    ...
                                                                                                                                    .equals(
                                                                                                                                            newUser
                                                                                                                                                    ...
                                                                                                                                                    && accountSettings
                                                                                                                                                            != null)
                                                                                                                            && accountSettings
                                                                                                                                    .isDynamicUserRegistration()) {
                                                                                                                        return getUserRegistrationToken(
                                                                                                                                        user)
                                                                                                                                .map(
                                                                                                                                        token -> {
                                                                                                                                            user
                                                                                                                                                    .setRegistrationUserUri(
                                                                                                                                                            domainService
                                                                                                                                                                    .buildUrl(
                                                                                                                                                                            domain,
                                                                                                                                                                            "/confirmRegistration"));
                                                                                ...
                                                                                .flatMap(
                                                                                        user -> {
                                                                                            // end
                                                                                            // pre-registration user if required
                                                                                            AccountSettings
                                                                                                    accountSettings =
                                                                                                            AccountSettings
                                                                                                                    .getInstance(
    ...
    public Completable resetPassword(
            ...
            io.gravitee.am.identityprovider.api.User principal) {
        return userService
                .findById(DOMAIN, domain.getId(), userId)
                .flatMap(
                        user -> {
                            // get client for password settings
                            return checkClientFunction()
                                    .apply(domain.getId(), user.getClient())
                                    ...
                                    .flatMapSingle(
                                            optClient -> {
                                                ...
                                                if (isInvalidUserPassword(
                                                        password,
                                                        optClient.orElse(null),
                                                        domain,
                                                        user)) {
                                                    return Single.error(
                                                            InvalidPasswordException.of(
                                                                    "Field [password] is invalid",
                                                                    "invalid_password_value"));
                                                }
                                                final Client client =
                                                                        ...
                                                                        identityProviderManager
                                                                                ...
                                                                                .flatMap(
                                                                                        idpUser -> {
                                                                                            ...
                                                                                            // was
                                                                                            // in
                                                                                            // pre-registration mode, end the registration process
                                                                                            if (user
                                                                                                    .isPreRegistration()) {
                                                                                                user
                                                                                                        .setRegistrationCompleted(
    ...
    public Completable sendRegistrationConfirmation(
            String domainId, String userId, io.gravitee.am.identityprovider.api.User principal) {
        return domainService
                .findById(domainId)
                .switchIfEmpty(Maybe.error(new DomainNotFoundException(domainId)))
                .flatMapCompletable(
                        domain1 ->
                                findById(DOMAIN, domainId, userId)
                                        .flatMapCompletable(
                                                user -> {
                                                    if (!user.isPreRegistration()) {
                                                        return Completable.error(
                                                                new UserInvalidException(
                                                                        "Pre-registration is disabled for the user "
                                                                                + userId));
                                                    }
                                                    if (user.isPreRegistration()
                                                        ...
                                                        return Completable.error(
                                                                new UserInvalidException(
                                                                        "Registration is completed for the user "
                                                                                + userId));
                                                    }
                                                    // fetch the client
                                                    return checkClientFunction()
                ...
                .flatMap(
                        user -> {
                            ...
                            return identityProviderManager
                                    ...
                                    .switchIfEmpty(
                                            identityProviderManager.getUserProvider(
                                                    user.getSource()))
                                    .switchIfEmpty(
                                            Maybe.error(
                                                    new UserProviderNotFoundException(
                                    ...
                                    .flatMapSingle(
                                            __ -> {
                                                ...
                                                // We also make sure to make it at lock not to
                                                // interfere with LoginAttempt if active
                                                LoginAttemptCriteria criteria =
                                                        new LoginAttemptCriteria.Builder()
                                                                .domain(user.getReferenceId())
                                                                .client(user.getClient())
    ...
    @Override
    public Single<User> enrollFactors(
            String userId,
    ...
    private boolean isInvalidUserPassword(
            String password, Application application, Domain domain, User user) {
    ...
    private Maybe<String> getUserRegistrationToken(User user) {
        ...
        return emailService
                .getEmailTemplate(Template.REGISTRATION_CONFIRMATION, user)
    ...
    private String getUserRegistrationToken(User user, Integer expiresAfter) {
        ...
        claims.put(
                Claims.exp,
                now.plusSeconds((expiresAfter != null ? expiresAfter : expireAfter))
                        .getEpochSecond());
    ...
    private void createPasswordHistory(
        ...
        passwordHistoryService
                ...
                .subscribe(
                        passwordHistory ->
                                logger.debug("Created password history for user with ID {}", user),
