...
public interface UserService extends CommonUserService {
    ...
    Completable sendRegistrationConfirmation(
            String domain, String userId, io.gravitee.am.identityprovider.api.User principal);
    ...
    default Single<User> assignRoles(
            ReferenceType referenceType, String referenceId, String userId, List<String> roles) {
        return assignRoles(referenceType, referenceId, userId, roles, null);
    }

    default Single<User> revokeRoles(
            ReferenceType referenceType, String referenceId, String userId, List<String> roles) {
