...
public class MembershipHelper {
    ...
    /**
     * Helper method to set ORGANIZATION_PRIMARY_OWNER role to the specified user. Note: if the user
     * already has a role, nothing is done.
     *
    ...
    /**
     * Helper method to set PLATFORM_ADMIN role to the primary owner of the default organization. In
     * a standalone installation, someone needs to be defined as platform admin to be able to access
     * some features outside of the organization scope. It seems that the primary owner of the
     * default organization is the best choice we can make. Note: if the user already has a role,
     * nothing is done.
     */
    public void setPlatformAdminRole() {

        Role organizationPrimaryOwnerRole =
                roleService
                        .findSystemRole(
                                SystemRole.ORGANIZATION_PRIMARY_OWNER, ReferenceType.ORGANIZATION)
                        .blockingGet();
    ...
    /**
     * Helper method to set specified organization role to the specified user. Note: if the user
     * already has a role, nothing is done.
     *
     * @param user the user to define the role on.
     */
    public void setOrganizationRole(User user, Role role) {
        ...
        // If admin user already has a role on the default organization no need to do anything
        // (either he is already admin, either someone decided to change his role).
