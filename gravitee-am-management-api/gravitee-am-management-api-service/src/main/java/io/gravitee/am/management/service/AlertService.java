...
public class AlertService {
    ...
    /**
     * Indicates if alerting is available or not. The alerting feature is available if there is at
     * least one trigger provider registered (meaning AM is connected to alert engine).
     *
