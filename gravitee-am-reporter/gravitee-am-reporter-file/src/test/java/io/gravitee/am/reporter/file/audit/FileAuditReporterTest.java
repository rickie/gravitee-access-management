...
public abstract class FileAuditReporterTest {
    ...
    protected void assertReportEqualsTo(Audit audit, AuditEntry test) {
        ...
        assertTrue(
                test.getTarget().getAlternativeId().equals(audit.getTarget().getAlternativeId()));
    ...
    protected String buildAuditLogsFilename() {
        ...
        String filename =
                Paths.get(
                                System.getProperty(FileAuditReporter.REPORTERS_FILE_DIRECTORY),
                                context.getOrganizationId(),
                                context.getEnvironmentId(),
                                context.getDomainId(),
                                "FileAuditReporterTest-"
