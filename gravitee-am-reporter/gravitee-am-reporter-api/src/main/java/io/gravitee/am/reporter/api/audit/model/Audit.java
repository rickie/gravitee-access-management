 ...
 *
 * <p>See <a href="https://tools.ietf.org/html/rfc3881#section-5">5. Data Definitions</a>
 *
 * <p>1) Event Identification - what was done 2) Active Participant Identification - by whom 3)
 * Network Access Point Identification - initiated from where 4) Audit Source Identification - using
 * which server 5) Participant Object Identification - to what record
 *
...
public class Audit implements Reportable {
    ...
    /**
     * The access point that performs the event (OAuth client or HTTP client (e.g web browser) with
     * ip address, user agent, geographical information)
     */
