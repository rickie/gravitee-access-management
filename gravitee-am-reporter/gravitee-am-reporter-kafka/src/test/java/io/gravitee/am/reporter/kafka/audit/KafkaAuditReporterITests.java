...
@ContextConfiguration(
        classes = JUnitConfiguration.class,
...
public class KafkaAuditReporterITests extends TestCase {
    ...
    @Autowired protected KafkaReporterConfiguration kafkaReporterConfiguration;
    ...
    public void Should_WriteEventAsJson_When_EventIsAudit() throws URISyntaxException, IOException {
        ...
        config.put(
                ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, this.kafkaContainer.getBootstrapServers());
        ...
        kafkaConsumer.subscribe(
                Collections.singletonList(this.kafkaReporterConfiguration.getTopic()));
        ...
        assertEquals(new String(expected, StandardCharsets.UTF_8), record.value());
    }
}
