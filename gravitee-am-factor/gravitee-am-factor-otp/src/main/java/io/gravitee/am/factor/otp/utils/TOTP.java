 ...
 * reserved.
 *
 * <p>Redistribution and use in source and binary forms, with or without modification, is permitted
 ...
 *
 * <p>See <a href="https://tools.ietf.org/html/rfc6238#appendix-A">Appendix A. TOTP Algorithm:
...
public final class TOTP {
    ...
    public static String generateTOTP(String key) {
        ...
        // 6 digits to return
        return generateTOTP(
                key, Long.toHexString(System.currentTimeMillis() / 30000).toUpperCase(), "6");
    }
