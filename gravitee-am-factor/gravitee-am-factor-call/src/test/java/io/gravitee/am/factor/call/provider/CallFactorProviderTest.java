...
public class CallFactorProviderTest {
    ...
    @InjectMocks private CallFactorProvider provider;

    @Mock private CallFactorConfiguration configuration;
    ...
    public void shouldValidatePhoneNumber() {
        ...
        factor.setChannel(
                new EnrolledFactorChannel(EnrolledFactorChannel.Type.CALL, "+33615492508"));
