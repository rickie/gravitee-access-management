...
public class ClientTest {
    ...
    public void testClone() throws CloneNotSupportedException {
        ...
        from.setRedirectUris(
                Stream.of("http://host/callback", "http://host/login")
        ...
        // redirect uris
        assertTrue(
                "same redirect uris size",
                to.getRedirectUris() != null
                        && to.getRedirectUris().size() == from.getRedirectUris().size());
        assertTrue(
                "same redirect uris values",
                to.getRedirectUris().containsAll(from.getRedirectUris()));
