...
/**
 * See <a
 * href="https://www.oasis-open.org/committees/download.php/56786/sstc-saml-metadata-errata-2.0-wd-05-diff.pdf">2.4.4
 * Element <SPSSODescriptor></a>
 *
...
public class ApplicationSAMLSettings {
    ...
    /**
     * Single Logout Service URL — the SP endpoint where the IdP should redirect to after performing
     * single logout
     */
    private String singleLogoutServiceUrl;
    /**
     * X.509 Public Key Certificate — the SP's base-64 encoded public key certificate, which is used
     * by the IdP to verify SAML authorization requests
     */
