...
public class OIDCSettings {
    ...
    /**
     * Enable redirect_uri strict matching during OIDC flow (check for redirect_uri_mismatch
     * exception)
     */
    ...
    /**
     * Array of URLs supplied by the RP to restrict the possible values of the request_uri
     * parameter. https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter
     */
    ...
    public ClientRegistrationSettings getClientRegistrationSettings() {
        return clientRegistrationSettings != null
                ? clientRegistrationSettings
                : ClientRegistrationSettings.defaultSettings();
    }

    public void setClientRegistrationSettings(
