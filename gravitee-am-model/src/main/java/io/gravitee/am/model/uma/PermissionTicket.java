...
/**
 * Permission Ticket including permission request and ticket response ID. See <a
 * href="https://docs.kantarainitiative.org/uma/wg/rec-oauth-uma-federated-authz-2.0.html#rfc.section.4.1">here</a>
 *
...
public class PermissionTicket {
    ...
    /** Permission Ticket technical id Named as ticket on Permission Endpoint */
    private String id;
