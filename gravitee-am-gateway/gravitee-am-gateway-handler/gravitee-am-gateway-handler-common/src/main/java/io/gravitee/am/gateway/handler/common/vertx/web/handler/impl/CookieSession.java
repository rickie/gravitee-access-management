...
public class CookieSession extends AbstractSession {
    ...
    public CookieSession(
            JWTService jwtService, CertificateProvider certificateProvider, long timeout) {
    ...
    public Session put(String key, Object obj) {
        ...
        if (key.equalsIgnoreCase(CookieSessionHandler.USER_ID_KEY)) {
            throw new IllegalArgumentException(
                    CookieSessionHandler.USER_ID_KEY + " can not be used as a session key!");
        }
    ...
    protected Single<CookieSession> setValue(String payload) {
        ...
        return this.jwtService
                .decodeAndVerify(payload, certificateProvider)
                .doOnSuccess(
                        jwt -> {
