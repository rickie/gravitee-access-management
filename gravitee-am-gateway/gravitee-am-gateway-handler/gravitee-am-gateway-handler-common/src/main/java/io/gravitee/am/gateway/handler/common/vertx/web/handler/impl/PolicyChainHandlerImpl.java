...
public class PolicyChainHandlerImpl implements PolicyChainHandler {
    ...
    @Autowired private FlowManager flowManager;
    ...
    public Handler<RoutingContext> create(ExtensionPoint extensionPoint) {
        ...
        return new io.gravitee.am.gateway.handler.common.vertx.web.handler.impl.internal
                .PolicyChainHandlerImpl(
                flowManager, policyChainProcessorFactory, executionContextFactory, extensionPoint);
    }
}
