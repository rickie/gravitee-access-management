 ...
 */
public class AuthenticationEventListener extends AbstractService
        implements EventListener<AuthenticationEvent, AuthenticationDetails> {
    ...
    protected void doStart() throws Exception {
        ...
        logger.info(
                "Register event listener for authentication events for domain {}",
                domain.getName());
    ...
    protected void doStop() throws Exception {
        ...
        logger.info(
                "Dispose event listener for authentication events for domain {}", domain.getName());
