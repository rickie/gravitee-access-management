...
public interface JWTService {
    ...
    /**
     * Encode raw JWT to JWT signed representation using userinfo_signed_response_alg Client
     * preferences.
     *
     * @param jwt JWT to encode
     * @param client client which want to sign the token
    ...
    /**
     * Encode raw JWT to JWT signed representation using authorization_signed_response_alg Client
     * preferences.
     *
     * @param jwt JWT to encode
     * @param client client which want to sign the token
