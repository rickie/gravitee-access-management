...
public class UserServiceImpl implements UserService {
    ...
    public Single<Set<ScopeApproval>> consents(String userId) {
        return scopeApprovalService
                .findByDomainAndUser(domain.getId(), userId)
    ...
    public Single<Set<ScopeApproval>> consents(String userId, String clientId) {
        return scopeApprovalService
                .findByDomainAndUserAndClient(domain.getId(), userId, clientId)
                .collect(HashSet::new, Set::add);
    }
    ...
    @Override
    public Completable revokeConsent(
    ...
    @Override
    public Completable revokeConsents(
            String userId, io.gravitee.am.identityprovider.api.User principal) {
        return scopeApprovalService.revokeByUser(domain.getId(), userId, principal);
    }

    @Override
    public Completable revokeConsents(
            String userId, String clientId, io.gravitee.am.identityprovider.api.User principal) {
        return scopeApprovalService.revokeByUserAndClient(
                domain.getId(), userId, clientId, principal);
    }
}
