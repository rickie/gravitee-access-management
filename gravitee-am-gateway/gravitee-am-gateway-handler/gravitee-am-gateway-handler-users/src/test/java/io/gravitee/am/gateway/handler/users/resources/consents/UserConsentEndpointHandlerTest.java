...
public class UserConsentEndpointHandlerTest extends RxWebTestBase {
    ...
    @InjectMocks
    private UserConsentEndpointHandler userConsentEndpointHandler =
            new UserConsentEndpointHandler(userService, clientService, domain);
    ...
    public void shouldNotGetConsent_notFound() throws Exception {
        ...
        when(userService.consent(anyString()))
                .thenReturn(Maybe.error(new ScopeApprovalNotFoundException("consentId")));
    ...
    public void shouldRevokeConsent() throws Exception {
        ...
        when(userService.revokeConsent(anyString(), anyString(), any()))
