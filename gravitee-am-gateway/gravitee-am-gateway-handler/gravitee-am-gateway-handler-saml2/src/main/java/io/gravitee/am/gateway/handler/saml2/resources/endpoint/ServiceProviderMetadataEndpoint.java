 ...
 *
 * <p>- The entityID attribute is the unique identifier of the entity. - The validUntil attribute
 * gives the expiration date of the metadata. - The <ds:Signature> element (which has been omitted
 * for simplicity) contains a digital signature that ensures the authenticity and integrity of the
 * metadata. - The organization identified in the <md:Organization> element is "responsible for the
 * entity" described by the entity descriptor. - The contact information in the <md:ContactPerson>
 * element identifies a technical contact responsible for the entity. Multiple contacts and contact
 * types are possible.
 *
                ...
                .subscribe(
                        ...
                        error ->
                                routingContext
                                        .response()
                                        .setStatusCode(
                                                error instanceof AbstractManagementException
                                                        ? ((AbstractManagementException) error)
                                                                .getHttpStatusCode()
                                                        : 500)
                                        .end());
    }
