...
/**
 * This endpoint aim to access to client-id generated through the dynamic client registration
 * protocol. See <a href="https://openid.net/specs/openid-connect-registration-1_0.html">Openid
 * Connect Dynamic Client Registration</a> See <a href="https://tools.ietf.org/html/rfc7591">OAuth
 * 2.0 Dynamic Client Registration Protocol</a>
 *
...
public class DynamicClientAccessEndpoint extends DynamicClientRegistrationEndpoint {
    ...
    public DynamicClientAccessEndpoint(
            DynamicClientRegistrationService dcrService, ClientSyncService clientSyncService) {
        super(dcrService, clientSyncService);
    }

    /**
     * Read client_metadata. See <a
     * href="https://openid.net/specs/openid-connect-registration-1_0.html#ReadRequest">Read
     * Request</a> See <a
     * href="https://openid.net/specs/openid-connect-registration-1_0.html#ReadResponse">Read
     * Response</a>
     *
     * @param context
     */
    public void read(RoutingContext context) {
        ...
        this.getClient(context)
                ...
                .map(
                        response -> {
                            // The Authorization Server need not include the registration
                            // access_token or client_uri unless they have been updated.
    ...
    public void renewClientSecret(RoutingContext context) {
        ...
        this.getClient(context)
                ...
                .flatMap(
                        toRenew ->
                                dcrService.renewSecret(
                                        toRenew, UriBuilderRequest.resolveProxyRequest(context)))
                .map(clientSyncService::addDynamicClientRegistred)
                .subscribe(
                        client ->
                                context.response()
