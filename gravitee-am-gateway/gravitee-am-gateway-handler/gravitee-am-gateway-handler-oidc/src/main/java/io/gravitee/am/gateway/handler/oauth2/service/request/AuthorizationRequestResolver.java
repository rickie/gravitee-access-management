...
public class AuthorizationRequestResolver extends AbstractRequestResolver<AuthorizationRequest> {
    ...
    public Single<AuthorizationRequest> resolve(
    ...
    /**
     * redirect_uri request parameter is OPTIONAL, but the RFC (rfc6749) assumes that the request
     * fails due to a missing, invalid, or mismatching redirection URI. If no redirect_uri request
     * parameter is supplied, the client must at least have one registered redirect uri
     *
     * <p>See <a href="https://tools.ietf.org/html/rfc6749#section-4.1.2.1">4.1.2.1. Error
     * Response</a>
     *
