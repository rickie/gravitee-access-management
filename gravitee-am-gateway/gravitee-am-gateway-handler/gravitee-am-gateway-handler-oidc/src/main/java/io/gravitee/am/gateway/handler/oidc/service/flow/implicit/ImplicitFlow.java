...
/**
 * When using the Implicit Flow, all tokens are returned from the Authorization Endpoint; the Token
 * Endpoint is not used.
 *
 * <p>The Implicit Flow is mainly used by Clients implemented in a browser using a scripting
 * language.
 *
 * <p>The Access Token and ID Token are returned directly to the Client, which may expose them to
 * the End-User and applications that have access to the End-User's User Agent.
 *
 * <p>The Authorization Server does not perform Client Authentication.
 *
 ...
 * sends the End-User back to the Client with an ID Token and, if requested, an Access Token. .
 * Client validates the ID token and retrieves the End-User's Subject Identifier.
 *
 * <p>See <a href="https://openid.net/specs/openid-connect-core-1_0.html#ImplicitFlowAuth">3.2.
...
public class ImplicitFlow extends AbstractFlow {
    ...
    protected Single<AuthorizationResponse> prepareResponse(
        ...
        if (io.gravitee.am.common.oidc.ResponseType.ID_TOKEN.equals(
