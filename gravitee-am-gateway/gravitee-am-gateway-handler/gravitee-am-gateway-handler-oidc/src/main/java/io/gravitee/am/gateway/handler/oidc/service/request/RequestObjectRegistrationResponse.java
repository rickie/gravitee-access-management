...
public class RequestObjectRegistrationResponse {
    ...
    // [RFC7519]. When a
    // pure OAuth 2.0 is used, the value is the redirection URI. When OpenID Connect is used, the
    // value is the issuer
    // value of the authorization server.
    private String iss;

    // A JSON string that represents the client identifier of the client that posted the request
    // object.
    private String aud;
