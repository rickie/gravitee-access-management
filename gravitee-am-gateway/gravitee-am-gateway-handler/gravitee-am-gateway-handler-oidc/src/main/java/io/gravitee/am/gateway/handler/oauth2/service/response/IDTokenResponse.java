...
/**
 * When using the Implicit Flow, all response parameters are added to the fragment component of the
 * Redirection URI, as specified in OAuth 2.0 Multiple Response Type Encoding Practices
 * [OAuth.Responses], unless a different Response Mode was specified.
 *
 * <p>ID token is returned if the response_type value used is id_token.
 *
 * <p>See <a
 * href="https://openid.net/specs/openid-connect-core-1_0.html#HybridAuthResponse">3.3.2.5.
 * Successful Authentication Response</a> See <a
 * href="https://openid.net/specs/oauth-v2-multiple-response-types-1_0.html#id_token">3. ID Token
 * Response Type</a>
 *
