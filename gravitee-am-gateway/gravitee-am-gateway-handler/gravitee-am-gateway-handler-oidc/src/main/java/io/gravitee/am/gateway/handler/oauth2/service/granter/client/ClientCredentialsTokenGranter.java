...
/**
 * Implementation of the Client Credentials Grant Flow See <a
 * href="https://tools.ietf.org/html/rfc6749#section-4.4"></a>
 *
...
public class ClientCredentialsTokenGranter extends AbstractTokenGranter {
    ...
    public ClientCredentialsTokenGranter() {
        ...
        // See <a href="https://tools.ietf.org/html/rfc6749#section-4.4.3">4.4.3. Access Token
        // Response</a>
        setSupportRefreshToken(false);
    }

    public ClientCredentialsTokenGranter(
            TokenRequestResolver tokenRequestResolver, TokenService tokenService) {
        this();
