...
@Override
    protected Mono<AuthorizationResponse> prepareResponse_migrated(AuthorizationRequest authorizationRequest, Client client, User endUser) {
        ...
        return authorizationCodeService.create_migrated(authorizationRequest, endUser).flatMap(v->RxJava2Adapter.singleToMono((Single<AuthorizationResponse>)RxJavaReactorMigrationUtil.toJdkFunction((Function<AuthorizationCode, Single<AuthorizationResponse>>)code -> {
                    // prepare response
