...
public abstract class AbstractAuthorizationRequestHandler {
    ...
    protected boolean isJwtAuthRequest(RoutingContext context) {
        return !StringUtils.isEmpty(
                        context.request()
                                .getParam(io.gravitee.am.common.oidc.Parameters.REQUEST_URI))
                || !StringUtils.isEmpty(
                        context.request().getParam(io.gravitee.am.common.oidc.Parameters.REQUEST));
    }

    protected void checkResponseType(
            String responseType, OpenIDProviderMetadata openIDProviderMetadata) {
