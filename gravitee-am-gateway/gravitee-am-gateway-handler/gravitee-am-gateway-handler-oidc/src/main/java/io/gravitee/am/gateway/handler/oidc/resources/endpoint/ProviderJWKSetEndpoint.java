...
/**
 * The JWKSet Endpoint provide a set of JWKs (keys) to enable clients to verify the authenticity of
 * JWT tokens.
 *
 * <p>A JWK Set is a JSON object that represents a set of JWKs. The JSON object MUST have a "keys"
 * member, with its value being an array ofxJWKs. This JSON object MAY contain whitespace and/or
 * line breaks.
 *
 * <p>See <a href="https://tools.ietf.org/html/rfc7517#section-5">5. JWK Set Format</a>
 *
