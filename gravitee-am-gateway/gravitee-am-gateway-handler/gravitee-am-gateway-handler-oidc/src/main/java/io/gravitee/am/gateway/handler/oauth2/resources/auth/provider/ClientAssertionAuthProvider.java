...
public class ClientAssertionAuthProvider implements ClientAuthProvider {
    ...
    public void handle(Client client, RoutingContext context, Handler<AsyncResult<Client>> handler) {
        ...
        clientAssertionService.assertClient_migrated(clientAssertionType, clientAssertion, basePath).flatMap(v->RxJava2Adapter.maybeToMono(Maybe.wrap(RxJavaReactorMigrationUtil.<Client, MaybeSource<Client>>toJdkFunction(client1 -> {
