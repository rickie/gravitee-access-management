 ...
 */
public class AuthorizationRequestParseProviderConfigurationHandler
        implements Handler<RoutingContext> {

    private final OpenIDDiscoveryService openIDDiscoveryService;

    public AuthorizationRequestParseProviderConfigurationHandler(
    ...
    public void handle(RoutingContext context) {
        ...
        context.put(
                PROVIDER_METADATA_CONTEXT_KEY, openIDDiscoveryService.getConfiguration(basePath));
        context.next();
    }
}
