...
/**
 * The authorization server must ensure that the client used for the Authorization Request is
 * registered and should not redirect to login page if the client does not exist
 *
