 ...
 * its protected resources) used by the client to obtain an access token. This specification defines
 * four grant types -- authorization code, implicit, resource owner password credentials, and client
 * credentials -- as well as an extensibility mechanism for defining additional types.
 *
...
public interface TokenGranter {
    ...
    /**
     * The client requests an access token by authenticating with the authorization server and
     * presenting the authorization grant.
     *
     * @param tokenRequest Access Token Request
     * @param client OAuth2 client
     * @return The authorization server authenticates the client and validates the authorization
