...
/**
 * UMA Specification state that if the resource server request used an unsupported HTTP method, the
 * authorization server MUST respond with the HTTP 405 (Method Not Allowed) status code and MAY
 * respond with an unsupported_method_type error code.
 *
