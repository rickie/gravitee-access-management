...
public class OAuth2Request extends BaseRequest {
     ...
     * identifier is not a secret; it is exposed to the resource owner and MUST NOT be used alone
     * for client authentication. The client identifier is unique to the authorization server.
     *
     * <p>The client identifier string size is left undefined by this specification. The client
     * should avoid making assumptions about the identifier size. The authorization server SHOULD
     * document the size of any identifier it issues.
     *
     * <p>See <a href="https://tools.ietf.org/html/rfc6749#section-2.2">Client Identifier</a>
     */
     ...
     * OPTIONAL
     *
     * <p>After completing its interaction with the resource owner, the authorization server directs
     * the resource owner's user-agent back to the client. The authorization server redirects the
     * user-agent to the client's redirection endpoint previously established with the authorization
     * server during the client registration process or when making the authorization request.
     *
     * <p>See <a href="https://tools.ietf.org/html/rfc6749#section-3.1.2"></a>
     */
    ...
    /**
     * REQUIRED for <a href=" https://datatracker.ietf.org/doc/html/rfc8705#section-3.1">Certificate
     * Bound Access Token</a>
     */
