...
/**
 * Implementation of the CIBA Grant Flow See <a
 * href="https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html#rfc.section.10"></a>
 *
                                        ...
                                        .map(
                                                cibaRequest -> {
                                                    if (!cibaRequest
                                                        ...
                                                        logger.warn(
                                                                "client_id '{}' requests token using not owned authentication request '{}'",
                                                                client.getId(),
                                                                authReqId);
                                        ...
                                        .map(
                                                cibaRequest -> {
                                                    ...
                                                    tokenRequest1.setSubject(
                                                            cibaRequest.getSubject());
                                                    // set original scopes
                                                    tokenRequest1.setScopes(
                                                            cibaRequest.getScopes());
                                                    ...
                                                    // enrichAuthFlow Policy ius used multiple time
                                                    // in a step
