...
public interface JWEService {
    ...
    /**
     * Encode raw JWT to JWT signed representation using id_token_encrypted_response_alg Client
     * preferences.
     *
    ...
    /**
     * Encode raw JWT to JWT signed representation using userinfo_encrypted_response_alg Client
     * preferences.
     *
     * @param signedJwt Signed JWT to encrypt
     * @param client client which want to encrypt the token
    ...
    /**
     * Decrypt JWT send by RP. This decryption action will use a private key provided by the domain
     * jwks
     *
     * @param jwt
     * @param encRequired true if the jwt has to be encrypted
    ...
    /**
     * Encode raw JWT to JWT signed representation using authorization_encrypted_response_alg Client
     * preferences.
     *
     * @param signedJwt Signed JWT to encrypt
     * @param client client which want to encrypt the token
