...
public interface PushedAuthorizationRequestService {
     ...
     * one, the JWT is validated first and returned as it. If request parameter is missing, JWT is
     * build from other parameters as a PlainJWT (with the aud claim targeting initialized with the
     * value provider through the issuer OIDC metadata)
     *
     * @param requestUri
     * @param client
     * @return
     ...
     * @return
     */
    Single<PushedAuthorizationRequestResponse> registerParameters(
