...
/**
 * If the resource owner grants the access request, the authorization server issues an access token
 * and delivers it to the client by adding the following parameters to the fragment component of the
 * redirection URI.
 *
 * <p>See <a href="https://tools.ietf.org/html/rfc6749#section-4.2.2">4.2.2. Access Token
 * Response</a>
 *
...
public class ImplicitResponse extends AuthorizationResponse {
     ...
     *
     * <p>Note : The authorization server MUST NOT issue a refresh token.
     */
