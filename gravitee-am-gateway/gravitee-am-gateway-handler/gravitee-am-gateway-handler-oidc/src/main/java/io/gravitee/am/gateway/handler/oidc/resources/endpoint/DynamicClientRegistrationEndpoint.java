...
public class DynamicClientRegistrationEndpoint implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext context) {
        ...
        this.extractRequest_migrated(context).flatMap(request->dcrService.create_migrated(request, UriBuilderRequest.resolveProxyRequest(context))).map(RxJavaReactorMigrationUtil.toJdkFunction(clientSyncService::addDynamicClientRegistred)).subscribe(client -> context.response()
