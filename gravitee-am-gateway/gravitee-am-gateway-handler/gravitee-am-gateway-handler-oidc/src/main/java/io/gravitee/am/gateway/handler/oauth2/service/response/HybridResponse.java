...
/**
 * When using the Hybrid Flow, Authentication Responses are made in the same manner as for the
 * Implicit Flow, as defined in Section 3.2.2.5, with the exception of the differences specified in
 * this section. These Authorization Endpoint results are used in the following manner:
 *
 * <p>- access_token OAuth 2.0 Access Token. This is returned when the response_type value used is
 * code token, or code id_token token. (A token_type value is also returned in the same cases.)
 *
 * <p>- id_token ID Token. This is returned when the response_type value used is code id_token or
 * code id_token token.
 *
 * <p>- code Authorization Code. This is always returned when using the Hybrid Flow.
 *
 * <p>See <a
 * href="https://openid.net/specs/openid-connect-core-1_0.html#HybridAuthResponse">3.3.2.5.
    ...
    public String buildRedirectUri() throws URISyntaxException {
        ...
        if (getIdToken() != null) {
            ...
            uriBuilder.addFragmentParameter(
                    Token.EXPIRES_IN, String.valueOf(accessToken.getExpiresIn()));
            ...
            if (accessToken.getAdditionalInformation() != null) {
                accessToken
                        ...
                        .forEach((k, v) -> uriBuilder.addFragmentParameter(k, String.valueOf(v)));
            }
        }
