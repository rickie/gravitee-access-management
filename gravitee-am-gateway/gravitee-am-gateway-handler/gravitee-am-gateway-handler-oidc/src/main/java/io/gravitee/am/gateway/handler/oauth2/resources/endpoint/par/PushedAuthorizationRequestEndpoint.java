...
public class PushedAuthorizationRequestEndpoint implements Handler<RoutingContext> {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(PushedAuthorizationRequestEndpoint.class);
    ...
    public void handle(RoutingContext context) {
        ...
        // authenticate with the authorization server when making requests to the pushed
        ...
        parService
                .registerParameters(request, client)
                .subscribe(
                        response -> {
                            context.response()
                                    ...
                                    .putHeader(
                                            io.gravitee.common.http.HttpHeaders.CACHE_CONTROL,
                                            "no-store")
                                    .putHeader(
                                            io.gravitee.common.http.HttpHeaders.PRAGMA, "no-cache")
