...
public class RequestObjectServiceTest {
    ...
    @InjectMocks private RequestObjectService requestObjectService = new RequestObjectServiceImpl();
    ...
    public void shouldNotReadRequestObject_plainJwt() {
        ...
        TestObserver<JWT> testObserver =
                requestObjectService.readRequestObject(request, client, false).test();
    ...
    public void shouldReadRequestObjectFromURI_URL_notRestricted() throws ParseException {
        ...
        TestObserver<JWT> testObserver =
                requestObjectService.readRequestObjectFromURI(request, client).test();
        ...
        verify(jweService)
                .decrypt(argThat(json -> json.equals("request_uri_payload")), anyBoolean());
    }
