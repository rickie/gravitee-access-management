...
public class RevocationTokenEndpointTest extends RxWebTestBase {
    ...
    @Mock private RevocationTokenService revocationTokenService;
    ...
    public void shouldNotInvokeRevocationTokenEndpoint_invalidClient() throws Exception {
        ...
        when(revocationTokenService.revoke(any(), any()))
                .thenReturn(Completable.error(new InvalidGrantException()));
