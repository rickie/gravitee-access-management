...
public class ResourceRegistrationAccessHandlerTest {
    ...
    @InjectMocks
    private UMAProtectionApiAccessHandler handler =
            new UMAProtectionApiAccessHandler(domain, oAuth2AuthHandler);
    ...
    public void testWhenUmaNotYetSetOnDomain() {
        ...
        Assert.assertTrue(
                "Should return a forbidden exception",
                exceptionCaptor.getValue() instanceof UMAProtectionApiForbiddenException);
    }
