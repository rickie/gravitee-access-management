...
public class OpenIDDiscoveryServiceTest {
    ...
    public void prepare() {
        ...
        when(environment.getProperty("http.ssl.clientAuth", String.class, "none"))
                .thenReturn("none");
    }
    ...
    private void enableMtls() {
        ...
        when(environment.getProperty("http.ssl.clientAuth", String.class, "none"))
                .thenReturn("required");
        when(environment.getProperty(ConstantKeys.HTTP_SSL_ALIASES_BASE_URL, String.class, "/"))
                .thenReturn("/");
    }
    ...
    public void shouldContain_id_token_signing_alg_values_supported() {
        ...
        assertTrue(
                JWAlgorithmUtils.getSupportedIdTokenSigningAlg()
                        .containsAll(openIDProviderMetadata.getIdTokenSigningAlgValuesSupported()));
    }
    ...
    public void shouldContain_brazil_claim_supported() {
        ...
        assertTrue(
                openIDProviderMetadata
                        .getClaimsSupported()
                        .containsAll(OpenIDDiscoveryServiceImpl.BRAZIL_CLAIMS));
    }
    ...
    public void shouldContain_brazil_acr_values_supported() {
        ...
        assertTrue(
                openIDProviderMetadata
                        ...
                        .containsAll(BrazilAcrValues.values()));
    }
    ...
    public void shouldContain_userinfo_signing_alg_values_supported() {
        ...
        assertTrue(
                JWAlgorithmUtils.getSupportedUserinfoSigningAlg()
                        .containsAll(
                                openIDProviderMetadata.getUserinfoSigningAlgValuesSupported()));
    }
    ...
    public void shouldContain_tls_client_certificate_bound_access_tokens() throws Exception {
        ((OpenIDDiscoveryServiceImpl) openIDDiscoveryService)
                .setMtlsAliasEndpoints(
                        Arrays.asList(
        ...
        assertTrue(
                "revocation endpoint is required",
                openIDProviderMetadata.getMtlsAliases().getRevocationEndpoint().contains("revoke"));
        assertTrue(
        ...
        assertTrue(
                ...
                openIDProviderMetadata.getMtlsAliases().getUserinfoEndpoint().contains("userinfo"));
        assertTrue(
                "token endpoint is required",
                openIDProviderMetadata.getMtlsAliases().getTokenEndpoint().contains("token"));
        assertTrue(
                ...
                openIDProviderMetadata
                        ...
                        .contains("authorize"));
        assertTrue(
                "par endpoint is required",
                openIDProviderMetadata.getMtlsAliases().getParEndpoint().contains("par"));
        assertTrue(
                "endSession endpoint is required",
                openIDProviderMetadata.getMtlsAliases().getEndSessionEndpoint().contains("logout"));
        assertTrue(
                "introspection endpoint is required",
                openIDProviderMetadata
                        .getMtlsAliases()
    ...
    public void shouldContainsCIBAMetadata() {
        ...
        assertTrue(
                openIDProviderMetadata
                        ...
                        .containsAll(List.of(CIBADeliveryMode.POLL)));
    }
}
