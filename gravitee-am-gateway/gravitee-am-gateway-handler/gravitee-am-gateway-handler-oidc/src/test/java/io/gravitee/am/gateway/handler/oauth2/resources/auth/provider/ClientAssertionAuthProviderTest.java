...
public class ClientAssertionAuthProviderTest {
    ...
    public void authorized_client() throws Exception {
        ...
        when(clientAssertionService.assertClient_migrated(any(),any(),any())).thenReturn(Mono.just(client));
    ...
    public void unauthorized_invalidClient_assertion_type() throws Exception {
        ...
        when(clientAssertionService.assertClient_migrated(any(),any(),any())).thenReturn(Mono.error(new InvalidClientException("Unknown or unsupported assertion_type")));
