...
public class AuthorizationEndpointTest extends RxWebTestBase {
    ...
    @Mock private ThymeleafTemplateEngine thymeleafTemplateEngine;
    ...
    public void setUp() throws Exception {
        ...
        AuthorizationEndpoint authorizationEndpointHandler =
                new AuthorizationEndpoint(flow, thymeleafTemplateEngine, parService);
        ...
        when(openIDDiscoveryService.getConfiguration(anyString()))
                .thenReturn(openIDProviderMetadata);
        when(environment.getProperty("authorization.code.validity", Integer.class, 60000))
                .thenReturn(60000);
        ...
        router.route()
                .failureHandler(
                        new AuthorizationRequestFailureHandler(
                                openIDDiscoveryService, jwtService, jweService, environment));
                            ...
                            routingContext.setUser(
                                    new User(
                                            new io.gravitee.am.gateway.handler.common.vertx.web.auth
                                                    .user.User(new io.gravitee.am.model.User())));
                            routingContext.next();
                        });
    ...
    public void shouldNotInvokeAuthorizationEndpoint_mismatchRedirectUri() throws Exception {
        ...
        client.setRedirectUris(
                Collections.singletonList("http://localhost:9999/authorize/callback"));
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.contains(
                                    "/test/oauth/error?client_id=client-id&error=redirect_uri_mismatch&error_description=The+redirect_uri+%255B+http%253A%252F%252Flocalhost%253A9999%252Fwrong%252Fcallback+%255D+MUST+match+the+registered+callback+URL+for+this+application"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldNotInvokeAuthorizationEndpoint_mismatchRedirectUri_strictMatching()
        ...
        authorizationRequest.setRedirectUri(
                "http://localhost:9999/authorize/callback?param=param1");
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.contains(
                                    "/test/oauth/error?client_id=client-id&error=redirect_uri_mismatch&error_description=The+redirect_uri+%255B+http%253A%252F%252Flocalhost%253A9999%252Fauthorize%252Fcallback%253Fparam%253Dparam1+%255D+MUST+match+the+registered+callback+URL+for+this+application"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldInvokeAuthorizationEndpoint_noStrictMatching() throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertNotNull(location);
                    assertEquals(
                            "http://localhost:9999/authorize/callback?param=param1&code=test-code",
                            location);
                },
                HttpStatusCode.FOUND_302,
                "Found",
        ...
        router.route()
                ...
                .handler(
                        routingContext -> {
                            routingContext
                                    .session()
                                    .put(ConstantKeys.USER_LOGIN_COMPLETED_KEY, true);
                            routingContext.setUser(
                                    new User(
                                            new io.gravitee.am.gateway.handler.common.vertx.web.auth
                                                    .user.User(new io.gravitee.am.model.User())));
    ...
    public void shouldNotInvokeAuthorizationEndpoint_implicitFlow_nonceMissing() throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.contains(
                                    "error=invalid_request&error_description=Missing+parameter%253A+nonce+is+required+for+Implicit+and+Hybrid+Flow"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldInvokeAuthorizationEndpoint_hybridFlow_code_IDToken_token() throws Exception {
        ...
        ((AccessToken) accessToken)
                .setAdditionalInformation(Collections.singletonMap("id_token", "test-id-token"));
        shouldInvokeAuthorizationEndpoint_hybridFlow(
                io.gravitee.am.common.oidc.ResponseType.CODE_ID_TOKEN_TOKEN,
    ...
    public void shouldInvokeAuthorizationEndpoint_responseModeQueryJWT() throws Exception {
        ...
        JWTAuthorizationCodeResponse jwtAuthorizationCodeResponse =
                new JWTAuthorizationCodeResponse(authorizationResponse);
    ...
    public void shouldNotInvokeAuthorizationEndpoint_mismatchRedirectUri_responseModeQueryJWT()
        ...
        when(jwtService.encodeAuthorization(any(JWT.class), eq(client)))
                .thenReturn(Single.just("my-jwt"));
        when(jweService.encryptAuthorization(anyString(), eq(client)))
                .then(
                        new Answer<Single<String>>() {
                            @Override
                            public Single<String> answer(InvocationOnMock invocation)
                                    throws Throwable {
