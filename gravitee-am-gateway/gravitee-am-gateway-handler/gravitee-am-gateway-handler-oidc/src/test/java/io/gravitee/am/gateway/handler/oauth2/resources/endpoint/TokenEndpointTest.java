...
public class TokenEndpointTest extends RxWebTestBase {
    ...
    @InjectMocks private TokenEndpoint tokenEndpointHandler = new TokenEndpoint();

    @Mock private TokenGranter tokenGranter;
    ...
    @Test
    public void shouldInvokeTokenEndpoint_withValidClientCredentials_noGrantType()
            throws Exception {
    ...
    public void shouldInvokeTokenEndpoint_withValidClientCredentials() throws Exception {
        ...
        when(tokenGranter.grant(
                        any(TokenRequest.class), any(io.gravitee.am.model.oidc.Client.class)))
    ...
    @Test
    public void shouldInvokeTokenEndpoint_withValidClientCredentials_noAccessToken()
            throws Exception {
        Client client = new Client();
        client.setClientId("my-client");
        ApplicationScopeSettings setting = new ApplicationScopeSettings();
    ...
    @Test
    public void shouldInvokeTokenEndpoint_withValidClientCredentials_withoutGrantType()
            throws Exception {
        Client client = new Client();
        client.setClientId("my-client");
    ...
    public void testInvokeTokenEndpoint_umaException() throws Exception {
        ...
        when(tokenGranter.grant(
                        any(TokenRequest.class), any(io.gravitee.am.model.oidc.Client.class)))
                .thenReturn(Single.error(UmaException.requestDeniedBuilder().build()));

        testRequest(
                HttpMethod.POST,
                        "/oauth/token?client_id=my-client&client_secret=my-secret&grant_type=urn:ietf:params:oauth:grant-type:uma-ticket",
