...
public class ThymeleafConfiguration {
    ...
    public ThymeleafTemplateEngine getTemplateEngine(
            GraviteeMessageResolver messageResolver, DomainBasedThemeResolver themeResolver) {
        GraviteeThymeleafTemplateEngine thymeleafTemplateEngine =
                new GraviteeThymeleafTemplateEngine(vertx);
    ...
    public GraviteeMessageResolver messageResolver() {
        return new GraviteeMessageResolver(
