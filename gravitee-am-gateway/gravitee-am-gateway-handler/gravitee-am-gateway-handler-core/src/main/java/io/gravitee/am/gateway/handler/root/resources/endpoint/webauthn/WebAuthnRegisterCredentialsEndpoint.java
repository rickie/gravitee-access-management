 ...
 *
 * <p>These options object contains a number of required and optional fields that a server specifies
 * to create a new credential for a user.
 *
 * <p>https://webauthn.guide/#registration
 *
...
public class WebAuthnRegisterCredentialsEndpoint extends WebAuthnHandler {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(WebAuthnRegisterCredentialsEndpoint.class);
    ...
    private void createCredentialCreationOptions(RoutingContext ctx) {
        try {
            ...
            webAuthn.createCredentialsOptions(
                    webauthnRegister,
                    createCredentialsOptions -> {
                        ...
                        if (domain.getWebAuthnSettings() != null
                                && domain.getWebAuthnSettings().isForceRegistration()) {
                        ...
                        ctx.session()
                                .put(
                                        ...
                                        credentialsOptions.getString("challenge"))
                                .put(
                                        ConstantKeys.PASSWORDLESS_CHALLENGE_USERNAME_KEY,
                                        webauthnRegister.getString("name"));
