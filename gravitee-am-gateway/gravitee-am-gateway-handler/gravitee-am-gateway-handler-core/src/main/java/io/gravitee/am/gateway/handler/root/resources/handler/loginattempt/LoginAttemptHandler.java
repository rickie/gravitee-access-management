...
public class LoginAttemptHandler implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext routingContext) {
        ...
        var password = routingContext.request().getParam(PASSWORD_PARAM_KEY);
        if (canApplyLoginAttemptKey(client, adaptiveRule, username, password)) {
    ...
    private boolean canApplyLoginAttemptKey(Client client, String adaptiveRule, String username, String password) {
