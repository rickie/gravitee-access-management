...
public class ErrorHandler implements Handler<RoutingContext> {
    ...
    private void handleException(
            RoutingContext routingContext, String errorCode, String errorDetail) {
        ...
        try {
            ...
            // redirect
            String proxiedErrorPage =
                    UriBuilderRequest.resolveProxyRequest(request, errorPageURL, parameters, true);
