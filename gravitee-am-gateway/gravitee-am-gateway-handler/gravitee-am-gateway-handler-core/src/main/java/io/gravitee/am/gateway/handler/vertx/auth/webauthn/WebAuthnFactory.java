...
public class WebAuthnFactory implements FactoryBean<WebAuthn> {
    ...
    private static Attestation getAttestation(AttestationConveyancePreference attestationConveyancePreference) {
        return attestationConveyancePreference != null ? Attestation.valueOf(attestationConveyancePreference.name()) : NONE;
    }
