...
public class RepositoryCredentialStore {
    ...
    public Future<List<Authenticator>> fetch(Authenticator query) {
        ...
        RxJava2Adapter.singleToMono(fetchCredentials).flatMap(v->RxJava2Adapter.singleToMono((Single<List<Authenticator>>)RxJavaReactorMigrationUtil.toJdkFunction((Function<List<Credential>, Single<List<Authenticator>>>)credentials -> {
