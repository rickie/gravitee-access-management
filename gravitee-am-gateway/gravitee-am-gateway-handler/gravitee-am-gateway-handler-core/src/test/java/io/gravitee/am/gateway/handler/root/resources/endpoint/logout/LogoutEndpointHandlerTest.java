...
public class LogoutEndpointHandlerTest extends RxWebTestBase {
    ...
    public void shouldInvokeLogoutEndpoint_targetUrl_noClient() throws Exception {
        testRequest(
                HttpMethod.GET,
                "/logout?target_url=https%3A%2F%2Ftest",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_alloaw_atDomainLevel_appUrls_not_defined()
            throws Exception {
    ...
    @Test
    public void
            shouldInvokeLogoutEndpoint_targetUrl_alloaw_atDomainLevel_appUrls_not_defined_emptyList()
                    throws Exception {
        Client client = new Client();
        client.setClientId("123");
        // no redirectUris registered for logout at App Level
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_not_allowed_atDomainLevel_appUrls_not_defined()
            throws Exception {
        Client client = new Client();
        client.setClientId("123");
        // no redirectUris registered for logout at App Level
        ...
        testRequest(
                HttpMethod.GET,
                "/logout?target_url=https%3A%2F%2Fnot-allowed",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
                    assertTrue(
                            location.endsWith(
                                    "invalid_request&error_description=The+post_logout_redirect_uri+MUST+match+the+registered+callback+URLs"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_client_with_param_wildcard_restriction()
            throws Exception {
        Client client = new Client();
        client.setPostLogoutRedirectUris(Arrays.asList("https://test/*"));
        when(clientSyncService.findById("client-id")).thenReturn(Maybe.just(client));
        ...
        testRequest(
                HttpMethod.GET,
                "/logout?target_url=https%3A%2F%2Ftest?u=200",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_with_param_client_wildcard_not_allowed()
            throws Exception {
        Client client = new Client();
        ...
        testRequest(
                HttpMethod.GET,
                "/logout?target_url=https%3A%2F%2Ftest.com?u=200",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_with_param_client_strict_match_true()
            throws Exception {
        Client client = new Client();
        client.setClientId("123");
        client.setPostLogoutRedirectUris(Arrays.asList("https://test.com"));
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_with_param_client_strict_match_false()
            throws Exception {
        Client client = new Client();
        client.setClientId("123");
        client.setPostLogoutRedirectUris(Arrays.asList("https://test.com"));
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_client_restriction_mismatch()
            throws Exception {
        Client client = new Client();
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/error?target_url=https%3A%2F%2Ftest&client_id=client-id&error=invalid_request&error_description=The+post_logout_redirect_uri+MUST+match+the+registered+callback+URLs"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_client_id_token_restriction_mismatch()
            throws Exception {
        JWT jwt = new JWT();
        ...
        when(userService.extractSessionFromIdToken("idToken"))
                .thenReturn(Single.just(new UserToken(endUser, client)));
        when(userService.logout(any(), eq(false), any())).thenReturn(Completable.complete());
        ...
        testRequest(
                HttpMethod.GET,
                "/logout?post_logout_redirect_uri=https%3A%2F%2Ftest&id_token_hint=idToken",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
                    assertTrue(
                            location.endsWith(
                                    "/error?post_logout_redirect_uri=https%3A%2F%2Ftest&id_token_hint=idToken&client_id=client-id&error=invalid_request&error_description=The+post_logout_redirect_uri+MUST+match+the+registered+callback+URLs"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldInvokeLogoutEndpoint_targetUrl_noClient_restriction_mismatch()
            throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/error?target_url=https%3A%2F%2Ftest&error=invalid_request&error_description=The+post_logout_redirect_uri+MUST+match+the+registered+callback+URLs"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldInvokeExternalOIDCLogoutEndpoint_targetUrl_restriction_mismatch()
            throws Exception {
        JWT jwt = new JWT();
        jwt.setAud("client-id");
        ...
        when(certificateManager.defaultCertificateProvider())
                .thenReturn(mock(CertificateProvider.class));
        when(jwtService.encode(any(JWT.class), any(CertificateProvider.class)))
                .thenReturn(Single.just("jwtstatevalue"));
    ...
    public void shouldInvokeExternalOIDCLogoutEndpoint_targetUrlOk() throws Exception {
        ...
        testRequest(
                HttpMethod.GET,
                "/logout?target_url=https%3A%2F%2Fdev",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
                    assertTrue(
                            location.startsWith(
                                    "https://oidc/logout?post_logout_redirect_uri=http://localhost:"));
                    assertTrue(
                            location.endsWith(
                                    "/domain/logout/callback&id_token_hint=opidtokenvalue&state=jwtstatevalue"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldInvokeExternalOIDCLogoutEndpoint_noTargetUrl() throws Exception {
        ...
        io.vertx.reactivex.ext.web.client.HttpRequest<io.vertx.reactivex.core.buffer.Buffer>
                httpRequest = mock(io.vertx.reactivex.ext.web.client.HttpRequest.class);
        io.vertx.ext.web.client.HttpResponse<io.vertx.reactivex.core.buffer.Buffer> httpResponse =
                mock(io.vertx.ext.web.client.HttpResponse.class);
        ...
        testRequest(HttpMethod.GET, "/logout", null, HttpStatusCode.OK_200, "OK", null);
    }
    ...
    public void shouldInvokeLogoutEndpoint_postRedirectUri_lax_id_token_hint() throws Exception {
        ...
        testRequest(
                HttpMethod.GET,
                "/logout?post_logout_redirect_uri=https%3A%2F%2Fdev",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
