...
public class SocialAuthenticationProviderTest {
    ...
    @InjectMocks private SocialAuthenticationProvider authProvider;
    ...
    public void shouldAuthenticateUser() throws Exception {
        ...
        io.gravitee.am.identityprovider.api.User user =
                new io.gravitee.am.identityprovider.api.DefaultUser("username");
        ...
        verify(eventManager)
                .publishEvent(argThat(evt -> evt == AuthenticationEvent.SUCCESS), any());
    }
    ...
    public void shouldNotAuthenticateUser_badCredentials() throws Exception {
        ...
        verify(eventManager)
                .publishEvent(argThat(evt -> evt == AuthenticationEvent.FAILURE), any());
    }
    ...
    public void shouldAuthenticateUser_Username_DomainAllowed() throws Exception {
        ...
        io.gravitee.am.identityprovider.api.User user =
                new io.gravitee.am.identityprovider.api.DefaultUser("my-user-id@acme.com");
    ...
    public void shouldAuthenticateUser_Username_And_Email_DomainAllowed() throws Exception {
        ...
        io.gravitee.am.identityprovider.api.DefaultUser user =
                new io.gravitee.am.identityprovider.api.DefaultUser("my-user-id@acme.com");
    ...
    public void shouldAuthenticateUser_Email_DomainAllowed() throws Exception {
        ...
        io.gravitee.am.identityprovider.api.DefaultUser user =
                new io.gravitee.am.identityprovider.api.DefaultUser("my-user-id");
        user.setEmail("my-user-id@acme.com");
    ...
    public void shouldNotAuthenticateUser_Email_DomainNotAllowed() throws Exception {
        ...
        authProvider.authenticate(
                ...
                userAsyncResult -> {
                    ...
                    Assert.assertTrue(userAsyncResult.failed());
                    Assert.assertTrue(
                            userAsyncResult.cause() instanceof LoginCallbackFailedException);
                });
