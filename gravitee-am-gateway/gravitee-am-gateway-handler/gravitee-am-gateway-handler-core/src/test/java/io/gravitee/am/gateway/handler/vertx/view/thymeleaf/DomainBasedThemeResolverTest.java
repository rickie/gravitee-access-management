    ...
    public void shouldResolveTheme_custom_theme() {
        ...
        Assert.assertTrue(
                themeResolution
                        .getCss()
                        .equals(
                                ":root {--primary-background-color:#ffffff;--primary-foreground-color:#000000;--secondary-background-color:#fafafa;--secondary-foreground-color:#000000;--logo-width:250px;}"));
    }
