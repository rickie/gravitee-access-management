...
public class BotDetectionManagerTest {
    ...
    @InjectMocks private BotDetectionManagerImpl cut = new BotDetectionManagerImpl();
    ...
    public void shouldGetTemplateVariables_Domain() {
        ...
        assertEquals(
                ((Map<?, ?>) variables.get(TEMPLATE_KEY_BOT_DETECTION_CONFIGURATION)).size(), 1);
        assertEquals(
                ((Map<?, ?>) variables.get(TEMPLATE_KEY_BOT_DETECTION_CONFIGURATION)).get("key"),
                "value");
    }
