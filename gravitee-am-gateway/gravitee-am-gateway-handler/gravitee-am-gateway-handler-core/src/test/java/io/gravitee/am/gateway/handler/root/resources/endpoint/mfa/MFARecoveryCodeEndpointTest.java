...
public class MFARecoveryCodeEndpointTest extends RxWebTestBase {
    ...
    @Mock private ThymeleafTemplateEngine templateEngine;
    ...
    public void setUp() throws Exception {
        ...
        mfaRecoveryCodeEndpoint =
                new MFARecoveryCodeEndpoint(
                        templateEngine, domain, userService, factorManager, applicationContext);
    ...
    public void shouldRenderWithRecoveryCodes() throws Exception {
        ...
        testRequest(
                ...
                REQUEST_PATH
                        + "?client_id="
                        + client.getClientId()
                        + "&redirect_uri=http://redirect.com/app",
                200,
                "OK");
    }
