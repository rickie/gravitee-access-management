...
public class IdentifierFirstLoginEndpointTest extends RxWebTestBase {
    ...
    public final LoginSelectionRuleHandler loginSelectionRuleHandler =
            new LoginSelectionRuleHandler(true);
    ...
    private io.gravitee.am.gateway.handler.root.resources.endpoint.identifierfirst
                    .IdentifierFirstLoginEndpoint
            identifierFirstLoginEndpoint;
    ...
    public void setUp() throws Exception {
        ...
        identifierFirstLoginEndpoint =
                new IdentifierFirstLoginEndpoint(templateEngine, domain, botDetectionManager);
    ...
    public void mustInvokeIdentifierFirstLoginEndpoint() throws Exception {
        router.route(HttpMethod.GET, "/login/identifier")
                .handler(get200AssertMockRoutingContextHandler(identifierFirstLoginEndpoint));
        testRequest(
                HttpMethod.GET,
                "/login/identifier?client_id="
    ...
    public void mustNotInvokeIdentifierFirstLoginEndpoint_wrongClientId() throws Exception {
        ...
        testRequest(
                HttpMethod.GET,
                "/login/identifier?client_id=" + appClient.getClientId(),
    ...
    public void shouldInvokeLoginEndpoint_noRedirectNoMatchingProviders() throws Exception {
        router.route(HttpMethod.POST, "/login/identifier")
                .handler(
                        routingContext -> {
                            ...
                            appIdp.setSelectionRule(
                                    "{#context.request['username'].endsWith('other-domain.com')}");
        ...
        testRequest(
                HttpMethod.POST,
                "/login/identifier?username=username@domain.com&client_id="
                        + appClient.getClientId()
                        + "&response_type=code&redirect_uri=somewhere.com",
                null,
                resp -> {
    ...
    @Test
    public void shouldInvokeLoginEndpoint_noRedirectNoMatchingProviders_appIdpRuleIsNull()
            throws Exception {
        router.route(HttpMethod.POST, "/login/identifier")
                .handler(
                        routingContext -> {
    ...
    public void shouldInvokeLoginEndpoint_noRedirectUsernameIsNotAnEmail() throws Exception {
        ...
        testRequest(
                HttpMethod.POST,
                "/login/identifier?username=username&client_id="
                        + appClient.getClientId()
                        + "&response_type=code&redirect_uri=somewhere.com",
                null,
                resp -> {
    ...
    public void shouldInvokeLoginEndpoint_redirectUsernameMatchesRule() throws Exception {
                ...
                .handler(
                        routingContext -> {
                            ...
                            routingContext.put(
                                    ...
                                    Map.of(
                                            idp.getId(),
                                            "https://host/some/provider/oauth/authorize"));

                            var identityProviders = new TreeSet<ApplicationIdentityProvider>();
                            var appIdp = new ApplicationIdentityProvider();
                            appIdp.setIdentity(idp.getId());
                            appIdp.setSelectionRule(
                                    "{#request.params['username'][0] matches '.+@domain.com$'}");
                            identityProviders.add(appIdp);
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.equals(
                                    "https://host/some/provider/oauth/authorize?login_hint=username%40domain.com"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldInvokeLoginEndpoint_redirectUsernameMatchesDomainAndSpecificIdp()
            throws Exception {
        router.route(HttpMethod.POST, "/login/identifier")
                .handler(
                        routingContext -> {
    ...
    private Handler<RoutingContext> get200AssertMockRoutingContextHandler(
            IdentifierFirstLoginEndpoint identifierFirstLoginEndpoint) {
