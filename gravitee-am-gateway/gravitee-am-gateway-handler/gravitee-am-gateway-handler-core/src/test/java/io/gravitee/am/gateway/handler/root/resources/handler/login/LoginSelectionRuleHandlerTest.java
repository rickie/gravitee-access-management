        ...
        router.route()
                ...
                .handler(
                        rc -> {
                            ...
                            applicationIdentityProvider.setSelectionRule(
                            ...
                            applicationIdentityProvider2.setSelectionRule(
                                    "{#request.params['username'][0] matches '.+@' + #identityProvider.domainWhitelist[0] + '$'}");
                            ...
                            identityProvider.setDomainWhitelist(
                                    Collections.singletonList("mail.com"));
                            IdentityProvider identityProvider2 = new IdentityProvider();
                            identityProvider2.setId("idp-2");
                            identityProvider2.setDomainWhitelist(
                                    Collections.singletonList("another-mail.com"));
                            List<IdentityProvider> socialProviders =
                                    Arrays.asList(identityProvider, identityProvider2);
