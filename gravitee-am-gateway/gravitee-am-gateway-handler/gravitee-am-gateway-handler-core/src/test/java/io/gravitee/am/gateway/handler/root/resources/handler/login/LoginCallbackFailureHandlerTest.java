...
public class LoginCallbackFailureHandlerTest extends RxWebTestBase {
    ...
    public void shouldRedirectToLoginPage_nominalCase() throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.contains(
                                    "/login?error=social_authentication_failed&error_description=policy_exception"));
                },
    ...
    public void shouldRedirectToSPRedirectUri_hideLogin_oneExternalIdP_codeFlow() throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.equals(
                                    "https://sp-app/callback?error=server_error&error_description=policy_exception&state=12345"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldRedirectToSPRedirectUri_SelectionRule_oneExternalIdP_codeFlow()
            throws Exception {
        router.route()
                .order(-1)
                .handler(
    ...
    @Test
    public void shouldRedirectToSPRedirectUri_hideLogin_oneExternalIdP_implicitFlow()
            throws Exception {
        router.route()
                .order(-1)
                .handler(
    ...
    @Test
    public void shouldRedirectToSPRedirectUri_SelectionRule_oneExternalIdP_implicitFlow()
            throws Exception {
        router.route()
                .order(-1)
                .handler(
