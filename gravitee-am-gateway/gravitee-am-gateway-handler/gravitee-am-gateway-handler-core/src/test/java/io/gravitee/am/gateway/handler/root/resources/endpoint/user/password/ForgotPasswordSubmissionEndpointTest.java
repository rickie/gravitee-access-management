...
public class ForgotPasswordSubmissionEndpointTest extends RxWebTestBase {
    ...
    @Mock private AccountSettings accountSettings;
    ...
    public void setUp() throws Exception {
        ...
        ForgotPasswordSubmissionEndpoint forgotPasswordSubmissionEndpoint =
                new ForgotPasswordSubmissionEndpoint(userService, domain);
    ...
    public void shouldInvokeForgotPasswordEndpoint() throws Exception {
        ...
        when(userService.forgotPassword(
                        argThat(p -> p.getEmail().equals("email@test.com")),
                        eq(client),
                        any(User.class)))
        ...
        testRequest(
                HttpMethod.POST,
                "/forgotPassword?client_id=client-id",
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/forgotPassword?client_id=client-id&success=forgot_password_completed"));
                },
    ...
    public void shouldFailWhenEmailFormatInvalidException() throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/forgotPassword?client_id=client-id&error=forgot_password_failed"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldCompleteWithWarningWhen_EnforceIdentityException_TooManyResult()
            throws Exception {
        Client client = new Client();
        client.setId("client-id");
        client.setClientId("client-id");
        ...
        when(userService.forgotPassword(
                        ...
                        eq(client),
                        any(User.class)))
                .thenReturn(Completable.error(new EnforceUserIdentityException()));
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/forgotPassword?client_id=client-id&warning=forgot_password_confirm"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    @Test
    public void shouldCompleteWithSuccessWhen_EnforceIdentityException_ConfirmIdentityNotEnabled()
            throws Exception {
        Client client = new Client();
        client.setId("client-id");
        client.setClientId("client-id");
    ...
    private void postEmail(
            io.vertx.reactivex.core.http.HttpClientRequest httpClientRequest, String email) {
