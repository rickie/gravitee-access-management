...
public class LogoutCallbackEndpointHandlerTest extends RxWebTestBase {
    ...
    public void shouldRedirect_using_state() throws Exception {
        ...
        when(jwtService.decodeAndVerify(any(String.class), any(CertificateProvider.class)))
        ...
        testRequest(
                HttpMethod.GET,
                "/logout/callback?state=myappstate",
                null,
                resp -> {
    ...
    public void shouldRedirect_using_state_invalidTargetUrl() throws Exception {
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/error?state=myappstate&client_id=client-id&error=invalid_request&error_description=The+post_logout_redirect_uri+MUST+match+the+registered+callback+URLs"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
