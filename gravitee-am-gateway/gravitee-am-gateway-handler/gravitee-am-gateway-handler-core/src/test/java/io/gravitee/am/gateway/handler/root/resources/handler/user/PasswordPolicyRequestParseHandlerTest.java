...
public class PasswordPolicyRequestParseHandlerTest extends RxWebTestBase {
    ...
    @Mock private PasswordService passwordValidator;
    ...
    public void setUp() throws Exception {
        super.setUp();
        passwordPolicyRequestParseHandler =
                new PasswordPolicyRequestParseHandler(passwordValidator, new Domain());
    ...
    public void shouldNotHandle_invalid_password() throws Exception {
        ...
        doThrow(InvalidPasswordException.class)
                ...
                .validate(anyString(), eq(null), any());
