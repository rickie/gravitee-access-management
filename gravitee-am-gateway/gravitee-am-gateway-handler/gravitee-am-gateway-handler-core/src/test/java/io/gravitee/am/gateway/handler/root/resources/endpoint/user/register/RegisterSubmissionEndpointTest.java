...
public class RegisterSubmissionEndpointTest extends RxWebTestBase {
    ...
    public void shouldInvokeRegisterEndpoint() throws Exception {
        ...
        when(userService.register(eq(client), any(), any()))
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/register?client_id=client-id&success=registration_succeed"));
                },
    ...
    public void shouldFail_UserAlreadyExistsException() throws Exception {
        ...
        when(userService.register(eq(client), any(), any()))
                .thenReturn(Single.error(new UserAlreadyExistsException("test")));
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/register?client_id=client-id&error=registration_failed"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldFail_invalidUserException() throws Exception {
        ...
        when(userService.register(eq(client), any(), any()))
                .thenReturn(Single.error(new InvalidUserException("Username invalid")));
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/register?client_id=client-id&warning=invalid_user_information"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldFail_emailFormatInvalidException() throws Exception {
        ...
        when(userService.register(eq(client), any(), any()))
                .thenReturn(Single.error(new EmailFormatInvalidException("test")));
        ...
        testRequest(
                ...
                resp -> {
                    ...
                    assertTrue(
                            location.endsWith(
                                    "/register?client_id=client-id&warning=invalid_email"));
                },
                HttpStatusCode.FOUND_302,
                "Found",
                null);
    ...
    public void shouldInvokeRegisterEndpoint_redirectUri_withoutDuplicateParam() throws Exception {
        ...
        testRequest(
                HttpMethod.POST,
                "/register?client_id=client-id&some-param=some-value",
                null,
                resp -> {
                    String location = resp.headers().get("location");
                    assertNotNull(location);
                    assertEquals(
                            "http://custom_uri?client_id=another-client-id&some-param=some-value",
                            location);
                },
                HttpStatusCode.FOUND_302,
                "Found",
