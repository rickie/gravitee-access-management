...
public class RegisterSubmissionEndpointTest extends RxWebTestBase {
    ...
    public void shouldInvokeRegisterEndpoint() throws Exception {
        ...
        when(userService.register_migrated(eq(client), any(), any())).thenReturn(Mono.just(new RegistrationResponse()));
    ...
    public void shouldInvokeRegisterEndpoint_redirectUri() throws Exception {
        ...
        when(userService.register_migrated(eq(client), any(), any())).thenReturn(Mono.just(registrationResponse));
    ...
    public void shouldFail_UserAlreadyExistsException() throws Exception {
        ...
        when(userService.register_migrated(eq(client), any(), any())).thenReturn(Mono.error(new UserAlreadyExistsException("test")));
    ...
    public void shouldFail_invalidUserException() throws Exception {
        ...
        when(userService.register_migrated(eq(client), any(), any())).thenReturn(Mono.error(new InvalidUserException("Username invalid")));
    ...
    public void shouldFail_emailFormatInvalidException() throws Exception {
        ...
        when(userService.register_migrated(eq(client), any(), any())).thenReturn(Mono.error(new EmailFormatInvalidException("test")));
