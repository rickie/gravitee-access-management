        ...
        WebAuthn webAuthN =
                WebAuthn.create(
                        ...
                        new GraviteeWebAuthnOptions()
                                .setRelyingParty(
                                        new RelyingParty().setName("FIDO Examples Corporation")));

        JsonObject packedFullAttestationWebAuthnSample =
                new JsonObject()
                        .put(
                                "rawId",
    ...
    public void testPackedFullAttestationSample() {
        ...
        JsonObject packedFullAttestationWebAuthnSample =
                new JsonObject()
                        .put(
                                "rawId",
                                "wsLryOAxXMU54s2fCSWPzWjXHOBKPploN-UHftj4_rpIu6BZxNXppm82f7Y6iX9FEOKKeS5-N2TALeyzLnJfAA")
                        .put(
                                "id",
                                "wsLryOAxXMU54s2fCSWPzWjXHOBKPploN-UHftj4_rpIu6BZxNXppm82f7Y6iX9FEOKKeS5-N2TALeyzLnJfAA")
                        .put(
        ...
        webAuthN.authenticate(
                new WebAuthnCredentials(
                        new JsonObject()
                                ...
                                .put(
                                        "challenge",
                                        "Tf65bS6D5temh2BwvptqgBPb25iZDRxjwC5ans91IIJDrcrOpnWTK4LVgFjeUV4GDMe44w8SI5NsZssIXTUvDg")),
                u -> {
                    // process should not failed for an encoding issue
                    Assert.assertTrue(u.failed());
                    Assert.assertFalse(u.cause().getMessage().contains("Illegal base64 character"));
