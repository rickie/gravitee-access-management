...
/**
 * See <a href="https://tools.ietf.org/html/rfc7644#section-3.12>3.12. HTTP Status and Error
 * Response Handling</a>
 *
...
public enum ScimType {
    ...
    /**
     * The specified filter syntax was invalid, or the specified attribute and filter comparison
     * combination is not supported.
     */
    INVALID_FILTER("invalidFilter"),
    /**
     * The specified filter yields many more results than the server is willing to calculate or
     * process. For example, a filter such as "(userName pr)" by itself would return all entries
    ...
    NO_TARGET("noTarget"),
    /**
     * A required value was missing, or the value specified was not compatible with the operation or
     * attribute type (see Section 2.2 of [RFC7643]), or resource schema (see Section 4 of
     * [RFC7643]).
     */
     ...
     * information in a request URI. For example, personal information SHALL NOT be transmitted over
     * request URIs. See Section 7.5.2.
     */
    SENSITIVE("sensitive");
