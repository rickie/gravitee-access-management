...
/**
 * See <a href="https://tools.ietf.org/html/rfc7643#section-8.5">8.5. Service Provider Configuration
 * Representation</a>
 *
...
public class ServiceProviderConfiguration extends Resource {
    ...
    /**
     * A multi-valued complex type that specifies supported authentication scheme properties. To
     * enable seamless discovery of configurations, the service provider SHOULD, with the
     * appropriate security considerations, make the authenticationSchemes attribute publicly
     * accessible without prior authentication. REQUIRED.
     */
