...
public class ListResponse<T extends Resource> extends Resource {
     ...
     * than the number of resources returned, such as when returning a single page (see Section
     * 3.4.2.4) of results where multiple pages are available. REQUIRED.
     */
    private long totalResults;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a
     * subset of the full set of resources if pagination (Section 3.4.2.4) is requested. REQUIRED if
    ...
    public ListResponse(
            List<T> resources, Integer startIndex, long totalResults, Integer itemsPerPage) {
