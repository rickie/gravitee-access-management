...
public enum AuthenticationScheme {
    ...
    /**
     * The authentication scheme. This specification defines the values "oauth", "oauth2",
     * "oauthbearertoken", "httpbasic", and "httpdigest". REQUIRED.
     */
    ...
    AuthenticationScheme(
            String type, String name, String description, String specUri, String documentationUri) {
        this.type = type;
        this.name = name;
