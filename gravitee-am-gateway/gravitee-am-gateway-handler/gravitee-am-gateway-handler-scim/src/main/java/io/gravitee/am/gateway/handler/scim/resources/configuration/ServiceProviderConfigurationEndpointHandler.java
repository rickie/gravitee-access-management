 ...
 *
 * <p>See <a href="https://tools.ietf.org/html/rfc7644#section-4">4. Service Provider Configuration
 * Endpoints</a>
 *
...
public class ServiceProviderConfigurationEndpointHandler implements Handler<RoutingContext> {
    ...
    public ServiceProviderConfigurationEndpointHandler(
            ServiceProviderConfigService serviceProviderConfigService) {
    ...
    public static ServiceProviderConfigurationEndpointHandler create(
            ServiceProviderConfigService serviceProviderConfigService) {
