    ...
    protected void doStart() throws Exception {
        ...
        if (isSelfServiceAccountEnabled()) {
            ...
            accountRouter
                    ...
                    .handler(accountHandler::getProfile);
            accountRouter
                    .put(AccountRoutes.PROFILE.getRoute())
                    .handler(BodyHandler.create())
                    .handler(accountHandler::getUser)
                    .handler(accountHandler::updateProfile);
            accountRouter
                    .get(AccountRoutes.ACTIVITIES.getRoute())
                    .handler(accountHandler::getUser)
                    .handler(accountHandler::getActivity);
            accountRouter
                    .get(AccountRoutes.CHANGE_PASSWORD.getRoute())
                    .handler(accountHandler::redirectForgotPassword);
            accountRouter
                    .post(AccountRoutes.CHANGE_PASSWORD.getRoute())
                    .handler(accountHandler::getUser)
            ...
            accountRouter
                    .get(AccountRoutes.WEBAUTHN_CREDENTIALS.getRoute())
                    .handler(accountHandler::getUser)
                    .handler(
                            accountWebAuthnCredentialsEndpointHandler
                                    ::listEnrolledWebAuthnCredentials);
            accountRouter
                    .get(AccountRoutes.WEBAUTHN_CREDENTIALS_BY_ID.getRoute())
                    .handler(accountHandler::getUser)
                    .handler(
                            accountWebAuthnCredentialsEndpointHandler
                                    ::getEnrolledWebAuthnCredential);
            accountRouter
                    .delete(AccountRoutes.WEBAUTHN_CREDENTIALS_BY_ID.getRoute())
                    .handler(accountHandler::getUser)
                    .handler(
                            accountWebAuthnCredentialsEndpointHandler
                                    ::removeEnrolledWebAuthnCredential);

            // Consent routes
            AccountConsentEndpointHandler accountConsentEndpointHandler =
                    new AccountConsentEndpointHandler(accountService);
            accountRouter
                    .get(AccountRoutes.CONSENT.getRoute())
                    .handler(accountHandler::getUser)
                    .handler(accountConsentEndpointHandler::listConsent);
            accountRouter
                    .get(AccountRoutes.CONSENT_BY_ID.getRoute())
                    .handler(accountHandler::getUser)
                    .handler(accountConsentEndpointHandler::getConsent);
            accountRouter
                    .delete(AccountRoutes.CONSENT_BY_ID.getRoute())
                    .handler(accountHandler::getUser)
