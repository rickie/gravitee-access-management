...
public class AccountResponseHandler {
    ...
    public static void handleUpdateUserResponse(
            RoutingContext routingContext, String message, Integer statusCode) {
        buildDefaultHeader(routingContext)
                .setStatusCode(statusCode)
                .end(getUpdateUserResponseFailureJson(message));
    }
