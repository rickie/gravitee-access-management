...
public class GatewayNodeMetadataResolver implements NodeMetadataResolver {
    ...
    @Lazy @Autowired private InstallationRepository installationRepository;

    @Lazy @Autowired private OrganizationRepository organizationRepository;

    @Lazy @Autowired private EnvironmentRepository environmentRepository;
    ...
    private Optional<List<String>> getSystemValues(String key) {
        ...
        String envs =
                systemPropertyEnvs == null ? configuration.getProperty(key) : systemPropertyEnvs;
