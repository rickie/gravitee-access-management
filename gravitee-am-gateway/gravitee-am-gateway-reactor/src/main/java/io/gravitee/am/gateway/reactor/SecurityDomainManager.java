...
/**
 * This manager interface acts as a bridge between the source of {@link Domain} (sync scheduler when
 * using the sync mode) and the {@link io.gravitee.am.gateway.reactor.Reactor}
 *
