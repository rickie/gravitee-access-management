...
public class MongoConnectionProvider
        implements ConnectionProvider<MongoClient, MongoConnectionConfiguration>, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.commonMongoClient =
                new MongoClientWrapper(
                        new MongoFactory(this.environment, Scope.MANAGEMENT.getName()).getObject());
        if (!useManagementSettings) {
            this.oauthMongoClient =
                    new MongoClientWrapper(
                            new MongoFactory(this.environment, Scope.OAUTH2.getName()).getObject());
        }
    }
    ...
    @Override
    public ClientWrapper<MongoClient> getClientFromConfiguration(
            MongoConnectionConfiguration configuration) {
