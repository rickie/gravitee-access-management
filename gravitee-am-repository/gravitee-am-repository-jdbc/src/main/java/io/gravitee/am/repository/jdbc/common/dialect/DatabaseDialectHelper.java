...
public interface DatabaseDialectHelper {
    ...
    Map<SqlIdentifier, Object> addJsonField(
            Map<SqlIdentifier, Object> insertSpec, String name, Object value);

    DatabaseClient.GenericExecuteSpec addJsonField(
            DatabaseClient.GenericExecuteSpec spec, String name, Object value);

    ScimUserSearch prepareScimSearchUserQuery(
            StringBuilder queryBuilder, FilterCriteria filterCriteria, int page, int size);

    String buildFindUserByReferenceAndEmail(
