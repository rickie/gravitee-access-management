...
@Repository
public class JdbcPasswordHistoryRepository extends AbstractJdbcRepository
        implements PasswordHistoryRepository, InitializingBean {
    ...
    @Autowired private SpringPasswordHistoryRepository repository;

    private static final List<String> columns =
            List.of(ID, REFERENCE_TYPE, REFERENCE_ID, CREATED_AT, UPDATED_AT, USER_ID, PASSWORD);
    ...
    public Single<PasswordHistory> update(PasswordHistory item) {
        ...
        return monoToSingle(updateAction.as(trx::transactional))
                ...
                .doOnError(
                        error ->
                                LOGGER.error(
                                        "unable to update password history with id {}",
                                        item.getId(),
                                        error));
    }
    ...
    public Completable delete(String id) {
        ...
        return monoToCompletable(
                template.delete(JdbcPasswordHistory.class)
    ...
    public Flowable<PasswordHistory> findByReference(
        ...
        return repository
                .findByReference(referenceType.toString(), referenceId)
                .map(this::toEntity);
    }
    ...
    public Flowable<PasswordHistory> findUserHistory(
        ...
        return repository
                .findByUserId(referenceType.toString(), referenceId, userId)
                .map(this::toEntity);
    }
    ...
    public Completable deleteByUserId(String userId) {
        ...
        return monoToCompletable(
                this.template
                        .delete(JdbcPasswordHistory.class)
