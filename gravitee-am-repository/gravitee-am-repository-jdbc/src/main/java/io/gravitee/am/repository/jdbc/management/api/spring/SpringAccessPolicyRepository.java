 ...
 */
@Repository
public interface SpringAccessPolicyRepository
        extends RxJava2CrudRepository<JdbcAccessPolicy, String> {
    ...
    @Query(
            "Select * from uma_access_policies u where u.domain = :domain and u.resource = :resource")
    Flowable<JdbcAccessPolicy> findByDomainAndResource(
            @Param("domain") String domain, @Param("resource") String resource);
