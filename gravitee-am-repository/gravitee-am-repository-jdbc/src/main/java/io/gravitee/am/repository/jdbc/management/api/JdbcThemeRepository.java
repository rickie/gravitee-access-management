...
public class JdbcThemeRepository extends AbstractJdbcRepository implements ThemeRepository {
    ...
    @Autowired private SpringThemeRepository themeRepository;
    ...
    public Maybe<Theme> findById(String id) {
        ...
        return themeRepository.findById(id).map(this::toEntity);
    }
    ...
    public Single<Theme> update(Theme item) {
        ...
        return themeRepository.save(toJdbcEntity(item)).map(this::toEntity);
    }
