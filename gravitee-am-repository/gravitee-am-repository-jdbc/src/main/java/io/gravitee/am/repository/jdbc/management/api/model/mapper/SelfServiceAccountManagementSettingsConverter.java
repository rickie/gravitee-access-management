 ...
 */
public class SelfServiceAccountManagementSettingsConverter
        extends DozerConverter<SelfServiceAccountManagementSettings, String> {
    ...
    @Override
    public SelfServiceAccountManagementSettings convertFrom(
            String s, SelfServiceAccountManagementSettings bean) {
