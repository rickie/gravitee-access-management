...
public class PostgresqlHelper extends AbstractDialectHelper {
    ...
    public Map<SqlIdentifier, Object> addJsonField(
        ...
        if (value == null) {
            ...
            spec.put(
                    SqlIdentifier.quoted(name),
                    Parameter.fromOrEmpty(Json.of(JSONMapper.toJson(value)), Json.class));
        }
        return spec;
    }
    ...
    protected ScimUserSearch processJsonFilter(
        ...
        switch (operator) {
            ...
            case "ew":
                ...
                break;
            default:
                // TODO gt, ge, lt, le not managed yet... we have to know the json field type in
                // order to adapt the clause
                throw new IllegalArgumentException(
                        "Operator '" + criteria + "' isn't authorized on JSON fields");
        }
    ...
    protected StringBuilder buildSearchUser(boolean wildcard, StringBuilder builder) {
        return builder.append("u.reference_id = :refId")
                ...
                .append(wildcard ? "LIKE " : "= ")
                .append(":value")
                .append(" OR  u.additional_information->>email ")
                .append(wildcard ? "LIKE " : "= ")
                .append(":value")
    ...
    protected StringBuilder buildSearchApplications(boolean wildcard, StringBuilder builder) {
        return builder.append("a.domain = :domain")
                ...
                .append(wildcard ? "LIKE " : "= ")
                .append(":value")
                .append(" OR upper(a.settings->'oauth'->>'clientId') ")
                .append(wildcard ? "LIKE " : "= ")
                .append(":value")
                .append(" ) ");
    }
    ...
    public String buildFindUserByReferenceAndEmail(
        ...
        return new StringBuilder(
                ...
                .append(
                        strict
                                ? "u.additional_information->>email"
                                : " UPPER(u.additional_information->>email)")
    ...
    public String buildFindApplicationByDomainAndClient() {
        return new StringBuilder("SELECT * FROM applications a WHERE ")
                ...
                .append(" AND a.settings->'oauth'->>'clientId' = :clientId")
                .toString();
    }
}
