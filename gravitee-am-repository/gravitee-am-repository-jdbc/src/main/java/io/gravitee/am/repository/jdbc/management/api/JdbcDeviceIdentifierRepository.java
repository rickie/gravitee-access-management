 ...
 */
@Repository
public class JdbcDeviceIdentifierRepository extends AbstractJdbcRepository
    ...
    public Flowable<DeviceIdentifier> findByReference(
        ...
        return fluxToFlowable(
                        template.select(JdbcDeviceIdentifier.class)
                                .matching(
                                        Query.query(
    ...
    public Completable delete(String id) {
        ...
        return monoToCompletable(
                template.delete(JdbcDeviceIdentifier.class)
                        .matching(Query.query(where(ID_FIELD).is(id)))
                        .all());
    }
}
