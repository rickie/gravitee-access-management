 ...
 */
@Repository
public interface SpringOrganizationHridsRepository
        extends RxJava2CrudRepository<JdbcOrganization.Hrid, String> {
    @Query(
            "select * from organization_hrids c where c.organization_id = :organizationId order by pos")
