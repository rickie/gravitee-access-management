 ...
 */
@Repository
public interface SpringOrganizationRepository
        extends RxJava2CrudRepository<JdbcOrganization, String> {

    @Query(
            "select * from organizations o INNER JOIN organization_hrids oh ON o.id = oh.organization_id where oh.hrid in (:hrids)")
