 ...
 */
@Repository
public class JdbcAuthenticationDeviceNotifierRepository extends AbstractJdbcRepository
    ...
    public Flowable<AuthenticationDeviceNotifier> findAll() {
        ...
        return fluxToFlowable(template.select(JdbcAuthenticationDeviceNotifier.class).all())
                .map(this::toEntity);
    }
    ...
    public Maybe<AuthenticationDeviceNotifier> findById(String id) {
        ...
        return monoToMaybe(
                        template.select(
                                        Query.query(from(where(ID_FIELD).is(id))),
                                        JdbcAuthenticationDeviceNotifier.class)
                                .singleOrEmpty())
                .map(this::toEntity);
    }
