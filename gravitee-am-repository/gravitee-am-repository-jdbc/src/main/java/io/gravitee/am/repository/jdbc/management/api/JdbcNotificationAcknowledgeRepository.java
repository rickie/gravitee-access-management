 ...
 */
@Repository
public class JdbcNotificationAcknowledgeRepository extends AbstractJdbcRepository
    ...
    public Maybe<NotificationAcknowledge> findById(String id) {
        ...
        return monoToMaybe(
                        this.template
                                .select(JdbcNotificationAcknowledge.class)
    ...
    public Completable deleteByResourceId(String resourceId, String resourceType) {
        ...
        return monoToCompletable(
                this.template
                        .delete(JdbcNotificationAcknowledge.class)
                        .matching(
                                query(
                                        where(COL_RESOURCE)
                                                .is(resourceId)
