 ...
 */
@Repository
public class JdbcEmailRepository extends AbstractJdbcRepository
        implements EmailRepository, InitializingBean {
    ...
    @Autowired private SpringEmailRepository emailRepository;
    ...
    public Flowable<Email> findAll() {
        ...
        return emailRepository.findAll().map(this::toEntity);
    }
    ...
    public Flowable<Email> findAll(ReferenceType referenceType, String referenceId) {
        ...
        return emailRepository
                .findAllByReference(referenceId, referenceType.name())
                .map(this::toEntity);
    }
    ...
    public Flowable<Email> findByClient(
        ...
        return emailRepository
                .findAllByReferenceAndClient(referenceId, referenceType.name(), client)
                .map(this::toEntity);
    }
    ...
    public Maybe<Email> findByTemplate(
        ...
        return emailRepository
                .findByTemplate(referenceId, referenceType.name(), template)
                .map(this::toEntity);
    }
    ...
    public Maybe<Email> findByClientAndTemplate(
        ...
        LOGGER.debug(
                ...
                template);
        return emailRepository
                .findByClientAndTemplate(referenceId, referenceType.name(), client, template)
                .map(this::toEntity);
    }
    ...
    public Single<Email> create(Email item) {
        ...
        insertSpec =
                addQuotedField(insertSpec, COL_EXPIRES_AFTER, item.getExpiresAfter(), int.class);
