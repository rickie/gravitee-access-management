 ...
 */
@Repository
public class JdbcPermissionTicketRepository extends AbstractJdbcRepository
        implements PermissionTicketRepository, InitializingBean {
    ...
    @Autowired protected SpringPermissionTicketRepository permissionTicketRepository;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.UPDATE_STATEMENT =
                createUpdateStatement("uma_permission_ticket", columns, List.of(COL_ID));
    }
    ...
    public Single<PermissionTicket> create(PermissionTicket item) {
        ...
        insertSpec =
                addQuotedField(
                        insertSpec,
                        COL_EXPIRE_AT,
                        dateConverter.convertTo(item.getExpireAt(), null),
                        LocalDateTime.class);
        insertSpec =
                databaseDialectHelper.addJsonField(
                        insertSpec, COL_PERMISSION_REQUEST, item.getPermissionRequest());
    ...
    public Single<PermissionTicket> update(PermissionTicket item) {
        ...
        update =
                databaseDialectHelper.addJsonField(
                        update, COL_PERMISSION_REQUEST, item.getPermissionRequest());
    ...
    public Completable purgeExpiredData() {
        ...
        return monoToCompletable(
                template.delete(JdbcPermissionTicket.class)
