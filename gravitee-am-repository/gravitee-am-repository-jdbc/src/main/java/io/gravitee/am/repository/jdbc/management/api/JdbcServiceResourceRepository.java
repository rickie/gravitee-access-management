 ...
 */
@Repository
public class JdbcServiceResourceRepository extends AbstractJdbcRepository
        implements ServiceResourceRepository {

    @Autowired protected SpringServiceResourceRepository serviceResourceRepository;
    ...
    public Maybe<ServiceResource> findById(String id) {
        ...
        return serviceResourceRepository.findById(id).map(this::toEntity);
    }
    ...
    public Single<ServiceResource> update(ServiceResource item) {
        ...
        return serviceResourceRepository.save(toJdbcEntity(item)).map(this::toEntity);
    }
