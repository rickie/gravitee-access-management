 ...
 */
public interface SpringExtensionGrantRepository
        extends RxJava2CrudRepository<JdbcExtensionGrant, String> {
    ...
    Maybe<JdbcExtensionGrant> findByDomainAndName(
            @Param("domain") String domain, @Param("name") String name);
}
