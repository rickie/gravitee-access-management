 ...
 */
@Repository
public class JdbcUserActivityRepository extends AbstractJdbcRepository
    ...
    public Flowable<UserActivity> findByReferenceAndTypeAndKeyAndLimit(
        ...
        return fluxToFlowable(template.select(JdbcUserActivity.class).matching(query).all())
                .map(this::toEntity);
    }
    ...
    public Completable purgeExpiredData() {
        ...
        LocalDateTime now = LocalDateTime.now(UTC);
        return monoToCompletable(
                        template.delete(JdbcUserActivity.class)
