...
public interface SpringUserAttributesRepository extends RxJava2CrudRepository<JdbcUser.Attribute, String> {
      @Deprecated  
default io.reactivex.Flowable<io.gravitee.am.repository.jdbc.management.api.model.JdbcUser.Attribute> findByUserId(@org.springframework.data.repository.query.Param(value = "user")
java.lang.String userId) {
    return RxJava2Adapter.fluxToFlowable(findByUserId_migrated(userId));
}
default reactor.core.publisher.Flux<io.gravitee.am.repository.jdbc.management.api.model.JdbcUser.Attribute> findByUserId_migrated(@Param(value = "user")
String userId) {
