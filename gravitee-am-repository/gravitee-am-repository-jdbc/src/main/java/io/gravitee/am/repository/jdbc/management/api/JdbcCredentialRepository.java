...
public class JdbcCredentialRepository extends AbstractJdbcRepository
    ...
    @Autowired private SpringCredentialRepository credentialRepository;
    ...
    public Flowable<Credential> findByUserId(
        ...
        return credentialRepository
                .findByUserId(referenceType.name(), referenceId, userId)
                .map(this::toEntity);
    }
    ...
    public Flowable<Credential> findByUsername(
        ...
        return credentialRepository
                .findByUsername(referenceType.name(), referenceId, username)
                .map(this::toEntity);
    }
    ...
    public Flowable<Credential> findByCredentialId(
        ...
        return credentialRepository
                .findByCredentialId(referenceType.name(), referenceId, credentialId)
                .map(this::toEntity);
    }
    ...
    public Maybe<Credential> findById(String id) {
        ...
        return credentialRepository
                ...
                .doOnError(
                        error ->
                                LOGGER.error("Unable to retrieve credential for Id {}", id, error));
    }
    ...
    public Single<Credential> update(Credential item) {
        ...
        return this.credentialRepository
                .save(toJdbcEntity(item))
                .map(this::toEntity)
                .doOnError(
                        (error) ->
                                LOGGER.error(
                                        "unable to create credential with id {}",
                                        item.getId(),
                                        error));
    }
    ...
    public Completable delete(String id) {
        ...
        return credentialRepository
                .deleteById(id)
                .doOnError(
                        error -> LOGGER.error("Unable to delete credential for Id {}", id, error));
    }
    ...
    public Completable deleteByUserId(
        ...
        return monoToCompletable(
                        template.delete(JdbcCredential.class)
                                .matching(
                                        Query.query(
                ...
                .doOnError(
                        error ->
                                LOGGER.error(
                                        "Unable to delete credential for userId {}",
                                        userId,
                                        error));
    }
    ...
    public Completable deleteByReference(ReferenceType referenceType, String referenceId) {
        ...
        return monoToCompletable(
                ...
                .doOnError(
                        error ->
                                LOGGER.error(
                                        "Unable to delete credential for reference {} - {}",
                                        referenceType.name(),
                                        referenceId,
                                        error));
    }
