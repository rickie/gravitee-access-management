 ...
 */
@Repository
public class JdbcNodeMonitoringRepository extends AbstractJdbcRepository
        implements NodeMonitoringRepository {

    @Autowired protected SpringNodeMonitoringRepository nodeMonitoringRepository;
    ...
    public Maybe<Monitoring> findByNodeIdAndType(String nodeId, String type) {
        ...
        return nodeMonitoringRepository.findByNodeIdAndType(nodeId, type).map(this::toEntity);
    }
    ...
    public Single<Monitoring> update(Monitoring monitoring) {
        ...
        return nodeMonitoringRepository.save(toJdbcEntity(monitoring)).map(this::toEntity);
    }
}
