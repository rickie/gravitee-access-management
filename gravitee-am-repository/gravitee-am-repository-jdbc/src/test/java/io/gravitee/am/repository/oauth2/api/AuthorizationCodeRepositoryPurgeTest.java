...
public class AuthorizationCodeRepositoryPurgeTest extends AbstractOAuthTest {
    ...
    @Autowired private JdbcAuthorizationCodeRepository authorizationCodeRepository;
    ...
    public void shouldRemoveCode() {
        ...
        authorizationCodeExpired.setExpireAt(
                new Date(now.minus(1, ChronoUnit.MINUTES).toEpochMilli()));

        TestObserver<AuthorizationCode> testObserver =
                authorizationCodeRepository.create(authorizationCode).test();
