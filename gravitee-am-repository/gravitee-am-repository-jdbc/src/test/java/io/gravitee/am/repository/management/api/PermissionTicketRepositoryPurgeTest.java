...
public class PermissionTicketRepositoryPurgeTest extends AbstractManagementTest {
    ...
    @Autowired private JdbcPermissionTicketRepository repository;
    ...
    public void testPurge() throws TechnicalException {
        ...
        PermissionTicket permissionTicketNoExpireAt =
        ...
        PermissionTicket permissionTicketExpired =
                new PermissionTicket().setPermissionRequest(Arrays.asList(permission));
        permissionTicketExpired.setExpireAt(
