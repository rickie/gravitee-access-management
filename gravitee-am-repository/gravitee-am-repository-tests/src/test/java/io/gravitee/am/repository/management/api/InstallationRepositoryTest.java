...
public class InstallationRepositoryTest extends AbstractManagementTest {
    ...
    public void testFindById() {
        ...
        Installation installationCreated =
                installationRepository.create(installation).blockingGet();

        // fetch idp
        TestObserver<Installation> testObserver =
                installationRepository.findById(installationCreated.getId()).test();
        ...
        testObserver.assertValue(
                found ->
                        found.getId().equals(installation.getId())
                                && found.getAdditionalInformation()
                                        .equals(installation.getAdditionalInformation()));
    }
    ...
    public void testCreate() {
        Installation installation = buildInstallation();
        TestObserver<Installation> testObserver =
                installationRepository.create(installation).test();
        testObserver.awaitTerminalEvent();
        ...
        testObserver.assertValue(
                idp ->
                        idp.getId().equals(installation.getId())
                                && idp.getAdditionalInformation()
                                        .equals(installation.getAdditionalInformation()));
    }
    ...
    public void testUpdate() {
        ...
        TestObserver<Installation> testObserver =
                installationRepository.update(updatedInstallation).test();
        testObserver.awaitTerminalEvent();
        ...
        testObserver.assertValue(
                updated ->
                        updated.getId().equals(updatedInstallation.getId())
                                && updated.getAdditionalInformation()
                                        .equals(updatedInstallation.getAdditionalInformation()));
    }
    ...
    public void testDelete() {
        ...
        TestObserver<Void> testObserver1 =
                installationRepository.delete(installationCreated.getId()).test();
