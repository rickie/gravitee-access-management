...
public class MembershipRepositoryTest extends AbstractManagementTest {
    ...
    public void testFindById() {
        ...
        TestObserver<Membership> obs =
                membershipRepository.findById(createdMembership.getId()).test();
    ...
    public void testFindByReference() {
        ...
        TestObserver<List<Membership>> obs =
                membershipRepository
                        .findByReference(ORGANIZATION_ID, ReferenceType.ORGANIZATION)
                        .toList()
                        .test();
        obs.awaitTerminalEvent();
    ...
    public void testFindByMember() {
        ...
        TestObserver<List<Membership>> obs =
                membershipRepository.findByMember("user#1", MemberType.USER).toList().test();
        obs.awaitTerminalEvent();
        ...
        obs.assertValue(
                m ->
                        m.size() == 1
                                && m.get(0).getMemberId().equals(createdMembership.getMemberId()));
    }
    ...
    public void testFindByCriteria() {
        ...
        TestSubscriber<Membership> obs =
                membershipRepository
                        .findByCriteria(ReferenceType.ORGANIZATION, ORGANIZATION_ID, criteria)
                        .test();
        ...
        obs.assertValue(
                m -> m.getMemberType() == MemberType.USER && m.getMemberId().equals("user#1"));
        ...
        obs.assertValueCount(1);
        obs.assertValue(
                m -> m.getMemberType() == MemberType.GROUP && m.getMemberId().equals("group#1"));
