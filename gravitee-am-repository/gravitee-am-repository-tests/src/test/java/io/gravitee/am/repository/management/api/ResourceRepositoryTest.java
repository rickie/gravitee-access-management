...
public class ResourceRepositoryTest extends AbstractManagementTest {
    ...
    public void testFindById() throws TechnicalException {
        ...
        testObserver.assertValue(
                s -> s.getResourceScopes().containsAll(resource.getResourceScopes()));
    ...
    public void update() throws TechnicalException {
        ...
        Resource toUpdate =
                new Resource()
                        .setId(rsCreated.getId())
                        .setResourceScopes(Arrays.asList("d", "e", "f"));
        ...
        testObserver.assertNoErrors();
        testObserver.assertValue(
                s -> s.getResourceScopes().containsAll(Arrays.asList("d", "e", "f")));
    }
    ...
    public void findByDomainAndClientAndUserAndResource() throws TechnicalException {
        ...
        TestObserver<Resource> testObserver =
                repository
                        .findByDomainAndClientAndUserAndResource(
                                DOMAIN_ID, CLIENT_ID, USER_ID, rsCreated.getId())
                        .test();
        testObserver.awaitTerminalEvent();
        ...
        testObserver.assertNoErrors();
        testObserver.assertValue(
                s -> s.getResourceScopes().containsAll(Arrays.asList("a", "b", "c")));
    }
    ...
    public void findByDomainAndClientAndUser() throws TechnicalException {
        ...
        // fetch scope
        TestObserver<List<Resource>> testObserver =
                repository
                        .findByDomainAndClientAndUser(DOMAIN_ID, CLIENT_ID, USER_ID)
                        .toList()
                        .test();
        testObserver.awaitTerminalEvent();
    ...
    public void testFindByDomain() throws TechnicalException {
        ...
        // fetch applications
        TestObserver<Page<Resource>> testObserver =
                repository.findByDomain(DOMAIN_ID, 0, Integer.MAX_VALUE).test();
        testObserver.awaitTerminalEvent();
    ...
    public void testFindByDomain_page() throws TechnicalException {
        ...
        testObserver.assertValue(
                resources -> readIds.add(resources.getData().iterator().next().getId()));
    ...
    public void testFindByResources() throws TechnicalException {
        ...
        TestSubscriber<Resource> testSubscriber =
                repository
                        .findByResources(
                                Arrays.asList(
                                        rsCreated1.getId(), rsCreated2.getId(), "notMatching"))
                        .test();
    ...
    public void testFindByDomainAndClientAndUserAndResources() throws TechnicalException {
        ...
        Resource resource2 =
                new Resource()
                        .setResourceScopes(Arrays.asList("b"))
                        .setDomain(DOMAIN_ID)
                        .setClientId(CLIENT_ID)
                        .setUserId(USER_ID);
        Resource resource3 =
                new Resource()
                        .setResourceScopes(Arrays.asList("c"))
                        .setDomain("another")
                        .setClientId(CLIENT_ID)
                        .setUserId(USER_ID);
        Resource resource4 =
                new Resource()
                        .setResourceScopes(Arrays.asList("d"))
                        .setDomain(DOMAIN_ID)
                        .setClientId("another")
                        .setUserId(USER_ID);
        Resource resource5 =
