...
public class PermissionTicketRepositoryTest extends AbstractManagementTest {
    ...
    @Autowired private PermissionTicketRepository repository;

    private static final PermissionRequest permission =
    ...
    public void testFindById() throws TechnicalException {
        ...
        PermissionTicket permissionTicket =
                new PermissionTicket().setPermissionRequest(Arrays.asList(permission));
    ...
    public void update() throws TechnicalException {
        ...
        PermissionTicket permissionTicket =
                new PermissionTicket().setPermissionRequest(Arrays.asList(source));
        PermissionTicket ptCreated = repository.create(permissionTicket).blockingGet();
        PermissionTicket toUpdate =
                new PermissionTicket()
                        .setId(ptCreated.getId())
                        .setPermissionRequest(Arrays.asList(permission));
