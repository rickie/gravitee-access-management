...
public class ThemeRepositoryTest extends AbstractManagementTest {
    ...
    public void testFindById() throws TechnicalException {
        ...
        testObserver.assertValue(
                d -> d.getSecondaryButtonColorHex().equals(theme.getSecondaryButtonColorHex()));
        testObserver.assertValue(
                d -> d.getPrimaryButtonColorHex().equals(theme.getPrimaryButtonColorHex()));
        testObserver.assertValue(
                d -> d.getPrimaryTextColorHex().equals(theme.getPrimaryTextColorHex()));
    ...
    public void testFindByReference_Domain() throws TechnicalException {
        ...
        TestObserver<Theme> testObserver =
                themeRepository.findByReference(ReferenceType.DOMAIN, DOMAIN_ID).test();
        testObserver.awaitTerminalEvent();
    ...
    public void testFindByReference_App() throws TechnicalException {
        ...
        TestObserver<Theme> testObserver =
                themeRepository.findByReference(ReferenceType.APPLICATION, APP_ID).test();
        testObserver.awaitTerminalEvent();
    ...
    public void testUpdate() throws TechnicalException {
        ...
        testObserver.assertValue(
                d ->
                        d.getSecondaryButtonColorHex()
                                .equals(updateTheme.getSecondaryButtonColorHex()));
        testObserver.assertValue(
                d -> d.getPrimaryButtonColorHex().equals(updateTheme.getPrimaryButtonColorHex()));
        testObserver.assertValue(
                d -> d.getPrimaryTextColorHex().equals(updateTheme.getPrimaryTextColorHex()));
