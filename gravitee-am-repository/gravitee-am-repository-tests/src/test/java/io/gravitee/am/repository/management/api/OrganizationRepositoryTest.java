...
public class OrganizationRepositoryTest extends AbstractManagementTest {
    ...
    public void testNotFoundById() {
        TestObserver<Organization> testObserver = RxJava2Adapter.monoToMaybe(organizationRepository.findById_migrated("unknown")).test();
    ...
    public void testCreate() {
        ...
        TestObserver<Organization> obs = RxJava2Adapter.monoToSingle(organizationRepository.create_migrated(organization)).test();
        obs.awaitTerminalEvent();
    ...
    public void testUpdate() {
        ...
        TestObserver<Organization> obs = RxJava2Adapter.monoToSingle(organizationRepository.update_migrated(organizationUpdated)).test();
        obs.awaitTerminalEvent();
