...
public class ExtensionGrantRepositoryTest extends AbstractManagementTest {
    ...
    public void testFindByDomain() throws TechnicalException {
        ...
        TestSubscriber<ExtensionGrant> testSubscriber =
                extensionGrantRepository.findByDomain("testDomain").test();
    ...
    public void testFindById() throws TechnicalException {
        // create extension grant
        ExtensionGrant extensionGrant = buildExtensionGrant();
        ExtensionGrant extensionGrantCreated =
                extensionGrantRepository.create(extensionGrant).blockingGet();

        // fetch extension grant
        TestObserver<ExtensionGrant> testObserver =
                extensionGrantRepository.findById(extensionGrantCreated.getId()).test();
        ...
        testObserver.assertValue(
                e -> e.getConfiguration().equals(extensionGrantCreated.getConfiguration()));
        testObserver.assertValue(e -> e.getDomain().equals(extensionGrantCreated.getDomain()));
        testObserver.assertValue(
                e -> e.getGrantType().equals(extensionGrantCreated.getGrantType()));
        testObserver.assertValue(e -> e.getType().equals(extensionGrantCreated.getType()));
        testObserver.assertValue(
                e -> e.getIdentityProvider().equals(extensionGrantCreated.getIdentityProvider()));
    ...
    public void testCreate() throws TechnicalException {
        ...
        TestObserver<ExtensionGrant> testObserver =
                extensionGrantRepository.create(extensionGrant).test();
        testObserver.awaitTerminalEvent();
    ...
    public void testUpdate() throws TechnicalException {
        ...
        TestObserver<ExtensionGrant> testObserver =
                extensionGrantRepository.update(updatedExtension).test();
        testObserver.awaitTerminalEvent();
    ...
    public void testDelete() throws TechnicalException {
        ...
        TestObserver testObserver1 =
                extensionGrantRepository.delete(extensionGrantCreated.getId()).test();
