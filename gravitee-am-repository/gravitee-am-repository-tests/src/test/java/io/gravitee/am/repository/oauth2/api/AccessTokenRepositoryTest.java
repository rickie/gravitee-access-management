...
public class AccessTokenRepositoryTest extends AbstractOAuthTest {
    ...
    public void shouldNotFindToken() {
        TestObserver<AccessToken> observer =
                accessTokenRepository.findByToken("unknown-token").test();
    ...
    public void shouldFindAuthorizationCode() {
        ...
        TestObserver<AccessToken> observer =
                accessTokenRepository
                        ...
                        .toCompletable()
                        .andThen(
                                accessTokenRepository.findByAuthorizationCode(
    ...
    public void shouldFindByClientIdAndSubject() {
        ...
        TestObserver<AccessToken> observer =
                accessTokenRepository
                        ...
                        .toCompletable()
                        .andThen(
                                accessTokenRepository.findByClientIdAndSubject(
                                        "my-client-id", "my-subject"))
                        .test();
        ...
        observer.assertValue(
                accessToken ->
                        accessToken.getSubject().equals("my-subject")
                                && accessToken.getClient().equals("my-client-id"));
    }
    ...
    public void shouldDeleteByDomainIdClientIdAndUserId() {
        ...
        TestObserver<AccessToken> testObserver =
                accessTokenRepository
                        ...
                        .andThen(
                                accessTokenRepository.deleteByDomainIdClientIdAndUserId(
                                        "domain-id", "client-id", "user-id"))
                        .andThen(accessTokenRepository.findByToken("my-token"))
                        .test();
    ...
    public void shouldDeleteByDomainIdAndUserId() {
        ...
        TestObserver<AccessToken> testObservable =
                accessTokenRepository
                        .create(token1)
                        .ignoreElement()
                        .andThen(accessTokenRepository.create(token2).ignoreElement())
                        .andThen(
                                accessTokenRepository.deleteByDomainIdAndUserId(
                                        "domain-id", "user-id"))
                        .andThen(accessTokenRepository.findByToken("my-token"))
                        .test();
