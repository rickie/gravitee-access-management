...
@Component
public class MongoPasswordHistoryRepository extends AbstractManagementMongoRepository
    ...
    public void init() {
        mongoCollection =
                mongoOperations.getCollection("password_histories", PasswordHistoryMongo.class);
    ...
    public Single<PasswordHistory> create(PasswordHistory item) {
        ...
        return Single.fromPublisher(mongoCollection.insertOne(historyMongo))
                .flatMap(
                        success -> {
    ...
    public Single<PasswordHistory> update(PasswordHistory item) {
        ...
        return Single.fromPublisher(
                        mongoCollection.replaceOne(
                                eq(FIELD_ID, historyMongo.getId()), historyMongo))
