...
@Component
public class MongoI18nDictionaryRepository extends AbstractManagementMongoRepository
        implements I18nDictionaryRepository {
    ...
    public void init() {
        mongoCollection =
                mongoOperations.getCollection("i18n_dictionaries", I18nDictionaryMongo.class);
    ...
    public Single<I18nDictionary> create(I18nDictionary item) {
        ...
        dictionaryMongo.setId(
                dictionaryMongo.getId() == null ? generate() : dictionaryMongo.getId());
        return Single.fromPublisher(mongoCollection.insertOne(dictionaryMongo))
                .flatMap(
                        success -> {
    ...
    public Single<I18nDictionary> update(I18nDictionary item) {
        ...
        return Single.fromPublisher(
                        mongoCollection.replaceOne(
                                eq(FIELD_ID, dictionaryMongo.getId()), dictionaryMongo))
