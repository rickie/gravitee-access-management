 ...
 */
@Component
public class MongoCredentialRepository extends AbstractManagementMongoRepository
    ...
    public void init() {
        credentialsCollection =
                mongoOperations.getCollection("webauthn_credentials", CredentialMongo.class);
    ...
    public Maybe<Credential> findById(String id) {
        return Observable.fromPublisher(credentialsCollection.find(eq(FIELD_ID, id)).first())
                .firstElement()
                .map(this::convert);
    }
    ...
    public Single<Credential> create(Credential item) {
        ...
        return Single.fromPublisher(credentialsCollection.insertOne(credential))
                .flatMap(
                        success -> {
    ...
    public Single<Credential> update(Credential item) {
        ...
        return Single.fromPublisher(
                        credentialsCollection.replaceOne(
                                eq(FIELD_ID, credential.getId()), credential))
