...
public class RiskAssessmentSettingsMongo {
    ...
    public RiskAssessmentSettingsMongo setDeviceAssessment(
            AssessmentSettingsMongo deviceAssessment) {
        this.deviceAssessment = deviceAssessment;
        return this;
    }

    public RiskAssessmentSettingsMongo setIpReputationAssessment(
            AssessmentSettingsMongo ipReputationAssessment) {
        this.ipReputationAssessment = ipReputationAssessment;
        return this;
    }

    public RiskAssessmentSettingsMongo setGeoVelocityAssessment(
            AssessmentSettingsMongo geoVelocityAssessment) {
    ...
    public static RiskAssessmentSettingsMongo convert(RiskAssessmentSettings riskAssessment) {
        ...
        return new RiskAssessmentSettingsMongo()
                ...
                .setDeviceAssessment(
                        AssessmentSettingsMongo.convert(riskAssessment.getDeviceAssessment()))
                .setGeoVelocityAssessment(
                        AssessmentSettingsMongo.convert(riskAssessment.getGeoVelocityAssessment()))
                .setIpReputationAssessment(
                        AssessmentSettingsMongo.convert(
                                riskAssessment.getIpReputationAssessment()));
    }
