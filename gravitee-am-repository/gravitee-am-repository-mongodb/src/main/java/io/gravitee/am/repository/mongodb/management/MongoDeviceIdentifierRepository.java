 ...
 */
@Component
public class MongoDeviceIdentifierRepository extends AbstractManagementMongoRepository
    ...
    @PostConstruct
    public void init() {
        deviceIdentifierMongoMongoCollection =
                mongoOperations.getCollection(COLLECTION_NAME, DeviceIdentifierMongo.class);
    ...
    @Override
    public Flowable<DeviceIdentifier> findByReference(
            ReferenceType referenceType, String referenceId) {
        return Flowable.fromPublisher(
                        deviceIdentifierMongoMongoCollection.find(
                                and(
    ...
    public Maybe<DeviceIdentifier> findById(String botDetectionId) {
        return Observable.fromPublisher(
                        deviceIdentifierMongoMongoCollection
                                .find(eq(FIELD_ID, botDetectionId))
                                .first())
                .firstElement()
                .map(this::convert);
    }
    ...
    public Single<DeviceIdentifier> create(DeviceIdentifier item) {
        ...
        return Single.fromPublisher(deviceIdentifierMongoMongoCollection.insertOne(entity))
                .flatMap(
                        success -> {
    ...
    public Single<DeviceIdentifier> update(DeviceIdentifier item) {
        ...
        return Single.fromPublisher(
                        deviceIdentifierMongoMongoCollection.replaceOne(
    ...
    public Completable delete(String id) {
        return Completable.fromPublisher(
                deviceIdentifierMongoMongoCollection.deleteOne(eq(FIELD_ID, id)));
    }
        ...
        return ofNullable(entity)
                ...
                .map(
                        e -> {
                            ...
                            deviceIdentifier.setReferenceType(
                                    ReferenceType.valueOf(e.getReferenceType()));
