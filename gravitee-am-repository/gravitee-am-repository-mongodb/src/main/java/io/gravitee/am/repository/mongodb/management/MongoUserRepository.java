 ...
 */
@Component
public class MongoUserRepository extends AbstractUserRepository<UserMongo>
        ...
        return Observable.fromPublisher(
                ...
                .map(
                        doc -> {
                            ...
                            Long activeUsers =
                                    ((Number) doc.get("total")).longValue() - nonActiveUsers;
