...
public class LoginSettingsMongoTest {
    ...
    private void assertMongoResult(
            LoginSettingsMongo expectedSetting,
            boolean isHideForm,
            boolean isIdentifierFirstLoginEnabled) {
        assertEquals(expectedSetting.isHideForm(), isHideForm);
        assertEquals(
                expectedSetting.isIdentifierFirstLoginEnabled(), isIdentifierFirstLoginEnabled);
    }
}
