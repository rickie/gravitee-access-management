...
public class R2DBCConnectionMetrics {
    ...
    public void register(ConnectionPool pool) {
        pool.getMetrics()
                .ifPresent(
                        metrics -> {
                            Gauge.builder("r2dbc_pool_acquiredSize", () -> metrics.acquiredSize())
                                    .tags(tags)
                                    .register(registry);
                            Gauge.builder("r2dbc_pool_allocatedSize", () -> metrics.allocatedSize())
                                    .tags(tags)
                                    .register(registry);
                            Gauge.builder(
                                    ...
                                    .tags(tags)
                                    .register(registry);
                            Gauge.builder("r2dbc_pool_idleSize", () -> metrics.idleSize())
                                    .tags(tags)
                                    .register(registry);
                            Gauge.builder(
