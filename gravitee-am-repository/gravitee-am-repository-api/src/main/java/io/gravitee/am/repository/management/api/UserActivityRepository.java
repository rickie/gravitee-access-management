...
public interface UserActivityRepository extends CrudRepository<UserActivity, String> {
    ...
    Flowable<UserActivity> findByReferenceAndTypeAndKeyAndLimit(
    ...
    default Flowable<UserActivity> findByDomainAndTypeAndKeyAndLimit(
            String domain, Type type, String key, int limit) {
        return findByReferenceAndTypeAndKeyAndLimit(ReferenceType.DOMAIN, domain, type, key, limit);
    }

    Completable deleteByReferenceAndKey(
