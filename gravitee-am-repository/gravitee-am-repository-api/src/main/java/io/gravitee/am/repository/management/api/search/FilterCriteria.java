...
public class FilterCriteria {
    ...
    public static FilterCriteria convert(Filter scimFilter) {
        ...
        String filterAttribute =
                scimFilter.getFilterAttribute() != null
                        ? scimFilter
                                .getFilterAttribute()
                                .toString()
                                .replace(Schema.SCHEMA_URI_USER + ":", "")
                                .replace(Schema.SCHEMA_URI_GROUP + ":", "")
                        : null;
        FilterCriteria filterCriteria =
                new FilterCriteria(
                        ...
                        scimFilter.getFilterComponents() != null
                                ? scimFilter.getFilterComponents().stream()
                                        .map(FilterCriteria::convert)
    ...
    public String toString() {
        return "{\"_class\":\"FilterCriteria\", "
                ...
                + ", "
                + "\"filterComponents\":"
                + (filterComponents == null ? "null" : Arrays.toString(filterComponents.toArray()))
                + "}";
    }
}
