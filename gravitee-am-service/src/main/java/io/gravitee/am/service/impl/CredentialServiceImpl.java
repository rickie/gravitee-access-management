...
public class CredentialServiceImpl implements CredentialService {
    ...
    public Single<Credential> update(Credential credential) {
        ...
        return RxJava2Adapter.monoToMaybe(RxJava2Adapter.maybeToMono(credentialRepository.findById(credential.getId())).switchIfEmpty(Mono.error(new CredentialNotFoundException(credential.getId()))))
    ...
    public Completable delete(String id) {
        ...
        return RxJava2Adapter.monoToCompletable(RxJava2Adapter.maybeToMono(credentialRepository.findById(id)).switchIfEmpty(Mono.error(new CredentialNotFoundException(id))).flatMap(email->RxJava2Adapter.completableToMono(credentialRepository.delete(id))).then())
                .onErrorResumeNext(ex -> {
                    if (ex instanceof AbstractManagementException) {
