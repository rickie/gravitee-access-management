...
public interface AuthenticationDeviceNotifierService {
    ...
    Single<AuthenticationDeviceNotifier> create(
            String domain, NewAuthenticationDeviceNotifier notifier, User principal);

    Single<AuthenticationDeviceNotifier> update(
            String domain,
            String id,
    ...
    default Single<AuthenticationDeviceNotifier> create(
            String domain, NewAuthenticationDeviceNotifier notifier) {
        return create(domain, notifier, null);
    }

    default Single<AuthenticationDeviceNotifier> update(
            String domain, String id, UpdateAuthenticationDeviceNotifier updateNotifier) {
