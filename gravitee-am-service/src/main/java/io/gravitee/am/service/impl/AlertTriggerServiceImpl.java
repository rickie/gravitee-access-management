...
public class AlertTriggerServiceImpl implements io.gravitee.am.service.AlertTriggerService {
    ...
    public AlertTriggerServiceImpl(
     ...
     * @return the alert trigger found or an {@link AlertTriggerNotFoundException} if no alert
     ...
     */
    @Override
    public Single<AlertTrigger> getById(
        ...
        return alertTriggerRepository
                ...
                .filter(
                        alertTrigger ->
                                alertTrigger.getReferenceType().equals(referenceType)
                                        && alertTrigger.getReferenceId().equals(referenceId))
                .switchIfEmpty(Single.error(new AlertTriggerNotFoundException(id)));
    }
     ...
     */
    @Override
    public Flowable<AlertTrigger> findByDomainAndCriteria(
            String domainId, AlertTriggerCriteria criteria) {
    ...
    /**
     * Create or update an alert trigger. Note: alert trigger are predefined. There is at most one
     * trigger of each type for a given reference.
     *
     * @param referenceType the reference type.
     * @param referenceId the reference id.
     ...
     */
    @Override
    public Single<AlertTrigger> createOrUpdate(
            ReferenceType referenceType,
            String referenceId,
            PatchAlertTrigger patchAlertTrigger,
            User byUser) {
        LOGGER.debug(
                "Create or update alert trigger for {} {}: {}",
                referenceType,
                referenceId,
                patchAlertTrigger);
     ...
     * @return nothing if the alert trigger has been successfully delete or an {@link
     *     AlertTriggerNotFoundException} exception if it has not been found.
     */
    @Override
    public Completable delete(
            ReferenceType referenceType, String referenceId, String alertTriggerId, User byUser) {
    ...
    private Single<AlertTrigger> createInternal(AlertTrigger toCreate, User byUser) {
        ...
        return alertTriggerRepository
                ...
                .doOnSuccess(
                        alertTrigger ->
                                auditService.report(
                                        AuditBuilder.builder(AlertTriggerAuditBuilder.class)
                                                .type(EventType.ALERT_TRIGGER_CREATED)
                ...
                .doOnError(
                        throwable ->
                                auditService.report(
                                        AuditBuilder.builder(AlertTriggerAuditBuilder.class)
                                                .type(EventType.ALERT_TRIGGER_CREATED)
                                                .alertTrigger(toCreate)
                                                .principal(byUser)
                                                .throwable(throwable)));
    }

    private Single<AlertTrigger> updateInternal(
            AlertTrigger alertTrigger, User updatedBy, AlertTrigger previous) {
        ...
        return alertTriggerRepository
                ...
                .doOnSuccess(
                        updated ->
                                auditService.report(
                                        AuditBuilder.builder(AlertTriggerAuditBuilder.class)
                                                .type(EventType.ALERT_TRIGGER_UPDATED)
                                                .alertTrigger(updated)
                                                .principal(updatedBy)
                                                .oldValue(previous)))
                .doOnError(
                        throwable ->
        ...
        return alertTriggerRepository
                ...
                .doOnComplete(
                        () ->
                                auditService.report(
                                        AuditBuilder.builder(AlertTriggerAuditBuilder.class)
                                                .type(EventType.ALERT_TRIGGER_DELETED)
                                                .alertTrigger(alertTrigger)
                                                .principal(deletedBy)))
                .doOnError(
                        throwable ->
