 ...
 */
public class DeviceIdentifierAuditBuilder
        extends ManagementAuditBuilder<DeviceIdentifierAuditBuilder> {

    private static final List<String> NEW_VALUE_EVENT_TYPE =
            List.of(EventType.DEVICE_IDENTIFIER_CREATED, EventType.BOT_DETECTION_UPDATED);
    ...
    public DeviceIdentifierAuditBuilder deviceIdentifier(DeviceIdentifier deviceIdentifier) {
        if (deviceIdentifier != null) {
            ...
            setTarget(
                    ...
                    null,
                    deviceIdentifier.getName(),
                    deviceIdentifier.getReferenceType(),
                    deviceIdentifier.getReferenceId());
        }
        return this;
    }
}
