...
public class PermissionSettingUtils {
     ...
     *
     * <p>Ex: if settings.oauth is filled, {@link Permission#APPLICATION_OPENID} will be added to
     * the list of required permissions cause it means the user want to update this information.
     *
    ...
    private static void setApplicationSettingsPermissions(
            PatchApplication application, Set<Permission> requiredPermissions) {
    ...
    private static void setIdentityProvidersPermissions(
            PatchApplication application, Set<Permission> requiredPermissions) {
    ...
    private static void setFactorsPermissions(
            PatchApplication application, Set<Permission> requiredPermissions) {
    ...
    private static void setCertificatePermission(
            PatchApplication application, HashSet<Permission> requiredPermissions) {
    ...
    private static void setSubApplicationSettingsPermissions(
            PatchApplication application, HashSet<Permission> requiredPermissions) {
    ...
    private static void setApplicationSettingsPermission(
            PatchApplicationSettings settings, Set<Permission> requiredPermissions) {
    ...
    private static void setOpenIDPermission(
            PatchApplicationSettings settings, Set<Permission> requiredPermissions) {
    ...
    private static void setSamlPermission(
            PatchApplicationSettings settings, Set<Permission> requiredPermissions) {
