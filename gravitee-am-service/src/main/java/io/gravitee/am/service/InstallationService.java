...
public interface InstallationService {
     ...
     *
     * @return the current installation or an {@link
     *     io.gravitee.am.service.exception.InstallationNotFoundException} exception.
     */
     ...
     *
     * @param additionalInformation the list of additional information to set on the existing
     *     installation.
     ...
     *
     * @param additionalInformation the list of additional information to add or update on the
