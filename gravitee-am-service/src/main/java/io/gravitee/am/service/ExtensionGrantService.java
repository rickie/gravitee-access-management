...
public interface ExtensionGrantService {
    ...
    default Single<ExtensionGrant> update(
            String domain, String id, UpdateExtensionGrant updateExtensionGrant) {
