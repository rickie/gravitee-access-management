...
@Deprecated  
default Maybe<ExtensionGrant> findById(String id) {
    return RxJava2Adapter.monoToMaybe(findById_migrated(id));
}
default Mono<ExtensionGrant> findById_migrated(String id) {
...
@Deprecated  
default Flowable<ExtensionGrant> findByDomain(String tokenGranter) {
    return RxJava2Adapter.fluxToFlowable(findByDomain_migrated(tokenGranter));
}
default Flux<ExtensionGrant> findByDomain_migrated(String tokenGranter) {
...
@Deprecated  
default Single<ExtensionGrant> create(String domain, NewExtensionGrant newExtensionGrant, User principal) {
    return RxJava2Adapter.monoToSingle(create_migrated(domain, newExtensionGrant, principal));
}
default Mono<ExtensionGrant> create_migrated(String domain, NewExtensionGrant newExtensionGrant, User principal) {
...
@Deprecated  
default Single<ExtensionGrant> update(String domain, String id, UpdateExtensionGrant updateExtensionGrant, User principal) {
    return RxJava2Adapter.monoToSingle(update_migrated(domain, id, updateExtensionGrant, principal));
}
default Mono<ExtensionGrant> update_migrated(String domain, String id, UpdateExtensionGrant updateExtensionGrant, User principal) {
...
@Deprecated  
default Completable delete(String domain, String certificateId, User principal) {
    return RxJava2Adapter.monoToCompletable(delete_migrated(domain, certificateId, principal));
}
default Mono<Void> delete_migrated(String domain, String certificateId, User principal) {
