...
public class BotDetectionAuditBuilder extends ManagementAuditBuilder<BotDetectionAuditBuilder> {
    ...
    public BotDetectionAuditBuilder botDetection(BotDetection botDetection) {
        if (botDetection != null) {
            if (EventType.BOT_DETECTION_CREATED.equals(getType())
                    || EventType.BOT_DETECTION_UPDATED.equals(getType())) {
            ...
            setTarget(
                    botDetection.getId(),
                    EntityType.BOT_DETECTION,
                    null,
                    botDetection.getName(),
                    botDetection.getReferenceType(),
                    botDetection.getReferenceId());
        }
        return this;
    }
}
