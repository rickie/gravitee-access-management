...
public class FormServiceImpl implements FormService {
    ...
    @Lazy @Autowired private FormRepository formRepository;
    ...
    public Maybe<Form> findById(String id) {
        ...
        return formRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find a form using its id {}",
                                    id,
                                    ex);
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find a form using its id %s",
                                                    id),
                                            ex));
                        });
    }
    ...
    public Flowable<Form> findAll(ReferenceType referenceType, String referenceId) {
        ...
        return formRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find a form using its {} {}",
                                    referenceType,
                                    referenceId,
                                    ex);
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find a form using its %s %s",
    ...
    public Maybe<Form> findByClientAndTemplate(
        ...
        LOGGER.debug(
                "Find form by {} {}, client {} and template {}",
                referenceType,
                referenceId,
                client,
                template);
    ...
    @Override
    public Maybe<Form> findByDomainAndClientAndTemplate(
    ...
    @Override
    public Single<List<Form>> copyFromClient(
            String domain, String clientSource, String clientTarget) {
        ...
        return formRepository
                                            ...
                                            page -> {
                                                ...
                                                Event event =
                                                        new Event(
                                                                ...
                                                                new Payload(
                                                                        page.getId(),
                                                                        page.getReferenceType(),
                                                                        page.getReferenceId(),
                                                                        Action.UPDATE));
                                                return eventService
                                                        .create(event)
                                                        .flatMap(__ -> Single.just(page));
                                            })
                                    .doOnSuccess(
                                            form ->
                                                    auditService.report(
                                                            AuditBuilder.builder(
                                                                            FormTemplateAuditBuilder
                                                                                    .class)
                                                                    .principal(principal)
                                                                    .type(
                                                                            EventType
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to update a form", ex));
                        });
    }
    ...
    @Override
    public Single<Form> update(
            String domain, String client, String id, UpdateForm updateForm, User principal) {
        LOGGER.debug("Update a form {} for domain {} and client {}", id, domain, client);
        return update(ReferenceType.DOMAIN, domain, id, updateForm, principal);
    }

    private Single<Form> create0(
            ReferenceType referenceType,
            String referenceId,
            String client,
            NewForm newForm,
        ...
        return checkFormUniqueness(
                        referenceType, referenceId, client, newForm.getTemplate().template())
                .flatMap(
                        irrelevant -> {
                            Form form = new Form();
                            form.setId(formId);
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to create a form", ex));
                        })
                .doOnSuccess(
                        form ->
                                auditService.report(
                                        AuditBuilder.builder(FormTemplateAuditBuilder.class)
                                                .principal(principal)
        ...
        return formRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to delete form: {}", formId, ex);
                            return Completable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to delete form: %s",
                                                    formId),
                                            ex));
                        });
    }
    ...
    private Single<Boolean> checkFormUniqueness(
            ReferenceType referenceType, String referenceId, String client, String formTemplate) {
        Maybe<Form> maybeSource =
                client == null
