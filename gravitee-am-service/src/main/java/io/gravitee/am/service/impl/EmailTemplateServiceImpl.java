...
public class EmailTemplateServiceImpl implements EmailTemplateService {
    ...
    @Lazy @Autowired private EmailRepository emailRepository;
    ...
    public Flowable<Email> findAll(ReferenceType referenceType, String referenceId) {
        ...
        return emailRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find all emails for {} {}",
                                    referenceType,
                                    referenceId,
                                    ex);
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find a all emails for %s %s",
        ...
        return emailRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find a all emails",
                                            ex));
                        });
    }

    @Override
    public Flowable<Email> findByClient(
                            ...
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    ...
                                                    referenceType, referenceId, client),
                                            ex));
                        });
    }

    @Override
    public Maybe<Email> findByTemplate(
                            ...
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    ...
                                                    referenceType, referenceId, template),
                                            ex));
                        });
    }
                            ...
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    ...
                                                    referenceType, referenceId, client, template),
                                            ex));
                        });
    }

    @Override
    public Maybe<Email> findByDomainAndClientAndTemplate(
            String domain, String client, String template) {
    ...
    public Maybe<Email> findById(String id) {
        ...
        return emailRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find a email using its id {}",
                                    id,
                                    ex);
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find a email using its id %s",
                                                    id),
                                            ex));
                        });
    }
    ...
    public Single<Email> create(
            ...
            User principal) {
        LOGGER.debug(
                "Create a new email {} for {} {} and client {}",
                newEmail,
                referenceType,
                referenceId,
                client);
        ...
        return emailRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to delete email: {}",
                                    emailId,
                                    ex);
                            return Completable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to delete email: %s",
                                                    emailId),
                                            ex));
                        });
    }

    private Single<Email> create0(
            ReferenceType referenceType,
            String referenceId,
            String client,
            NewEmail newEmail,
        ...
        return checkEmailUniqueness(
                        referenceType, referenceId, client, newEmail.getTemplate().template())
                .flatMap(
                        irrelevant -> {
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to create a email", ex));
                        })
                .doOnSuccess(
                        email ->
                                auditService.report(
                                        AuditBuilder.builder(EmailTemplateAuditBuilder.class)
                                                .principal(principal)
        ...
        return emailRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to update a email", ex));
                        });
    }

    private Single<Boolean> checkEmailUniqueness(
            ReferenceType referenceType, String referenceId, String client, String emailTemplate) {
        Maybe<Email> maybeSource =
                client == null
                        ? findByTemplate(referenceType, referenceId, emailTemplate)
                        : findByClientAndTemplate(
                                referenceType, referenceId, client, emailTemplate);
