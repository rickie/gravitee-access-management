...
public class LoginAttemptServiceImpl implements LoginAttemptService {
    ...
    @Lazy @Autowired private LoginAttemptRepository loginAttemptRepository;

    @Override
    public Single<LoginAttempt> loginFailed(
            LoginAttemptCriteria criteria, AccountSettings accountSettings) {
                        ...
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to add a login attempt",
                                            ex));
                        });
    }
        ...
        return loginAttemptRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to delete login attempt for",
                                    criteria,
                                    ex);
                            return Completable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to delete login attempt: %s",
                                                    criteria),
                                            ex));
                        });
    }
    ...
    @Override
    public Maybe<LoginAttempt> checkAccount(
            LoginAttemptCriteria criteria, AccountSettings accountSettings) {
        ...
        return loginAttemptRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to find login attempt by id {}",
                                    id,
                                    ex);
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to fin login attempt by id: %s",
                                                    id),
                                            ex));
                        });
    }
