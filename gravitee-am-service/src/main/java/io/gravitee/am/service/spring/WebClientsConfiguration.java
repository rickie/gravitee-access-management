...
public class WebClientsConfiguration {
    ...
    protected WebClient recaptchaWebClient(Vertx vertx, WebClientBuilder webClientBuilder)
            throws MalformedURLException {
        return webClientBuilder.createWebClient(vertx, URI.create(recaptchaServiceUrl).toURL());
    }

    @Bean("newsletterWebClient")
    protected WebClient newsletterWebClient(Vertx vertx, WebClientBuilder webClientBuilder)
            throws MalformedURLException {
