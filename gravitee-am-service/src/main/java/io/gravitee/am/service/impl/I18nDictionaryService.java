...
public class I18nDictionaryService {
    ...
    @Autowired
    public I18nDictionaryService(
            @Lazy I18nDictionaryRepository repository,
    ...
    public Single<I18nDictionary> create(
        ...
        return findByName(referenceType, referenceId, newDictionary.getName())
                ...
                .onErrorResumeNext(
                        ex -> {
                            if (ex instanceof AbstractManagementException) {
                                ...
                                String msg =
                                        "An error occurred while trying to create an i18n dictionary";
                                LOGGER.error(msg, ex);
                ...
                .doOnSuccess(
                        dictionary ->
                                auditService.report(
                                        AuditBuilder.builder(DictionaryAuditBuilder.class)
                                                .principal(principal)
    ...
    public Maybe<I18nDictionary> findByName(
        ...
        return repository
                .findByName(referenceType, referenceId, name)
                .onErrorResumeNext(
                        ex -> {
                            String msg =
                                    "An error occurred while trying to find a dictionary using its name: ? for the ? ?";
                            LOGGER.error(
                                    msg.replace("?", "{}"), name, referenceType, referenceId, ex);
                            return Maybe.error(
    ...
    public Single<I18nDictionary> update(
            ReferenceType referenceType,
            String referenceId,
            String id,
            UpdateI18nDictionary updateDictionary,
            User principal) {
    ...
    public Single<I18nDictionary> updateEntries(
            ReferenceType referenceType,
            String referenceId,
            String id,
    ...
    public Maybe<I18nDictionary> findById(
        ...
        return repository
                ...
                .onErrorResumeNext(
                        ex -> {
                            String msg =
                                    "An error occurred while trying to find a dictionary using its id ?";
    ...
    public Flowable<I18nDictionary> findAll(ReferenceType referenceType, String referenceId) {
        ...
        return repository
                ...
                .onErrorResumeNext(
                        ex -> {
                            String msg =
                                    "An error occurred while trying to find dictionaries by ? ?";
                                                ...
                                                () ->
                                                        auditService.report(
                                                                AuditBuilder.builder(
                                                                                DictionaryAuditBuilder
                                                                                        .class)
                                                                        .principal(principal)
                                                                        .type(
                                                                                EventType
                                                                                        .I18N_DICTIONARY_DELETED)
                                                                        .dictionary(dictionary)))
                                        .doOnError(
                                                throwable ->
                                                        auditService.report(
