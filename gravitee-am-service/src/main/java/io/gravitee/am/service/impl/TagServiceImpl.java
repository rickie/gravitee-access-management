...
public class TagServiceImpl implements TagService {
    ...
    @Lazy @Autowired private TagRepository tagRepository;
    ...
    public Maybe<Tag> findById(String id, String organizationId) {
        ...
        return tagRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find a tag using its ID: {}",
                                    id,
                                    ex);
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find a tag using its ID: %s",
                                                    id),
                                            ex));
                        });
    }
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find all tags", ex));
                        });
    }
        ...
        return tagRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to create a tag", ex));
                        })
                .doOnSuccess(
                        tag ->
                                auditService.report(
                                        AuditBuilder.builder(TagAuditBuilder.class)
                                                .tag(tag)
                                                .principal(principal)
    ...
    @Override
    public Single<Tag> update(
            String tagId, String organizationId, UpdateTag updateTag, User principal) {
        ...
        return tagRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to update a tag", ex));
                        });
    }
        ...
        return tagRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to delete tag {}", tagId, ex);
                            return Completable.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to delete tag " + tagId,
                                            ex));
                        });
    }
