...
public class ConsecutiveCharacterPasswordValidator implements PasswordValidator {
    ...
    public Boolean validate(String password) {
        return isNull(maxConsecutiveLetters)
                || maxConsecutiveLetters < 1
                || !isOverMaxConsecutiveLetters(password, maxConsecutiveLetters);
    }

    /**
     * Test if any character is repeated consecutively more than the giver max number str="aaabb",
     * max=3 -> true str="aaabb", max=2 -> false
     */
