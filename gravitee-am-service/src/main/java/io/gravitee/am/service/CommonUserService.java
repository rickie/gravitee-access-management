...
@Deprecated  
default Single<Page<User>> search(ReferenceType referenceType, String referenceId, FilterCriteria filterCriteria, int page, int size) {
    return RxJava2Adapter.monoToSingle(search_migrated(referenceType, referenceId, filterCriteria, page, size));
}
default Mono<Page<User>> search_migrated(ReferenceType referenceType, String referenceId, FilterCriteria filterCriteria, int page, int size) {
...
@Deprecated  
default Single<User> enhance(User user) {
    return RxJava2Adapter.monoToSingle(enhance_migrated(user));
}
default Mono<User> enhance_migrated(User user) {
