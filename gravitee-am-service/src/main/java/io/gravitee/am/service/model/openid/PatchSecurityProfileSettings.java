...
public class PatchSecurityProfileSettings {
    ...
    /**
     * Apply the standard Open Banking Brasil Financial-grade API Security Profile 1.0 (version
     * 1.0).
     */
    ...
    public SecurityProfileSettings patch(SecurityProfileSettings toPatch) {
        SecurityProfileSettings result =
                toPatch != null ? toPatch : SecurityProfileSettings.defaultSettings();
