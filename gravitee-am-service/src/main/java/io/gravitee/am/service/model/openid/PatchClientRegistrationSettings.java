...
public class PatchClientRegistrationSettings {
    ...
    public void setDynamicClientRegistrationEnabled(
            Optional<Boolean> isDynamicClientRegistrationEnabled) {
    ...
    public ClientRegistrationSettings patch(ClientRegistrationSettings toPatch) {
        ClientRegistrationSettings result =
                toPatch != null ? toPatch : ClientRegistrationSettings.defaultSettings();

        SetterUtils.safeSet(
                result::setAllowWildCardRedirectUri,
                this.getAllowWildCardRedirectUri(),
                boolean.class);
        SetterUtils.safeSet(
                result::setAllowHttpSchemeRedirectUri,
                this.getAllowHttpSchemeRedirectUri(),
                boolean.class);
        SetterUtils.safeSet(
                result::setAllowLocalhostRedirectUri,
                this.getAllowLocalhostRedirectUri(),
                boolean.class);
        SetterUtils.safeSet(
                result::setOpenDynamicClientRegistrationEnabled,
                this.isOpenDynamicClientRegistrationEnabled(),
                boolean.class);
        SetterUtils.safeSet(
                result::setDynamicClientRegistrationEnabled,
                this.isDynamicClientRegistrationEnabled(),
                boolean.class);
        SetterUtils.safeSet(result::setDefaultScopes, this.getDefaultScopes());
        SetterUtils.safeSet(
                result::setAllowedScopesEnabled, this.isAllowedScopesEnabled(), boolean.class);
        SetterUtils.safeSet(result::setAllowedScopes, this.getAllowedScopes());
        SetterUtils.safeSet(
                result::setClientTemplateEnabled, this.isClientTemplateEnabled(), boolean.class);
