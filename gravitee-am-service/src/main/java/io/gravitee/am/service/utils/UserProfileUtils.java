...
public class UserProfileUtils {
    ...
    /**
     * Determine if the user displayName has been processed by AM during the User Creation. if so
     * the displayName will be updated otherwise it will remain unchanged (SCIM user may be
     * created/updated using custom displayName)
     *
     * @param user
     * @return
     */
            ...
            if (!Strings.isNullOrEmpty(user.getPreferredLanguage())) {
                ...
                preferredLanguage =
                        localeParts.length == 1
                                ...
                                : new Locale(localeParts[0], localeParts[1].toUpperCase());
