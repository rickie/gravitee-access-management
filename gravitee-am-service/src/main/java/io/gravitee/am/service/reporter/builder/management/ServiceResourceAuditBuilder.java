 ...
 */
public class ServiceResourceAuditBuilder
        extends ManagementAuditBuilder<ServiceResourceAuditBuilder> {
    ...
    public ServiceResourceAuditBuilder resource(ServiceResource resource) {
        if (resource != null) {
            if (EventType.RESOURCE_CREATED.equals(getType())
                    || EventType.RESOURCE_UPDATED.equals(getType())) {
