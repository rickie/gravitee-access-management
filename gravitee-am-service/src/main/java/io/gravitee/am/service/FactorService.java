...
public interface FactorService {
    ...
    Single<io.gravitee.am.model.User> enrollFactor(
    ...
    default Single<io.gravitee.am.model.User> enrollFactor(
            io.gravitee.am.model.User user, EnrolledFactor enrolledFactor) {
