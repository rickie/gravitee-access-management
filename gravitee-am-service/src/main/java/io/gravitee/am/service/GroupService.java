...
public interface GroupService {
    ...
    Single<Group> create(
            String domain, NewGroup group, io.gravitee.am.identityprovider.api.User principal);
    ...
    default Single<Group> assignRoles(
            ReferenceType referenceType, String referenceId, String groupId, List<String> roles) {
        return assignRoles(referenceType, referenceId, groupId, roles, null);
    }

    default Single<Group> revokeRoles(
            ReferenceType referenceType, String referenceId, String groupId, List<String> roles) {
