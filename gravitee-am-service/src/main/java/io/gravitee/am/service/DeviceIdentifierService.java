...
public interface DeviceIdentifierService {
    ...
    default Single<DeviceIdentifier> create(
            String domain, NewDeviceIdentifier newDeviceIdentifier) {
        return create(domain, newDeviceIdentifier, null);
    }

    default Single<DeviceIdentifier> update(
            String domain, String id, UpdateDeviceIdentifier updateDeviceIdentifier) {
