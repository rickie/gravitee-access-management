 ...
 */
public class IdentityProviderAuditBuilder
        extends ManagementAuditBuilder<IdentityProviderAuditBuilder> {
    ...
    public IdentityProviderAuditBuilder identityProvider(IdentityProvider identityProvider) {
        if (identityProvider != null) {
            if (EventType.IDENTITY_PROVIDER_CREATED.equals(getType())
                    || EventType.IDENTITY_PROVIDER_UPDATED.equals(getType())) {
