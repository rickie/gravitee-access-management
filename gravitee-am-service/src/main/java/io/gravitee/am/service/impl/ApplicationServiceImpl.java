...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    @Lazy @Autowired private ApplicationRepository applicationRepository;

    @Autowired private ApplicationTemplateManager applicationTemplateManager;

    @Autowired private AccountSettingsValidator accountSettingsValidator;
                        ...
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find applications",
                                            ex));
                        });
    }
    ...
    public Single<Page<Application>> findByDomain(String domain, int page, int size) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find applications by domain {}",
                                    domain,
                                    ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find applications by domain %s",
                                                    domain),
                                            ex));
                        });
    }
    ...
    public Single<Page<Application>> search(String domain, String query, int page, int size) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to search applications with query {} for domain {}",
                                    query,
                                    domain,
                                    ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to search applications with query %s by domain %s",
                                                    query, domain),
                                            ex));
                        });
    }
    ...
    public Flowable<Application> findByCertificate(String certificate) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find applications by certificate",
                                    ex);
    ...
    public Flowable<Application> findByIdentityProvider(String identityProvider) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find applications by identity provider",
                                    ex);
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find applications by identity provider",
    ...
    public Flowable<Application> findByFactor(String factor) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find applications by factor",
                                    ex);
                            return Flowable.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find applications by factor",
    ...
    @Override
    public Single<Set<Application>> findByDomainAndExtensionGrant(
            String domain, String extensionGrant) {
        LOGGER.debug(
                "Find applications by domain {} and extension grant : {}", domain, extensionGrant);
        return applicationRepository
                .findByDomainAndExtensionGrant(domain, extensionGrant)
                .collect(
                        () -> (Set<Application>) new HashSet(),
                        Set::add) // TODO CHECK IF FLOWABLE is useful...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find applications by extension grant",
                                    ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find applications by extension grant",
    ...
    public Flowable<Application> findByIdIn(List<String> ids) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find applications by ids {}",
                                    ids,
                                    ex);
                            return Flowable.error(
                                    new TechnicalManagementException(
    ...
    public Maybe<Application> findById(String id) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find an application using its ID: {}",
                                    id,
                                    ex);
                            return Maybe.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find an application using its ID: %s",
                                                    id),
                                            ex));
                        });
    }
    ...
    @Override
    public Single<Application> create(
        ...
        if (ApplicationType.SERVICE != application.getType()) {
            if (!ObjectUtils.isEmpty(newApplication.getRedirectUris())) {
                try {
                    ...
                    LOGGER.debug(
                            "An error has occurred when generating SAML attribute consume service url",
                            ex);
                }
            }
        }
                ...
                .onErrorResumeNext(
                        ex -> {
                            if (ex instanceof AbstractManagementException
                                    || ex instanceof OAuth2Exception) {
                                return Single.error(ex);
                            }
                            LOGGER.error(
                                    "An error occurs while trying to create an application", ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to create an application",
                                            ex));
                        });
    }
    ...
    public Single<Application> update(Application application) {
        ...
        return applicationRepository
                ...
                .flatMapSingle(
                        application1 ->
                                update0(application1.getDomain(), application1, application, null))
                .onErrorResumeNext(
                        ex -> {
                            if (ex instanceof AbstractManagementException
                                    || ex instanceof OAuth2Exception) {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to update an application", ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to update an application",
                                            ex));
                        });
    }

    @Override
    public Single<Application> updateType(
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to patch an application", ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to patch an application",
                                            ex));
                        });
    }

    @Override
    public Single<Application> patch(
                            ...
                            if (!accountSettingsValidator.validate(accountSettings)) {
                                return Single.error(
                                        new InvalidParameterException(
                                                "Unexpected forgot password field"));
                            }
                            return update0(domain, existingApplication, toPatch, principal);
                        })
                .onErrorResumeNext(
        ...
        return applicationRepository
                            ...
                            if (application.getSettings() == null) {
                                return Single.error(
                                        new IllegalStateException(
                                                "Application settings is undefined"));
                            }
                            if (application.getSettings().getOauth() == null) {
                                return Single.error(
                                        new IllegalStateException(
                                                "Application OAuth 2.0 settings is undefined"));
                            }
                            // update secret
                            application
                                    .getSettings()
                                    .getOauth()
                                    .setClientSecret(SecureRandomString.generate());
                            ...
                            Event event =
                                    new Event(
                                            ...
                                            new Payload(
                                                    ...
                                                    application1.getDomain(),
                                                    Action.UPDATE));
                            return eventService
                                    .create(event)
                                    .flatMap(domain1 -> Single.just(application1));
                        })
                .doOnSuccess(
                        updatedApplication ->
                                auditService.report(
                                        AuditBuilder.builder(ApplicationAuditBuilder.class)
                                                .principal(principal)
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to renew client secret for application {} and domain {}",
                                    id,
                                    domain,
                                    ex);
                            return Single.error(
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to delete application: {}",
                                    id,
                                    ex);
                            return Completable.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to delete application: %s",
                                                    id),
                                            ex));
                        });
    }
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            return Single.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to count applications"),
                                            ex));
                        });
    }
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            ...
                            LOGGER.error(
                                    "An error occurs while trying to count applications for domain {}",
                                    domainId,
                                    ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to count applications for domain %s",
                                                    domainId),
                                            ex));
                        });
    }
    ...
    public Single<Set<TopApplication>> findTopApplications() {
        ...
        return applicationRepository
                ...
                .flatMapObservable(
                        pagedApplications -> Observable.fromIterable(pagedApplications.getData()))
                .flatMapSingle(
                        application ->
                                tokenService
                                        ...
                                        .map(
                                                totalToken -> {
                                                    ...
                                                    topApplication.setAccessTokens(
                                                            totalToken.getTotalAccessTokens());
                                                    return topApplication;
                                                }))
                .toList()
                .map(
                        topApplications ->
                                topApplications.stream()
                                        .filter(topClient -> topClient.getAccessTokens() > 0)
                                        .collect(Collectors.toSet()))
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find top applications", ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            "An error occurs while trying to find top applications",
                                            ex));
                        });
    }
    ...
    public Single<Set<TopApplication>> findTopApplicationsByDomain(String domain) {
        ...
        return applicationRepository
                ...
                .onErrorResumeNext(
                        ex -> {
                            LOGGER.error(
                                    "An error occurs while trying to find top applications for domain {}",
                                    domain,
                                    ex);
                            return Single.error(
                                    new TechnicalManagementException(
                                            String.format(
                                                    "An error occurs while trying to find top applications for domain %s",
                                                    domain),
                                            ex));
                        });
    }
    ...
    private Single<Application> create0(String domain, Application application, User principal) {
        ...
        return checkApplicationUniqueness(domain, application)
                ...
                .flatMap(
                        application1 -> {
                            if (principal == null
                                    || principal.getAdditionalInformation() == null
                                    || StringUtils.isEmpty(
                                            principal
                                                    .getAdditionalInformation()
                                                    .get(Claims.organization))) {
                                // There is no principal or we can not find the organization the
                                // user is attached to. Can't assign role.
                                return Single.just(application1);
                            }

                            return roleService
                                    .findSystemRole(
                                            SystemRole.APPLICATION_PRIMARY_OWNER,
                                            ReferenceType.APPLICATION)
                                    .switchIfEmpty(
                                            Single.error(
                                                    new InvalidRoleException(
                                                            "Cannot assign owner to the application, owner role does not exist")))
                                    .flatMap(
                                            role -> {
                ...
                .flatMap(
                        application1 -> {
                            ...
                            return eventService
                                    .create(event)
                                    .flatMap(domain1 -> Single.just(application));
                        })
                .doOnSuccess(
                        application1 ->
                                auditService.report(
    ...
    private Single<Application> update0(
            String domain,
                        ...
                        certificates -> {
                            ...
                            Certificate defaultCertificate =
                                    certificates.stream()
                                            ...
                                            .or(
                                                    () ->
                                                            // legacy way to retrieve default
                                                            // certificate before we introduce the
                                                            // system flag
                                                            // keep it for backward compatibility in
                                                            // case of issue with the
                                                            // SystemCertificateUpgrader
                                                            certificates.stream()
                                                                    .filter(
                                                                            certificate ->
                                                                                    "Default"
        ...
        return findByDomainAndClientId(domain, clientId)
                ...
                .flatMapCompletable(
                        isEmpty -> {
                            if (!isEmpty) {
                                return Completable.error(
                                        new ApplicationAlreadyExistsException(clientId, domain));
                            }
    ...
    private Single<Application> validateApplicationIdentityProviders(Application application) {
        if (application.getIdentityProviders() == null
                || application.getIdentityProviders().isEmpty()) {
            return Single.just(application);
        }
    ...
    private Single<Application> validateRedirectUris(Application application) {
        ...
        return domainService
                ...
                .flatMapSingle(
                        domain -> {
                            // check redirect_uri
                            if (GrantTypeUtils.isRedirectUriRequired(oAuthSettings.getGrantTypes())
                                    && CollectionUtils.isEmpty(oAuthSettings.getRedirectUris())) {
                                // if client type is from V2, it means that the application has been
                                // created from an old client without redirect_uri control (via the
                                // upgrader)
                                    ...
                                    try {
                                        URI uri =
                                                redirectUri.contains("*")
                                                        ? new URI(redirectUri)
                                                        : UriBuilder.fromURIString(redirectUri)
                                                                .build();
                                        ...
                                        if (!domain.isRedirectUriLocalhostAllowed()
                                                && isHttp(uri.getScheme())
                                                && UriBuilder.isLocalhost(host)) {
                                            return Single.error(
                                                    new InvalidRedirectUriException(
                                                            "localhost is forbidden"));
                                        }
                                        // check http scheme
                                        if (!domain.isRedirectUriUnsecuredHttpSchemeAllowed()
                                                && uri.getScheme().equalsIgnoreCase("http")) {
                                            return Single.error(
                                                    new InvalidRedirectUriException(
                                                            "Unsecured http scheme is forbidden"));
                                        }
                                        // check wildcard
                                        if (!domain.isRedirectUriWildcardAllowed()
                                                && (nonNull(uri.getPath())
                                                                && uri.getPath().contains("*")
                                                        || nonNull(host) && host.contains("*"))) {
                                            return Single.error(
                                                    new InvalidRedirectUriException(
                                        ...
                                        if (uri.getFragment() != null) {
                                            return Single.error(
                                                    new InvalidRedirectUriException(
                                                            "redirect_uri with fragment is forbidden"));
                                        }
    ...
    private Single<Application> validateScopes(Application application) {
        ...
        List<String> scopes =
                oAuthSettings.getScopeSettings() != null
                        ? oAuthSettings.getScopeSettings().stream()
        ...
        return scopeService
                .validateScope(application.getDomain(), scopes)
                .flatMap(
                        isValid -> {
                            if (!isValid) {
                                return Single.error(
                                        new InvalidClientMetadataException("non valid scopes"));
                            }
                            return Single.just(application);
                        });
    }
    ...
    private Single<Application> validateTokenEndpointAuthMethod(Application application) {
        ...
        if ((ApplicationType.SERVICE.equals(application.getType())
                        || (oauthSettings.getGrantTypes() != null
                                && oauthSettings
                                        .getGrantTypes()
                                        .contains(GrantType.CLIENT_CREDENTIALS)))
                && (tokenEndpointAuthMethod != null
                        && ClientAuthenticationMethod.NONE.equals(tokenEndpointAuthMethod))) {
            return Single.error(
    ...
    private Single<Application> validateTlsClientAuth(Application application) {
        ...
        if (settings.getTokenEndpointAuthMethod() != null
                && ClientAuthenticationMethod.TLS_CLIENT_AUTH.equalsIgnoreCase(
                        settings.getTokenEndpointAuthMethod())) {

            if ((settings.getTlsClientAuthSubjectDn() == null
            ...
            if (settings.getTlsClientAuthSubjectDn() != null
            ...
            } else if (settings.getTlsClientAuthSanDns() != null
                    && !settings.getTlsClientAuthSanDns().isEmpty()
                ...
                return Single.error(
                        new InvalidClientMetadataException(
                                "The tls_client_auth must use exactly one of the TLS parameters."));
            } else if (settings.getTlsClientAuthSanIp() != null
                    && !settings.getTlsClientAuthSanIp().isEmpty()
                    && ((settings.getTlsClientAuthSubjectDn() != null
                                    && !settings.getTlsClientAuthSubjectDn().isEmpty())
                            || (settings.getTlsClientAuthSanDns() != null
                ...
                return Single.error(
                        new InvalidClientMetadataException(
                                "The tls_client_auth must use exactly one of the TLS parameters."));
            } else if (settings.getTlsClientAuthSanEmail() != null
                    && !settings.getTlsClientAuthSanEmail().isEmpty()
                    && ((settings.getTlsClientAuthSubjectDn() != null
                                    && !settings.getTlsClientAuthSubjectDn().isEmpty())
                            || (settings.getTlsClientAuthSanDns() != null
                ...
                return Single.error(
                        new InvalidClientMetadataException(
                                "The tls_client_auth must use exactly one of the TLS parameters."));
            } else if (settings.getTlsClientAuthSanUri() != null
                    && !settings.getTlsClientAuthSanUri().isEmpty()
                    && ((settings.getTlsClientAuthSubjectDn() != null
                                    && !settings.getTlsClientAuthSubjectDn().isEmpty())
                            || (settings.getTlsClientAuthSanDns() != null
                                ...
                                for (String logoutRedirectUri :
                                    ...
                                    try {
                                        ...
                                        if (uri.getFragment() != null) {
                                            return Single.error(
                                                    new InvalidTargetUrlException(
                                                            "post_logout_redirect_uri with fragment is forbidden"));
                                        }
                                    } catch (IllegalArgumentException | URISyntaxException ex) {
                                        return Single.error(
                                                new InvalidTargetUrlException(
