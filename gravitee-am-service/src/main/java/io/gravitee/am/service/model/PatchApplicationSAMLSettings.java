...
public class PatchApplicationSAMLSettings {
    ...
    public ApplicationSAMLSettings patch(ApplicationSAMLSettings _toPatch) {
        ...
        ApplicationSAMLSettings toPatch =
                _toPatch == null
                        ? new ApplicationSAMLSettings()
                        : new ApplicationSAMLSettings(_toPatch);
        SetterUtils.safeSet(toPatch::setEntityId, this.getEntityId());
        SetterUtils.safeSet(
                toPatch::setAttributeConsumeServiceUrl, this.getAttributeConsumeServiceUrl());
