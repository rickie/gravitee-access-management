...
public interface ResourceService {
    ...
    Flowable<Resource> findByDomainAndClientAndResources(
            String domain, String client, List<String> resourceIds);

    Maybe<Resource> findByDomainAndClientAndUserAndResource(
    ...
    Flowable<AccessPolicy> findAccessPolicies(
    ...
    Maybe<AccessPolicy> findAccessPolicy(
    ...
    Completable deleteAccessPolicy(
            String domain, String client, String user, String resource, String accessPolicy);
    ...
    default Single<Set<Resource>> findByDomain(String domain) {
        return findByDomain(domain, 0, Integer.MAX_VALUE)
                .map(
                        pagedResources ->
                                (pagedResources.getData() == null)
                                        ? Collections.emptySet()
                                        : new HashSet<>(pagedResources.getData()));
    }
}
