...
public class PermissionSettingsUtilsTest {
    ...
    public void must_have_nothing_with_null_app() {
        assertTrue(
                PermissionSettingUtils.getRequiredPermissions((PatchApplication) null).isEmpty());
        assertTrue(
                PermissionSettingUtils.getRequiredPermissions((PatchApplicationSettings) null)
                        .isEmpty());
    }
