...
public class LoginAttemptServiceTest {
    ...
    public void shouldCreateUser_accountLockFirstConnection() {
        ...
        when(loginAttemptRepository.findByCriteria_migrated(loginAttemptCriteria)).thenReturn(Mono.just(loginAttempt));
        when(loginAttemptRepository.update_migrated(loginAttempt)).thenReturn(Mono.just(loginAttempt));
