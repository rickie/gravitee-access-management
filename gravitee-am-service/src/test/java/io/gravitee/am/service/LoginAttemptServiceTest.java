...
public class LoginAttemptServiceTest {
    ...
    @InjectMocks private LoginAttemptService loginAttemptService = new LoginAttemptServiceImpl();
    ...
    public void shouldCreateUser_accountLockFirstConnection() {
        ...
        when(loginAttemptRepository.findByCriteria(loginAttemptCriteria))
                .thenReturn(Maybe.just(loginAttempt));
        when(loginAttemptRepository.update(loginAttempt)).thenReturn(Single.just(loginAttempt));

        TestObserver testObserver =
                loginAttemptService.loginFailed(loginAttemptCriteria, accountSettings).test();
