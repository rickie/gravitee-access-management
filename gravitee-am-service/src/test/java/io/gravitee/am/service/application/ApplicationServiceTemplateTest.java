...
public class ApplicationServiceTemplateTest {
    ...
    private ApplicationServiceTemplate applicationServiceTemplate =
    ...
    public void shouldApply_existingGrantType() {
        ...
        Assert.assertTrue(
                oAuthSettings1.getClientSecret() != null
                        && !oAuthSettings.getClientSecret().isEmpty());
        Assert.assertTrue(
                oAuthSettings1.getGrantTypes().size() == 1
                        && oAuthSettings1.getGrantTypes().contains(GrantType.PASSWORD));
    }
    ...
    public void shouldChangeType() {
        ...
        existingOAuthSettings.setGrantTypes(
        ...
        Assert.assertTrue(
                oAuthSettings.getClientSecret() != null
                        && !oAuthSettings.getClientSecret().isEmpty());
        Assert.assertTrue(
                (oAuthSettings.getGrantTypes().size() == 1
                        && oAuthSettings.getGrantTypes().contains(GrantType.CLIENT_CREDENTIALS)));
