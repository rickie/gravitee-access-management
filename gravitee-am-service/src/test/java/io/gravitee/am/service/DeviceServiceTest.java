...
public class DeviceServiceTest {
    ...
    private static final String DEVICE_IDENTIFIER = "rememberDevice1";
    private static final String REMEMBER_DEVICE2 = "rememberDevice2";
    ...
    public void mustFindByDomainAndApplicationAndUser() {
        doReturn(Flowable.fromIterable(List.of(device1, device2)))
    ...
    public void mustFindNothing() {
        doReturn(Flowable.fromIterable(List.of()))
                .when(deviceRepository)
    ...
    public void mustReturn_SingleBoolean() {
        doReturn(Maybe.empty())
                ...
                .findByDomainAndClientAndUserAndDeviceIdentifierAndDeviceId(
                        DOMAIN, CLIENT, USER, DEVICE_IDENTIFIER, DEVICE1);
        doReturn(Maybe.just(device2))
                .when(deviceRepository)
                .findByDomainAndClientAndUserAndDeviceIdentifierAndDeviceId(
    ...
    public void mustNotDelete_deviceDoesNotExist() {
        ...
        deviceService
                .delete(DOMAIN, USER, device1.getId(), new DefaultUser())
                .test()
    ...
    public void mustNotDelete_deviceDoesNotBelongToContext() {
        ...
        deviceService
                .delete(DOMAIN2, USER, device1.getId(), new DefaultUser())
                .test()
                .assertFailure(DeviceNotFoundException.class);
    }
