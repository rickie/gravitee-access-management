...
public class ThreadLocalDomainDictionaryProviderTest extends AbstractDynamicDictionaryProviderTest {
    ...
    private final ThreadLocalDomainDictionaryProvider provider =
    ...
    public void shouldGetRightDictionary_inMultiThreadContext() throws Exception {
        ...
        assertTrue(
                provider()
                        .getDictionaryFor(new Locale(i18nDictionary.getLocale()))
                        .getProperty("key")
                        .equals("value"));
            ...
            Future<String> future =
                    executorService.submit(
                            () -> {
                                ...
                                localI18nDictionary.setEntries(
                                        Collections.singletonMap("key", "value-locale"));
                                provider().loadDictionary(localI18nDictionary);
                                return provider()
                                        .getDictionaryFor(
                                                new Locale(localI18nDictionary.getLocale()))
                                        .getProperty("key");
                            });
