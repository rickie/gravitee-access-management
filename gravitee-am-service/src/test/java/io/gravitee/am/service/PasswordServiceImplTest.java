...
public class PasswordServiceImplTest {
    ...
    private static final PasswordService passwordService =
            new PasswordServiceImpl(
                    new DefaultPasswordValidatorImpl("default"),
                    new PasswordDictionaryImpl().start(false));
    ...
    public void testPassword_min_8_characters_at_least_one_letter_one_number() {
        PasswordService passwordValidator =
                new PasswordServiceImpl(
                        new DefaultPasswordValidatorImpl(
                                "^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{8,}$"),
                        null);
    ...
    @Test
    public void
            testPassword_min_8_characters_at_least_one_letter_one_number_one_special_character() {
        PasswordService passwordValidator =
                new PasswordServiceImpl(
                        new DefaultPasswordValidatorImpl(
                                "^(?=.*[A-Za-z])(?=.*\\d)(?=.*[@$!%*#?&])[A-Za-z\\d@$!%*#?&]{8,}$"),
                        new PasswordDictionaryImpl());
    ...
    @Test
    public void
            testPassword_min_8_characters_at_least_one_uppercase_letter_one_lowercase_letter_one_number_one_special_character() {
        PasswordService passwordValidator =
                new PasswordServiceImpl(
                        new DefaultPasswordValidatorImpl(
    ...
    @Test
    public void
            testPassword_min_8_characters_max_10_characters_at_least_one_uppercase_letter_one_lowercase_letter_one_number_one_special_character() {
        PasswordService passwordValidator =
                new PasswordServiceImpl(
                        new DefaultPasswordValidatorImpl(
    ...
    public void invalidMinLength() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(3, null, null, null, null, null, null);
    ...
    public void includeNumber() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(2, true, null, null, null, null, null);
        Assertions.assertThat(getValidationErrorKey("ABC", passwordSettings))
                .hasValue("password must contains numbers");
    ...
    public void includeSpecialCharacters() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(3, false, true, null, null, null, null);
        Assertions.assertThat(getValidationErrorKey("AB12", passwordSettings))
                .hasValue("password must contains special characters");
        Assertions.assertThat(getValidationErrorKey("1234", passwordSettings))
                .hasValue("password must contains special characters");
        Assertions.assertThat(getValidationErrorKey("ABCD", passwordSettings))
                .hasValue("password must contains special characters");
    ...
    public void lettersInMixedCase() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(3, null, null, true, null, null, null);
        Assertions.assertThat(getValidationErrorKey("ABCD", passwordSettings))
                .hasValue("password must contains letters in mixed case");
        Assertions.assertThat(getValidationErrorKey("abcd", passwordSettings))
                .hasValue("password must contains letters in mixed case");
    ...
    public void maxConsecutiveLetters() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(3, null, null, false, 3, null, null);
        Assertions.assertThat(getValidationErrorKey("ABBBBCD", passwordSettings))
                .hasValue("invalid max consecutive letters");
    ...
    public void passwordInDictionary() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(3, null, null, false, null, true, null);
        Assertions.assertThat(getValidationErrorKey("trustno1", passwordSettings))
                .hasValue("invalid password, try something else");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_username() {
        PasswordSettings passwordSettings =
                buildPasswordSettings(3, null, null, false, null, null, true);
        User user = new User();
        user.setUsername("myUsername");
        Assertions.assertThat(
                        getValidationErrorKey("MyUsErNaMe-and-a-suffix@@@", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_firstname() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey(
                                "SomePaSSwordWith-myFiRsTnAmE", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_lastname() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey(
                                "SomePasswordWith-myLaStNaMe", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_nickname() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey(
                                "SomePasswordWith-myNiCkNaMe", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_middlename() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey("myMiDdLeNaMe-withsomething", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_email() {
        ...
        Assertions.assertThat(getValidationErrorKey("uSeR@eMaIl.com", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_emails() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey(
                                "somePassword-email2@email.com", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_phonenumbers() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey("somePassword-0798765432", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void userProfileInPassword_phonenumber() {
        ...
        Assertions.assertThat(
                        getValidationErrorKey("somePassword-0712345678", passwordSettings, user))
                .hasValue("invalid password user profile");
        Assertions.assertThat(getValidationErrorKey("mY5tR0N9P@SsWoRd!", passwordSettings, user))
                .isEmpty();
    }
    ...
    public void checkAccountPasswordExpiry_clientNull_shouldReturnExpired() {
        ...
        Assertions.assertThat(passwordService.checkAccountPasswordExpiry(user, null, domain))
                .isTrue();
    }
    ...
    public void checkAccountPasswordExpiry_clientNotNull_shouldReturnExpired() {
        ...
        Assertions.assertThat(passwordService.checkAccountPasswordExpiry(user, client, domain))
                .isTrue();
    }
    ...
    private Optional<String> getValidationErrorKey(
            String password, PasswordSettings passwordSettings) {
        return getValidationErrorKey(password, passwordSettings, null);
    }

    private Optional<String> getValidationErrorKey(
            String password, PasswordSettings passwordSettings, User user) {
        try {
