...
public class ExtensionGrantServiceTest {
    ...
    @Mock private ExtensionGrantRepository extensionGrantRepository;
    ...
    public void shouldFindById() {
        when(extensionGrantRepository.findById("my-extension-grant"))
                .thenReturn(Maybe.just(new ExtensionGrant()));
    ...
    public void shouldFindByDomain() {
        when(extensionGrantRepository.findByDomain(DOMAIN))
                .thenReturn(Flowable.just(new ExtensionGrant()));
        TestSubscriber<ExtensionGrant> testSubscriber =
                extensionGrantService.findByDomain(DOMAIN).test();
    ...
    public void shouldCreate() {
        ...
        when(extensionGrantRepository.findByDomainAndName(DOMAIN, "my-extension-grant"))
                .thenReturn(Maybe.empty());
        when(extensionGrantRepository.create(any(ExtensionGrant.class)))
                .thenReturn(Single.just(new ExtensionGrant()));
    ...
    public void shouldUpdate() {
        ...
        when(extensionGrantRepository.findByDomainAndName(DOMAIN, "my-extension-grant"))
                .thenReturn(Maybe.empty());
        when(extensionGrantRepository.update(any(ExtensionGrant.class)))
                .thenReturn(Single.just(new ExtensionGrant()));
        when(eventService.create(any())).thenReturn(Single.just(new Event()));

        TestObserver testObserver =
                extensionGrantService
                        .update(DOMAIN, "my-extension-grant", updateExtensionGrant)
                        .test();
        testObserver.awaitTerminalEvent();
    ...
    public void shouldDelete_notExistingExtensionGrant() {
        ...
        TestObserver testObserver =
                extensionGrantService.delete(DOMAIN, "my-extension-grant").test();
    ...
    public void shouldNotDelete_extensionGrantWithClients() {
        ...
        when(extensionGrantRepository.findById(extensionGrant.getId()))
                .thenReturn(Maybe.just(extensionGrant));
        when(applicationService.findByDomainAndExtensionGrant(
                        DOMAIN, extensionGrant.getGrantType() + "~" + extensionGrant.getId()))
                .thenReturn(Single.just(Collections.singleton(new Application())));

        TestObserver testObserver =
                extensionGrantService.delete(DOMAIN, extensionGrant.getId()).test();
    ...
    public void shouldNotDelete_extensionGrantWithClients_backward_compatibility() {
        ...
        when(applicationService.findByDomainAndExtensionGrant(
                        DOMAIN, extensionGrant.getGrantType()))
                .thenReturn(Single.just(Collections.singleton(new Application())));
        when(extensionGrantRepository.findByDomain(DOMAIN))
                .thenReturn(Flowable.just(extensionGrant, extensionGrant2));
        TestObserver testObserver =
                extensionGrantService.delete(DOMAIN, extensionGrant.getId()).test();
    ...
    public void shouldDelete_extensionGrantWithClients_backward_compatibility() {
        ...
        when(extensionGrantRepository.findById(extensionGrant2.getId()))
                .thenReturn(Maybe.just(extensionGrant2));
        when(extensionGrantRepository.delete(extensionGrant2.getId()))
                .thenReturn(Completable.complete());
        when(applicationService.findByDomainAndExtensionGrant(
                        DOMAIN, extensionGrant2.getGrantType() + "~" + extensionGrant2.getId()))
                .thenReturn(Single.just(Collections.emptySet()));
        when(applicationService.findByDomainAndExtensionGrant(
                        DOMAIN, extensionGrant2.getGrantType()))
                .thenReturn(Single.just(Collections.singleton(new Application())));
        when(extensionGrantRepository.findByDomain(DOMAIN))
                .thenReturn(Flowable.just(extensionGrant, extensionGrant2));
        when(eventService.create(any())).thenReturn(Single.just(new Event()));
        TestObserver testObserver =
                extensionGrantService.delete(DOMAIN, extensionGrant2.getId()).test();
    ...
    public void shouldDelete() {
        ...
        when(extensionGrantRepository.findById("my-extension-grant"))
                .thenReturn(Maybe.just(existingExtensionGrant));
        when(extensionGrantRepository.delete("my-extension-grant"))
                .thenReturn(Completable.complete());
        when(extensionGrantRepository.findByDomain(DOMAIN))
                .thenReturn(Flowable.just(existingExtensionGrant));
        when(applicationService.findByDomainAndExtensionGrant(
                        DOMAIN, "my-extension-grant~my-extension-grant"))
                .thenReturn(Single.just(Collections.emptySet()));
