...
public class GroupServiceTest {
    ...
    @InjectMocks private GroupService groupService = new GroupServiceImpl();

    @Mock private GroupRepository groupRepository;

    @Mock private UserService userService;

    @Mock private OrganizationUserService organizationUserService;
    ...
    public void shouldFindByDomain() {
        when(groupRepository.findAll(ReferenceType.DOMAIN, DOMAIN))
                .thenReturn(Flowable.just(new Group()));
    ...
    public void shouldFindByDomainPagination() {
        ...
        when(groupRepository.findAll(ReferenceType.DOMAIN, DOMAIN, 1, 1))
                .thenReturn(Single.just(pagedGroups));
    ...
    public void shouldCreate() {
        ...
        when(groupRepository.findByName(ReferenceType.DOMAIN, DOMAIN, newGroup.getName()))
    ...
    public void shouldCreate_technicalException() {
        ...
        when(groupRepository.findByName(ReferenceType.DOMAIN, DOMAIN, newGroup.getName()))
                .thenReturn(Maybe.empty());
        when(groupRepository.create(any(Group.class)))
                .thenReturn(Single.error(TechnicalException::new));
    ...
    public void shouldCreate_alreadyExists() {
        ...
        when(groupRepository.findByName(ReferenceType.DOMAIN, DOMAIN, newGroup.getName()))
                .thenReturn(Maybe.just(new Group()));
    ...
    public void shouldUpdate() {
        ...
        when(groupRepository.findById(ReferenceType.DOMAIN, DOMAIN, "my-group"))
                .thenReturn(Maybe.just(group));
        when(groupRepository.findByName(ReferenceType.DOMAIN, DOMAIN, updateGroup.getName()))
                .thenReturn(Maybe.empty());
    ...
    public void shouldDelete() {
        ...
        TestObserver testObserver =
                groupService.delete(ReferenceType.DOMAIN, DOMAIN, "my-group").test();
        testObserver.awaitTerminalEvent();
    ...
    public void shouldDelete_technicalException() {
        when(groupRepository.findById(ReferenceType.DOMAIN, DOMAIN, "my-group"))
                .thenReturn(Maybe.just(new Group()));
        when(groupRepository.delete("my-group"))
    ...
    public void shouldAssignRoles() {
        ...
        when(groupRepository.findById(eq(ReferenceType.DOMAIN), eq(DOMAIN), eq("group-id")))
                .thenReturn(Maybe.just(group));
        ...
        TestObserver testObserver =
                groupService
                        .assignRoles(ReferenceType.DOMAIN, DOMAIN, group.getId(), rolesIds)
                        .test();
        testObserver.assertComplete();
        testObserver.assertNoErrors();
    ...
    public void shouldRevokeRole() {
        ...
        TestObserver testObserver =
                groupService
                        .revokeRoles(ReferenceType.DOMAIN, DOMAIN, group.getId(), rolesIds)
                        .test();
        testObserver.assertComplete();
        testObserver.assertNoErrors();
        verify(groupRepository, times(1)).update(any());
    ...
    public void shouldFindMembersFromDomainUsers_Paginate() {
        ...
        when(groupRepository.findById(eq(ReferenceType.DOMAIN), eq(DOMAIN), eq("group-id")))
                .thenReturn(Maybe.just(group));
        when(userService.findByIdIn(any()))
                .thenReturn(
        ...
        var observer =
                groupService.findMembers(ReferenceType.DOMAIN, DOMAIN, "group-id", 0, 25).test();
        observer.awaitTerminalEvent();
