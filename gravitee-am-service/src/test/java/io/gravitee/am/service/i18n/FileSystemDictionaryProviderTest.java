...
public class FileSystemDictionaryProviderTest {
    ...
    public void should_Fallback_ToDefault() {
        ...
        Assert.assertEquals(
                "Should contains the default message", "value-default", prop.getProperty("key"));
    }
    ...
    public void should_Match_Most_Specific_Locale_enGB() {
        ...
        Assert.assertEquals(
                "Should contains the en-GB message", "value-en-GB", prop.getProperty("key"));
        Assert.assertTrue(
                "Should contains the en-GB multiline message",
                prop.getProperty("key.multi.lines").contains("lines")
    ...
    public void should_Match_Most_Specific_Locale_frFR() {
        ...
        Assert.assertEquals(
                "Should contains the fr-FR message", "value-fr-FR", prop.getProperty("key"));
        Assert.assertTrue(
                "Should contains the fr-FR multiline message",
                prop.getProperty("key.multi.lines").contains("lines")
    ...
    public void should_Fallback_to_language() {
        ...
        Assert.assertTrue(
                "Should contains the fr multiline message",
                prop.getProperty("key.multi.lines").contains("lines")
