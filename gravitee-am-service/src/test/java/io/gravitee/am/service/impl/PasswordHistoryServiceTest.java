...
class PasswordHistoryServiceTest {
    ...
    @InjectMocks private PasswordHistoryService service;
    private User user;
    ...
    void addPasswordToHistory() {
        ...
        given(repository.findUserHistory(DOMAIN, REFERENCE_ID, userId))
    ...
    void rejectUsedPassword() {
        ...
        given(repository.findUserHistory(DOMAIN, REFERENCE_ID, userId))
                .willReturn(fromIterable(List.of(new PasswordHistory())));
    ...
    void replaceOldestPassword() {
        ...
        given(repository.findUserHistory(DOMAIN, REFERENCE_ID, userId))
                .willReturn(fromIterable(passwordHistories));
    ...
    void findByReferenceError() {
        given(repository.findByReference(any(), any()))
                .willReturn(Flowable.error(IllegalArgumentException::new));
